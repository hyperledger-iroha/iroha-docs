...
اگر نیٹ ورک نوڈ Docker یا Kubernetes میں چلتا ہے، تو میزبان یا سروس ایڈریس کا استعمال کریں جو کلائنٹ کے عمل سے قابل رسائی ہے۔ ایک کنٹینر کے اندر `127.0.0.1` میزبان مشین نہیں ہے.
...
اگر یہ کمانڈ `502` ، TLS، DNS، یا ٹائم آؤٹ کی غلطیوں کے ساتھ ناکام ہوجاتے ہیں تو، اکاؤنٹ چابیاں یا لین دین کے پے لوڈ کو ڈیبگ کرنے سے پہلے نیٹ ورک کی دستیابی کو درست کریں یا عوامی ٹیسٹ نیٹ کے اختتامی نقطہ کا انتظار کریں۔
...
## استفسارات خالی نتائج لوٹاتے ہیں {#queries-return-empty-results}
...
بلاک اور ایونٹ سٹریم کی مثالیں Torii اسٹریمنگ اختتامی پوائنٹس پر انحصار کرتی ہیں۔ تصدیق کریں کہ نیٹ ورک نوڈ اب بھی چل رہا ہے ، پھر ٹائم آؤٹ کے ساتھ ٹیسٹ کریں:

...
ایپ سے متعلق لیجر کی تلاوتیں ایک اختیاری کینونیکل اکاؤنٹ دستخط کی حد کا استعمال کرتی ہیں۔ غیر دستخط شدہ درخواست صرف فعال عوامی ڈیٹا بیس وصول کرتی ہے۔ ایک درست دستخط کردہ درخواست کال کرنے والے کے موجودہ UAID اور اس اکاؤنٹ کی `CanReadRestrictedDataspace` اجازتوں کے ذریعہ نامزد عین مطابق ڈیٹا بیس راستوں سے منسلک ڈیٹا بیس شامل کرتی ہے۔ `CanReadAllLedgerData` ہر ڈیٹا اسپیس میں نمائش فراہم کرتا ہے۔ صرف `X-Iroha-Account` ، یا کسی بھی نامکمل یا غلط شکل والے دستخط ہیڈر سیٹ کو فراہم کرتے ہوئے ، `401 Unauthorized` لوٹاتا ہے۔ یہ گمنام نمائش پر واپس نہیں آتا ہے۔

ایک ہی نمائش آبجیکٹ فلٹر اکاؤنٹ ، ڈومین ، اثاثہ کی تعریف ، اثاثے ، NFT ، RWA ، ہولڈر ، اور ایکسپلورر پڑھتا ہے۔ ایک غائب آبجیکٹ اور کسی چیز کو جو کال کرنے والے کے مرئی راستوں سے باہر ہے جان بوجھ کر الگ نہیں کیا جاسکتا ہے. ٹرانزیکشن کے لئے ریکارڈ کردہ ہر روٹ پاٹ نظر آنے پر ہی انجام شدہ لین دین اور ہدایات کی تاریخ دکھائی جاتی ہے۔ مخلوط ڈیٹا اسپیس لین دین اس وجہ سے جب ایک حصہ لینے والے پاؤں بھی کال کرنے والے کے دائرہ کار سے باہر ہے تو چھپایا جاتا ہے۔ غائب ، پرانی یا غلط شکل کا روٹنگ سیاق و سباق صرف عالمی قارئین کو نظر آتا ہے۔

Torii صارف کے فلٹرز ، پیجینیشن ، گنتیوں یا پروجیکشنز سے پہلے اس دائرہ کار کو لاگو کرتا ہے SSE ، WebSocket ، معاہدے کے واقعہ اور دوبارہ کھیلنے کے راستوں پر۔ طویل عرصے تک جاری رہنے والے سلسلے اسی اجازت کا دوبارہ جائزہ لیتے ہیں جب لیجر کی اجازتیں تبدیل ہوجاتی ہیں اور رسائی حاصل ہونے کے بعد عام اجازت کی ناکامی کے ساتھ ختم ہوجاتے ہیں۔ منسوخ کر دیا گیا ہے۔
...
ایکسپلورر WebSocket بہاؤ فلٹر شدہ خلاصے جاری کرتے ہیں اور جب لیجر کی اجازتیں تبدیل ہوتی ہیں تو نظر ثانی کو دوبارہ حساب لگاتے ہیں۔ مقامی `GET /v1/blocks/stream` راستہ مختلف ہے: یہ مکمل خارج کرتا ہے۔ دستخط شدہ بلاکس ، ہاتھ ملانے کے دوران `CanReadAllLedgerData` کی ضرورت ہوتی ہے ، اور بند ہوجاتی ہے اگر بعد میں اس اجازت کو منسوخ کردیا جاتا ہے۔ ڈیٹا اسپیس سکینڈ ایکسپلورر کے لئے مقامی ندی کا استعمال نہ کریں۔

براہ راست `GET /v1/sumeragi/status/sse` اتفاق رائے تشخیصی سلسلہ بھی ایک گمنام ڈیٹا اسپیس فیڈ نہیں ہے۔ اس میں ہر رابطہ کی کوشش پر مکمل آپریٹر دستخط ہیڈر کوارٹیٹ کی ضرورت ہوتی ہے۔ گاہکوں کو درست سلسلہ URI کے لئے ایک نیا دستخط پیدا ہوتا ہے اور خود کار طریقے سے نقل و حمل کی دوبارہ کوشش کے ذریعے ری ڈائریکٹ یا ایک دستخط شدہ کوشش کو دوبارہ نہیں کھیلتے ہیں.
...
تمام ISO راستوں کے لئے ایک نئے آپریٹر کی دستخط کی ضرورت ہوتی ہے۔ ابتدائی `pacs.008` ، `pacs.009`، `sese.023` یا `colr.012` جمع کروانے کے ل the ، تصدیق شدہ آپریٹر کو درخواست ہیڈر `From` کی مالی شناخت کے ذریعہ شناختی کارکن سے تعلق رکھنا چاہئے۔ `To` شناخت کو ایک اور تشکیل شدہ شریک کا نام دینا چاہئے ، اور منتخب کردہ پروفائل دونوں فریقوں کے لئے اجازت دی جانی چاہئے۔ دیرپا داخلہ ماخذ ، پارٹی ، داخل کرنے والے شریک اور آپریٹر کی کلید ، اور اصل پروفائل اور سرایت کی پالیسی کو ریکارڈ کرتا ہے۔
...
ISO ریکارڈ اسٹورز صرف اسکیما V3 ریکارڈز اور دوبارہ کھیلنے کے قبرستانوں کو قبول کرتے ہیں۔ Torii ایک واضح عدم مطابقت کی خرابی کے ساتھ شروع کرنے میں ناکام ہوجاتا ہے جب برقرار رکھنے والے اعداد و شمار اس اسکیم سے مماثل نہیں ہوتے ہیں ، لہذا پہلی ریلیز اسٹورز اور فکسچر کو بحال کرنا ضروری ہے۔ ہر امیر ریکارڈ شرکاء کی اصل کو غیر متغیر رکھتا ہے۔ ایک علیحدہ پائیدار قبرستان پیغام ID ، پے لوڈ ہیش ، کاروباری پیغام ID ، اور UETR کو مکمل ڈپلیکیشن کے لئے برقرار رکھتا ہے TTL یہاں تک کہ امیر ریکارڈ کی تفصیلات کاٹنے کے بعد بھی.

Torii ایک لائف سائیکل پیغام پر دستخط کرنے یا اس پر عملدرآمد کرنے سے پہلے دوبارہ کھیلنے کی اجازت برقرار رکھتا ہے۔ یہ کبھی بھی ختم نہ ہونے والی دوبارہ پلے شناخت کو خارج نہیں کرتا ہے۔ اگر تشکیل شدہ ریکارڈ کی گنجائش میں صرف TTL کے ذریعہ محفوظ اندراجات شامل ہیں تو ، پیش کشوں کو زندگی سائیکل یا اکاؤنٹنگ کی حالت میں تبدیلی کے بغیر واپس قابل `503 Service Unavailable` موصول ہوتا ہے.

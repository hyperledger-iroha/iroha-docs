...
`pacs.009` دستاویزات میں کاروباری پیغام ID، پیغام کی تعریف ID، تخلیق کا وقت، بین الاقوامی بینک تصفیہ رقم، کرنسی، تصفیہ کی تاریخ، ہدایات دینے والا اور ہدایت یافتہ ایجنٹ BICs، اور قرض دہندہ اور کریڈٹر IBANs شامل ہونا ضروری ہے. اگر پیغام میں `Purp` شامل ہے تو، پل فی الحال صرف سیکیورٹی مقاصد کے لئے فنڈنگ قبول کرتا ہے: `Purp=SECU`.
...
- `JoinKaigi` اور `LeaveKaigi`: کال لسٹ کو اپ ڈیٹ کریں۔ پرائیویٹ موڈ میں ، شرکاء براہ راست شرکت کنندہ اکاؤنٹ IDs کو بے نقاب کرنے کے بجائے عہدوں ، منسوخ کنندگان اور لسٹری ثبوت استعمال کرتے ہیں۔
...
استعمال `--room-policy public` ان کمروں کے لئے جن پر ریلے بغیر ناظرین کے ٹکٹوں کی نمائش کر سکتے ہیں ، یا `--room-policy authenticated` جب باہر نکلنے کے لئے ناظرین کی توثیق ضروری ہے. `--privacy-mode zk-roster-v1` صرف اس وقت جب نیٹ ورک کے پاس Kaigi فہرست اور استعمال کی تصدیق کرنے والی چابیاں ترتیب دی گئی ہیں؛ دوسری صورت میں منسلک، پتیوں، اور پرائیویٹ استعمال ریکارڈ ڈیٹرمینسٹک تصدیق کے دوران ناکام ہو جاتے ہیں.
...
اختتامی نقطہ نظر کی نمائش ٹیلی میٹری ترتیبات پر منحصر ہے. اپ اسٹریم دستاویزات پانچ پروفائل سطحوں کی وضاحت کرتی ہیں:

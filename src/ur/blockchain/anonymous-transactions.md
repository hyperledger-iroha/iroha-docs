...
|موڈ|معنی |
| ----------------- | ---------------------------------------------------------------- |
|`TransparentOnly` |صرف عام عوامی توازن اور ٹرانسفر قبول کیے جاتے ہیں۔ |
...
1. توثیق کنندہ نوڈس پر خفیہ حمایت کو فعال کریں۔ توثیقی کاروں کو تصدیق کنندہ بیک اینڈ ، فعال تصدیق کرنے والی چابیاں ، پوزیڈن / پیڈرسن پیرامیٹر IDs ، اور رازداری کے قواعد ورژن پر اتفاق کرنا ہوگا۔ نوڈس غیر مماثل رازداری کی خصوصیت ڈائجسٹ کے ساتھ ہم مرتبہ یا بلاکس کو مسترد کرتے ہیں۔
...
6. `Unshield` عوامی رقم اور وصول کنندہ اکاؤنٹ کو ظاہر کرتا ہے، نجی نوٹ منسوخ کرنے والا خرچ کرتا ہے، اور نجی تبدیلی آؤٹ پٹ تشکیل دے سکتا ہے.
7. خفیہ واقعات، ثبوت ریکارڈز، باطل کرنے والے کی حیثیت اور گمنام اسکرور ریکارڈ کو ٹائپ کردہ سوالات اور Torii اختتامی پوائنٹس کے ذریعے پڑھ کر آڈٹ کرنا۔

## CLI مثالیں {#cli-examples}

ZK CLI کمانڈ آپریٹر اور ٹیسٹنگ فلو کے لئے ہیں۔ پیداوار والیٹس کو حاصل کردہ ہدایات جمع کرنے سے پہلے بٹوے / پروف لائبریری کے ساتھ مصروفیت، خفیہ شدہ مفید بوجھ اور ثبوت پیدا کرنا چاہئے.
...
محفوظ نوٹ کے لئے ایک ورژن خفیہ شدہ مفید بوجھ لفافہ بنائیں:
...
عوامی فنڈز کو اثاثہ کے محفوظ شدہ لیجر میں محفوظ کریں:
...
ایک پروف منسلک JSON کے ساتھ غیر محفوظ:
...
گمنام اثاثوں کے اسکرو ایک ہی شیلڈ ٹرانسفر مشینری کا استعمال کرتا ہے جس سے اسکرو ویلیو حاصل ہوتی ہے۔ پارٹیاں اور اسکرو کی حیثیت اب بھی اسکرو ریکارڈ میں درج ہیں ، لیکن فنڈنگ ، رہائی ، منسوخی ، اور ریزولوشن پاؤں شیلڈ نفی کرنے والے اور آؤٹ پٹ کے وعدے استعمال کرتے ہیں۔

تفصیلات کے لئے ISI اثاثہ جات کا رویہ اور مثالیں دیکھیں [ نیشنل اثاثہ اثاثہ ](/ur/blockchain/escrow.md#anonymous-escrow)۔
...
4. `ReleaseAnonymousAssetEscrow` خریدار کی پیداوار کے ذمہ داریوں پر اسرو عہد کو خرچ کرتا ہے۔
5. `CancelAnonymousAssetEscrow` جب ادائیگی کا نشان نہ دیا گیا ہو تو بیچنے والے کی پیداوار کے وعدوں پر اسرو عہد کو واپس خرچ کرتا ہے۔
6. `OpenAnonymousEscrowDispute` اور `ResolveAnonymousEscrowDispute` شواہد ہاشس کے ساتھ متنازعہ اسکوئرز کو سنبھالتے ہیں اور حل کرنے والے کنٹرول میں تقسیم کرتے ہیں۔

[سوالوں ](/ur/reference/queries.md#escrow-and-proof-records) میں درج گمنام اسرو سوالات کا استعمال اسرو ریکارڈ اور حیثیت کی جانچ پڑتال کرنے کے لئے کریں۔

...
- Alice کی چابی کے کنٹرول میں ایک کینونیکل اکاؤنٹ
- Mad Hatter کی کلید کے ذریعہ کنٹرول کردہ ایک کینونیکل اکاؤنٹ۔
- `wonderland.universal` کے تحت `tea` کے طور پر پیش گوئی کی گئی ایک اثاثہ تعریف
- اس اثاثے کا بیلنس جو ہر اکاؤنٹ کے پاس ہے

مقصد ایک ٹرگر کو رجسٹر کرنا ہے جو Alice کے چائے کے بیلنس کا مشاہدہ کرتا ہے اور جب میچنگ ڈیٹا واقعہ جاری ہوتا ہے تو Mad Hatter اکاؤنٹ سے منتقلی جمع کراتا ہے۔
...
SDK کے موجودہ ٹائپڈ بلڈرز کو حتمی لین دین کی پے لوڈ کے لئے استعمال کریں۔ عملدرآمد کرنے سے پہلے ہارڈ کوڈنگ پرانے ٹیکسٹ IDs میں ٹرگر کوڈ؛ تجزیہ یا استفسار کینیکل IDs سے بچیں.
...
## عمل درآمد کی ترتیب {#execution-order}

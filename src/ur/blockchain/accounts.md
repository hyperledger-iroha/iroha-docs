...
اکاؤنٹ بنانے کے لئے استعمال ہونے والے لین دین کا فائدہ مند بوجھ `NewAccount` ہے۔ اس میں شناختی ، میٹا ڈیٹا ، لیبل ، UAID ، اور غیر شفاف ID فیلڈز شامل ہیں جو رجسٹرڈ اکاؤنٹ کے ذریعہ استعمال ہوتے ہیں۔
...
- ذخیرہ شدہ میٹا ڈیٹا
- Nexus شناخت کے بہاؤ میں حصہ لیں جب ان خصوصیات کو فعال کیا جائے۔
...
- حکام کے پاس ہدایات کی ضرورت کی اجازت ہے

...
ٹرانزیکشنز ریاست کو تبدیل کرنے یا قابل عمل کام انجام دیتے ہیں۔ صرف پڑھنے کی جانچ پڑتال دستخط شدہ سوالات یا عوامی پڑھنے کے اختتام پوائنٹس کا استعمال کرتی ہے اور کوئی ٹرانزیکtionشن نہیں بناتی۔
...
یہ ابھی تک صرف پڑھنے کے لئے ہے۔ ٹرانزیکشن جمع کروانے کے لئے ایک دستخط شدہ Norito لفافہ ، صحیح سلسلہ ID ، فیس میٹا ڈیٹا اور نل سے فنڈ شدہ Taira اکاؤنٹ کی ضرورت ہوتی ہے۔

فیس ادا کرنے والے مثالوں کے لئے Taira, سے نل کے مددگار کو بچانے [ٹیسٹ نیٹ حاصل کریں XOR پر Taira](/ur/get-started/sora-nexus-dataspaces.md#_4-get-testnet-xor-on-taira) کے طور `taira_faucet_claim.py`, پھر دستخط کنندہ کو سب سے پہلے عوامی نل کے ذریعے فنڈ دیں:
...
اگر نل پازل یا دعوے کا راستہ `502` واپس آتا ہے تو، ٹرانزیکشن خود کو ڈیبگ کرنے سے پہلے انتظار کریں اور دوبارہ کوشش کریں.
...
تیاری والیٹ کو فعال پل ABI 21 اور مستند V4 آرٹیفیکٹ سیٹ سے جوڑتی ہے۔ نسب ، بھرنے اور بازیابی کی درخواستوں میں ٹائپ شدہ `application/x-norito` آرکائیو استعمال ہوتا ہے۔ آپریشن ریسورس کی طرف اشارہ کرنے والے `Location` ہیڈر کے ساتھ ٹاپ اپ اور ریفریجریشن ریٹرن `202 Accepted`؛ ایمبیڈڈ غیر صفر آپریشن ID idempotency کلید فراہم کرتا ہے.
...
3. جب ضرورت ہو تو وصول کنندہ رجسٹریشن نسب کو حل کریں، مقامی طور پر ہر ہم مرتبہ کی منتقلی کی تعمیر اور تصدیق کریں، اور منتقلی کو تسلیم کرنے سے پہلے خفیہ شدہ نوٹ کی حالت برقرار رکھیں.
...
لیجر آن لائن لائف سائیکل کے ذریعے نوٹ کی حالت واپس آنے تک متضاد آف لائن منتقلی کا مشاہدہ نہیں کرسکتا ہے۔ لہذا بٹوے اور آپریٹر پالیسی کو قیمت کی حدود ، ختم ہونے والی مدت ، قبول شدہ جاری کرنے والے ، دیرپا مقامی اسٹوریج اور مصالحہ ونڈوز پر عملدرآمد کرنا چاہیے۔

یہاں `Grant` ہدایات کے ساتھ ایک نیا لین دین بنانے کی ایک مثال ہے۔ اس لین دین میں ، ماؤس ایلس کو مخصوص کردار (`role_id`) دے رہا ہے۔ مکمل مثال [ چیک کریں ](./permissions.md#register-a-new-role).

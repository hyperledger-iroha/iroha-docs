...
شفاف عددی منتقلیاں ایک منظم منتقلی ٹرانسکرپٹ تخلیق کرتی ہیں جب ہدایات بیلنس کو تبدیل کرتی ہیں۔ ٹرانسکریپٹ ریکارڈ:

- ماخذ اکاؤنٹ، منزلہ اکاؤنٹ، اثاثے کی تعریف اور رقم
- منتقلی سے پہلے اور بعد میں بھیجنے والے اور وصول کرنے والے کے بیلنس
- ٹرانزیکشن انٹری پوائنٹ ہیش کے طور پر استعمال کیا جاتا ہے
- جمع کرانے والے اکاؤنٹ سے حاصل کردہ اتھارٹی کا ڈائجسٹ
- سنگل ڈیلٹا ٹرانسکرپٹ کے لئے پوزیڈون کا ڈائجسٹ
...
| --------------- | ------------------------------------------------ | ----------------------- | ---------------------- |
|بھیجنے والا ڈیبٹ |`asset/<asset-definition>/<source-account>` |بھیجنے والے بیلنس سے پہلے |بھیجنے والے بیلنس کے بعد|
|وصول کنندہ کریڈٹ |`asset/<asset-definition>/<destination-account>` |وصول کنندہ بیلنس سے پہلے | کے بعد وصول کنندہ بیلنس|
...
|ان پٹ |معنی |
| ------------- | --------------------------------------------------------------- |
|`dsid` |ڈیٹا بیس کی شناخت کے طور پر کوڈ little-endian بائٹس |
|`slot` |بلاک تخلیق کا وقت نینو سیکنڈ میں تبدیل |
|`old_root` |`execution witness` سے اخذ کردہ سابقہ حالت کی جڑ |
|`new_root` |`execution witness` سے اخذ کردہ بعد کی حالت کی جڑ |
...
بائٹ سٹرنگز کو 7 بائٹ لٹل اینڈین اجزاء میں پیک کیا جاتا ہے، تاکہ ہر جز لازماً `p` سے کم ہو:
...
ہر ٹرانسفر ڈیلٹا کے لئے، ہدف اعشاریہ پیمانے کی مقدار اور دونوں بیلنس snapshots بھر میں زیادہ سے زیادہ کٹایا پیمانے ہے:
...
منتقلی کی رقم کے لئے `a`, بھیجنے والا بیلنس `f`, اور وصول کنندہ بیلنس `t`, FastPQ ٹریس کی تعمیر سے پہلے معیاری شاہد اقدار کو درست کرتا ہے:
...
ملٹی ڈیلٹا ٹرانسفر ٹرانسکرپٹ کے لیے، موجودہ فارمیٹ کی ضرورت ہوتی ہے کہ یہ اعلیٰ سطح کا ڈائجسٹ نہ ہو۔

منتقلی ٹرانسکرپٹ کے لئے میزبان اتھارٹی کا ڈائجسٹ:
...
ٹرانسفر لائنز میں 32 سطحوں کا نایاب میرکل راستہ ہوتا ہے۔ اگر میزبان ثبوت غائب ہے تو ، پروور صف کی کلید سے ایک تعیناتی راستہ ترکیب کرتا ہے ، پہلے بیلنس ، اور یہ کہ آیا صف بھیجنے والا یا وصول کنندہ طرف ہے۔
...
- بھیجنے والے کا بیلنس صفر سے کم نہیں ہونا چاہیے، یعنی underflow نہیں ہونا چاہیے۔
...
ٹریس میں ٹرانسفر ، مائنٹ ، برن ، رول تفویض ، رول منسوخی ، میٹا ڈیٹا سیٹ ، اور اجازت تلاش کرنے کی قطاروں کے لئے سلیکٹر کالم شامل ہیں۔ عددی آپریشن لائنز میں دستخط شدہ ڈیلٹا بھی ہوتے ہیں ، ہر اثاثہ پر چلنے والے ڈیلٹا اور سپلائی کاؤنٹرز۔

## پروور لین {#prover-lane}

`iroha3d` شروع ہونے پر FastPQ prover lane کو شروع کرتا ہے اگر پروور بیک اینڈ کو ابتدائی بنایا جاسکتا ہے۔ لین ایک محدود قطار کے ساتھ پس منظر کا کام ہے۔ ایک بلاک کے عملدرآمد کے گواہ کی پیداوار کے بعد ، commit path ایک پروور ٹاسک پیش کرتا ہے جس میں بلاک ہیش ، اونچائی ، نظارہ اور گواہ شامل ہیں۔
...
دونوں ترتیبات بطور ڈیفالٹ `cpu` استعمال کرتی ہیں۔ `gpu` کا انتخاب ایک واضح fail-closed درخواست ہے: اگر GPU سپورٹ compile نہیں کی گئی یا مطلوبہ GPU backend preflight میں ناکام ہو جائے تو prover lane غیر فعال رہتی ہے۔ پہلی ریلیز میں کوئی `auto` قدر نہیں ہے اور مطلوبہ GPU mode سے CPU پر fallback نہیں کیا جاتا۔
...
اگر تصدیق کامیاب ہو جاتی ہے تو، Iroha ایک `VerifiedLaneRelayRecord` ذخیرہ کرتا ہے جس میں ریلے حوالہ، اصل لفافہ، ثبوت پے لوڈ ہیش، تصدیق کی اونچائی، manifest root، اور FastPQ binding شامل ہیں.
...
`authorization` دعوے میں رول تفویض لائن داخل کی جاتی ہے:
...
اور ایک میٹا ڈیٹا قطار authorization policy کو باندھتی ہے۔ `compliance` claim دو میٹا ڈیٹا قطاریں شامل کرتا ہے: ایک policy کے لیے اور ایک target dataspaces کے لیے۔
...
AXT بیچ مینی فیسٹ ڈائجسٹ کینیکل بائنڈنگ کی Norito کوڈنگ پر SHA-256 ہے۔
...
SCCP ہیلپر خانہ شفاف کراس چین پیغام پروف کے لئے بھی FastPQ کا استعمال کرتا ہے۔ یہ راستہ `iroha3d` پس منظر prover سے الگ ہے lane. یہ FastPQ بیچ کو براہ راست ایک SCCP پیغام ثبوت بنڈل اور مینی فیسٹ سے تعمیر کرتا ہے، پھر کھلی توثیق کے لئے نتیجے میں ہونے والے ثبوت کو لفٹ دیتا ہے.
...
| ------------- | ---------------------------------------------------------- |
|`dsid` |پہلے 16 بائٹس کے ایک Blake2b ڈائجسٹ بیان ہیش پر |
...
| ---------------------- | -------------------------- | ------------------------------ | ------------------------------------------- | ------------------------------- |
|`fastpq-lane-balanced` |متوازن prover throughput |Goldilocks quadratic extension |Poseidon2 commitments، catalogue SHA3 label |arity 8، blowup 8، 46 استفسارات |
|`fastpq-lane-latency` |latency-sensitive lanes |Goldilocks quadratic extension |Poseidon2 commitments، catalogue SHA3 label |arity 16، blowup 16، 34 استفسارات |
...
ٹیلی میٹری فعال ہو تو FastPQ، backend selection اور Metal runtime کے رویے کے metrics برآمد کرتا ہے:
...
|`fastpq_metal_queue_depth`|Metal queue کی حد، بیک وقت جاری کارروائیوں کی زیادہ سے زیادہ تعداد، dispatch کی تعداد، اور sampling window|
|`fastpq_metal_queue_ratio` |Metal queue کا مصروف اور overlap تناسب |
...
- [node-authoritative type snapshot کے لئے ڈیٹا ماڈل اسکیم](/ur/reference/data-model-schema.md)
- `FastpqTransitionBatch`
- `FastpqPublicInputs`
- `TransferTranscript`
- `AxtFastpqBinding`
- `LaneFastpqProofMaterial`
- [`iroha3d` FastPQ اختیارات ](/ur/reference/iroha3d-cli.md#fastpq-overrides)

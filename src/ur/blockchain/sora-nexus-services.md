...
ریلے کی حوصلہ افزائی کا انجکشن ناکامی سے بند ہے۔ جب `incentives.enable` درست ہے تو ، `incentives.trusted_verifier_ids` میں کم از کم ایک اور زیادہ سے زیادہ 64 کینونیکل اکاؤنٹ IDs ہونا چاہئے۔ رن ٹائم لسٹری کو بطور تعیناتی ترتیب شدہ سیٹ اسٹور کرتا ہے ، اور ریلے کے آغاز کے دوران غلط لسٹری جیومیٹری مسترد کردی جاتی ہے۔

ہر `RelayBandwidthProof` کو ایک مقررہ فریم / تفویض بجٹ کے تحت ڈیکوڈ کیا جاتا ہے اور اسے مکمل فریم استعمال کرنا چاہئے۔ ثبوت کا تصدیق کنندہ اکاؤنٹ ترتیب شدہ لسٹ میں موجود ہونا ضروری ہے ، اور `RelayBandwidthProof::verify_signature()` کامیاب ہونا ضروری ہے، ریلے سے پہلے اس کی کارکردگی کے accumulator بند یا تبدیل. ایک ناقابل اعتماد دستخط کنندہ یا دستخط غیر معتبر / مسخ شدہ ثبوت اس وجہ سے کوئی پیمائش میں شراکت نہیں کرتا ہے اور حوصلہ افزائی snapshot پیدا نہیں کر سکتے ہیں.
...
بائٹس پڑھنے سے پہلے ، Torii مقامی منشور کی کینونیکل کوڈنگ ، سیمانٹک پابندیاں ، ہضم اور جڑ CID کی توثیق کرتا ہے۔ اس کے بعد اس کے لئے مستند مقامی فراہم کنندہ کی شناخت ، گورننس کا اعتراف ، اور مینشور کی تعمیل اور ڈاؤن لوڈ کی جانچ پڑتال کی ضرورت ہوتی ہے ، CID ، اور فراہم کنندہ۔ گیٹ وے کی شرح / پابندی کی پالیسی کلائنٹ کے موثر ایڈریس کا استعمال کرتی ہے ، صرف ترتیب شدہ قابل اعتماد پراکسیوں کے ذریعہ آگے بڑھے ہوئے پتوں کو اعزاز دیتی ہے۔ غائب پالیسی ، تعمیل ، ہٹانا ، شناخت یا داخلہ ریاست بند نہیں ہوتی ہے۔

ایک درخواست میں اختتام سے اختتام تک عوامی گیٹ وے کی اجازت ہے؛ پورے عمل کی حد 64 بیک وقت پڑھتی ہے، اضافی درخواستوں کے ساتھ `503 Service Unavailable` اور `Retry-After: 1` واپس کرنا. واضح جوابات کو 16 MiB تک محدود کیا جاتا ہے ، فائل کی فہرستیں ڈیفالٹ کے طور پر 50 اندراجات اور زیادہ سے زیادہ 500 کو قبول کرتی ہیں ، اور ایک مکمل فائل یا واحد بائٹ رینج کو 8 MiB تک محدود کیا گیا ہے۔ CIDs ، سوالات ، میزبانوں ، راستوں اور رینج ہیڈرز کو ان کے کینونیکل سنگل ویلیو فارم استعمال کرنا چاہئے۔ فعال HTML ، اسکرپٹ، SVG، XML، PDF، یا Wasm مواد صرف ایک ترتیب شدہ CID سے مشتق الگ تھلگ ماخذ (یا وہاں ری ڈائریکٹ) سے خدمت کی جاتی ہے، جس سے مشترکہ راستہ-گیٹ وے ماخذ کو غیر قابل اعتماد مواد پر عملدرآمد کرنے سے روکتا ہے۔

### اعتدال پسندی کے چیلنجز {#moderation-challenges}

SoraFS اعتدال پسند چیلنج معیشت اتفاق رائے کی ریاست ہے۔ فعال پالیسی گورنمنٹ ووٹنگ اثاثہ اور گورنمنٹ اکاؤنٹس کا نام دیتا ہے جو اسرو اور کٹوتی کے لئے استعمال ہوتا ہے۔ ہر چیلنج میں اس اثاثے کے بالکل 150 یونٹ کی ضرورت ہوتی ہے۔ اسے بڑھانے سے بانڈ کو ایٹمی طور پر اسرو میں منتقل کردیا جاتا ہے۔ ایک کیس میں ڈپلیکیٹ چیلنج کی شناخت، اسی اکاؤنٹ کے ذریعہ دوسرا چیلنج یا بیلنس یا چیلنج کاؤنٹر تبدیل کیے بغیر دوبارہ استعمال شدہ ثبوت کو مسترد کیا جاتا ہے۔

چیلنج جمع کروانے کی آخری تاریخ اور چیلنج حل کرنے کی آخری تاریخ مختلف ہیں۔ گورنمنٹ کو کسی زیر التوا چیلنج کو قبول یا مسترد کرنے کے قریب پیشکشوں کے بعد بالکل 24 گھنٹے ملتے ہیں۔ منتظر چیلنجز بلاک ووٹنگ صرف اس قرارداد کی آخری تاریخ کے ذریعے ظاہر کرتی ہے:

- ایک قبول شدہ چیلنج کیس کو روکتا ہے اور پورے بانڈ کی واپسی کرتا ہے۔
- ایک مسترد چیلنج کیس کو جاری رکھتا ہے، سلاٹ وصول کرنے والے کے لئے بانڈ کا 25٪ بھیجتا ہے (ووٹنگ اثاثہ کی درستگی پر گول) ، اور باقی رقم واپس کرتا ہے؛ اور
- ایک غیر حل شدہ چیلنج گریس ونڈو کے بعد ختم ہو جاتا ہے، کھولنے میں ناکام رہتا ہے، اور مکمل بانڈ واپس کرتا ہے.

`ExpireSorafsModerationChallenge` پہلے ہی ختم ہوچکی ایک چیلنج کے لئے اجازت نہیں ہے اور بے اختیار ہے۔ کیس کو حتمی شکل دینا بیک اسٹاپ کی طرح ہی ختم ہونے والے معاہدے پر عملدرآمد کرتا ہے۔ لہذا غیر حاضر ہولڈر فنڈز کو بند نہیں چھوڑ سکتا یا انکشافات کو بلاک نہیں رکھ سکتا۔ ہر معاہدہ ایٹمی ہے: اگر کوئی رقم کی واپسی یا سلاٹ ٹانگ ناکام ہوجاتی ہے تو ، پورا معاہدہ واپس آرہا ہے۔

اعتدال کی پالیسی اور کیس ریکارڈ براہ راست پہلی ریلیز اسکیم کا استعمال کرتے ہیں۔ نوڈس ابتداء / ریاست کے آغاز کے دوران پہلے سے ہی کٹ برقرار رکھنے والے ترتیب کو مسترد کرتے ہیں۔ یا سنیپ شاٹ کی بحالی؛ ووٹنگ اثاثہ، ذخیرہ اندوزی اکاؤنٹس، ڈیڈ لائنز، یا معیشت کو ورثے کی حالت سے نکالنے کے بجائے ان فکسچر کو بحال کریں.
...
- عوامی Taira یا Minamoto استعمال کے لئے، [ سے شروع کریں SORA Nexus ڈیٹا بیسوں سے رابطہ کریں](/ur/get-started/sora-nexus-dataspaces.md).

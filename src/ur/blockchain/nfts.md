...
Iroha NFT ایک منفرد لیجر آبجیکٹ ہے جس میں ایک ہی مالک ہے۔ جب ریکارڈ کو اپنی شناخت ، میٹا ڈیٹا ، لائف سائیکل کے واقعات اور ملکیت کی منتقلی سیمینٹکس کی ضرورت ہو تو NFTs کا استعمال کریں ، لیکن عددی توازن کی ضرورت نہیں۔
...
NFT کے لئے مستحکم ناموں کا استعمال کریں IDs. ID ہدایات ، سوالات ، اجازت ، واقعہ فلٹرز اور ایپلی کیشن ریفرنسز میں استعمال ہونے والی اعتراض کی شناخت ہے۔
...
اجازت کی جانچ پڑتال فعال رن ٹائم توثیق کنندہ کے ذریعہ نافذ کی جاتی ہے ، لہذا نیٹ ورک ایگزیکٹر کو اپ گریڈ کرکے اجازت کو اپنی مرضی کے مطابق بنا سکتا ہے۔ موجودہ ڈیفالٹ ٹوکن لسٹ کے لئے [Permission Tokens](/ur/reference/permissions.md) دیکھیں.

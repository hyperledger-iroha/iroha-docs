...
- `git`
- اختیاری طور پر، Docker اور Docker Compose کے لئے مقامی کثیر ہم مرتبہ تیز رفتار شروع
...
آپ عام طور پر استعمال کریں گے تین بائنری ہیں:

- `irohad` پیئر ڈیمون کے لئے
...
موجودہ ماخذ کی حمایت یافتہ لوکل نیٹ فلو Kagami کے ذریعہ تیار کیا جاتا ہے۔ اس میں ہم مرتبہ ترتیب ، جینیس آرٹیفیکٹس ، کلائنٹ ترتیب ، مددگار اسکرپٹ اور ایک اختیاری کمپوز فائل لکھی جاتی ہے جو چیک آؤٹ کوڈ سے ملتی ہے:

- `kagami localnet` مقامی ہم مرتبہ اسکرپٹ کے لئے

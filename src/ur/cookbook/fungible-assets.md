...
براہ راست Taira اثاثہ تعریفوں کی جانچ پڑتال کریں اور ایک مقامی نیٹ ورک پر پیدا کردہ رجسٹر، منٹ، منتقلی، جلنے، اور بیلنس کی تصدیق کے بہاؤ کو مکمل کریں. نسخہ کینونیکل، بغیر سابقے والے Base58 asset-definition IDs، ڈومین کے لئے اہل ناموں، ڈومينلیس I105 اکاؤنٹ IDs، اور صریح فیس کی ادائیگی کا استعمال کرتا ہے۔
...
### مقامی مجاز اکاؤنٹس اور منزل کی تیاری کریں {#_2-prepare-the-local-authority-and-destination}

تخلیق کردہ ترتیب میں عوامی کلید سے مقامی مجاز اکاؤنٹس کو نکالیں اور وصول کنندہ کے طور پر ایک اور رجسٹرڈ اکاؤنٹ منتخب کریں۔ کوئی نجی کلید طباعت نہیں کی جاتی ہے۔
...
تمام لکھنے کے امجاز اکاؤنٹسات صریح طور پر فیس ادا کرنے والے مجاز اکاؤنٹس کو منتخب کرتے ہیں۔ CLI دستخط سے پہلے عین مطابق لین دین کا حوالہ دیتا ہے اور ڈیفالٹ کی حیثیت سے انتظار کرتا ہے۔
...
جلنے کے بعد، ذرائع بیلنس کی توقع کریں `64.50`, منزل کی بیلنس `25.50`, اور مجموعی مقدار `90.00`.

::: warning اجازت کی حد

Taira پر ، فوسیٹ سے ماخوذ `taira.tx-metadata.json` منسلک کریں اور ہر تحریر کے لئے `--fee-payer authority` کا استعمال کریں۔ رجسٹریشن اور مائننگ میں فعال تصدیق کنندہ کی اجازت درکار ہوتی ہے۔ منتقلی اور جلنے میں ماخذ بیلنس پر اختیار کی ضرورت ہوتی ہے۔ فوسیٹ سے مالی اعانت حاصل کرنے والا اکاؤنٹ خود بخود جاری کرنے والا نہیں ہوتا ہے۔

:::

## تصدیق کریں {#verify}

دونوں ٹھوس بیلنس اور پھر تعریف پڑھیں۔ یہ پوسٹ اسٹیٹ استفسارات کامیابی کے معیار ہیں؛ ایک جمع کرانے کی رسید خود ہی نہیں ہے.
...
- مرحلہ 2 جان بوجھ کر ایک رجسٹرڈ منزل اکاؤنٹ کا انتخاب کرتا ہے. اگر اثاثہ داخل `ExplicitOnly` ہے تو، ایک مجاز کے ذریعے منزل کی بیلنس فراہم کریں منتقلی سے پہلے بہاؤ۔ اسی طرح کا نام CLI گارڈ اکاؤنٹ یا بیلنس کو رجسٹر نہیں کرتا ہے؛ یہ ایک اور ہدایات شامل کرنے کے بجائے اس کی اجازت دیتا ہے۔
...
- [Rust مقررہ commit داری پر اثاثوں کی تعمیر کے مثالیں](https://github.com/hyperledger-iroha/iroha/blob/0010c5a70039eac101a4846499ba9ceaf43eb65c/crates/iroha/examples/tutorial.rs)

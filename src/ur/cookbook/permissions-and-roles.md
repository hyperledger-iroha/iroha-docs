...
ہر ریاستی تبدیلی CLI کمانڈ صریح طور پر فیس ادا کرنے والے کا نام دیتا ہے۔ میٹا ڈیٹا فائل میں فوسیٹ کے جواب سے حاصل موجودہ Taira فیس اثاثہ ہوتا ہے۔
...
کردار اور ان کی اجازتیں ختم نہیں ہوتی۔ جب اس تک رسائی کی ضرورت نہ ہو تو انہیں واضح طور پر منسوخ کریں۔
...
- `Not permitted` رجسٹریشن ، ترمیم یا کردار تفویض کرتے وقت مطلب یہ ہے کہ دستخط کنندہ کو مطلوبہ Taira اتھارٹی کی کمی ہے۔ گنجائش والے ٹوکن کو گلوبل کے ساتھ متبادل نہ کریں؛ عین مطابق تفویض کی درخواست کریں یا لوکل نیٹ استعمال کریں۔
- ایک پے لوڈ تجزیہ کی غلطی کا مطلب عام طور پر `account` `payload` کے ساتھ رکھا گیا تھا، I105 ID کے بجائے ایک عرفان فراہم کیا گیا تھا، یا JSON قدر دو بار حوالہ دیا گیا تھا.
- فیس کی مستردگی اس دستخط کنندہ سے تعلق رکھتی ہے جو یہ قدم پیش کرتا ہے۔ مینیجر کو فنڈ اور آزادانہ طور پر تفویض کرنا اور فوسیٹ سے حاصل کردہ فیس اثاثہ میٹا ڈیٹا برقرار رکھنا۔
- ایک کامیاب کردار کی تفویض اس کے ٹوکن میں کوڈ کردہ دائرہ کار سے تجاوز نہیں کرتی ہے۔ یہ کردار صرف اجازت بوجھ میں نامی اکاؤنٹ کو تبدیل کرسکتا ہے۔

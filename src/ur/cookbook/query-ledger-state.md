...
# استفسار شدہ لیجر ریاست {#query-ledger-state}

## نتیجہ {#outcome}

Taira JSON وسائل کو پڑھیں اور پروجیکٹ کریں ، پھر فلٹرز ، منطقی صفحہ بندی ، تالیف ، فٹچ سائز ، اور صرف فارورڈ کرسر تسلسل کے ساتھ ٹائپ کردہ Iroha سوالات کا استعمال کریں۔ آپ سرور سے آگے بڑھنے والے `--select` tuple کا جائزہ لینے سے پہلے سلیکٹر پروجیکشن پر انحصار کرنے سے بھی بچیں گے۔

## لازمی شرائط {#prerequisites}

- `curl` ، `jq`، Node.js 24، اور موجودہ `iroha` CLI.
- Taira تک رسائی صرف پڑھنے کے لئے۔
- دستخط شدہ ٹائپڈ سوالات کی مثالوں کے لئے، Taira کے لئے کلائنٹ ترتیب یا ایک مقامی نیٹ ورک پیدا کیا.
...
`ForwardCursor` اختیار سے منسلک ، عمل کے مقامی اور صرف فارورڈ ہے۔ اسے کبھی بھی تجزیہ نہ کریں ، اس کا ترکیب نہ کریں ، اسے حکام کے مابین بانٹیں ، یا اسے Torii کی مثالوں میں پورٹیبل ریزیومے ٹوکن کے طور پر برقرار رکھیں۔ اگر اس کی میعاد ختم ہوجاتی ہے تو ، ایپلیکیشن لیول چیک پوائنٹ کے ساتھ اصل استفسار کو دوبارہ شروع کریں۔
...
پیجائزڈ ایپلی کیشن سوالات کے لئے، یہ بھی ٹیسٹ کریں کہ IDs صفحات پر بار بار نہیں ہوتا ہے، مطلوبہ منطقی حد کبھی بھی تجاوز نہیں کی جاتی ہے، اور ختم ہونے والے کرسر کے بعد دوبارہ کوشش کرنا ایک دستاویزی چیک پوائنٹ سے دوبارہ شروع ہوتا ہے.
...
- وسیع لامحدود سوالات ہم مرتبہ کے کام، کلائنٹ میموری اور کرسر کی زندگی کا خطرہ بڑھاتے ہیں۔ ایک منطقی حد مقرر کریں اور صارف کے لئے مناسب سائز حاصل کریں۔
- عوامی JSON وسائل کے پیرامیٹرز اور دستخط شدہ ٹائپڈ استفسار کے پیرامیٹرس متعلقہ ہیں لیکن متبادل وائر فارمیٹس نہیں ہیں۔ ٹائپ کردہ استفسار لفافوں کے لئے SDK یا CLI کو ترجیح دی جاتی ہے۔

## ماخذ اور متعلقہ دستاویزات {#source-and-related-docs}

- [pinned commit پر cursor-backed pagination انضمام ٹیسٹ](https://github.com/hyperledger-iroha/iroha/blob/bc7114ed1c7f265a156d2100ff09e851cc95702c/integration_tests/tests/pagination.rs)
- [پنڈ commit](https://github.com/hyperledger-iroha/iroha/blob/bc7114ed1c7f265a156d2100ff09e851cc95702c/crates/iroha_data_model/src/query/builder/mod.rs) پر query builder اور selector کا رویہ۔
- [پنڈ commit](https://github.com/hyperledger-iroha/iroha/blob/bc7114ed1c7f265a156d2100ff09e851cc95702c/crates/iroha_data_model/src/query/parameters.rs) میں استفسار پیرامیٹرز اور کرسر ماڈل۔

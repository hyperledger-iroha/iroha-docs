...
- ایک اکاؤنٹ جو Taira نل یا نیٹ ورک کے زیر انتظام آن بورڈنگ پاتھ کے ذریعے محفوظ کیا گیا ہے اس سے پہلے کہ کسی اکاؤنٹ کی مخصوص پڑھنے کو کامیاب ہونے کا امکان ہو۔
...
ID سے `.id` سخت اکاؤنٹ فیلڈز کے لئے موزوں ہے۔ اس میں کوئی ڈومین شامل نہ کریں۔ `.primary_alias` سے ایک عرفی صارف کا سامنا کرنے والی تلاش کی کلید ہے ، اور کوئی دوسری قانونی شناخت نہیں ہے۔
...
- ایک اکاؤنٹ `404` ایک نل `202` کے بعد پھیلاؤ میں تاخیر ہوسکتی ہے. لکھنے بھیجنے سے پہلے اکاؤنٹ یا فنڈ شدہ اثاثہ کا سروے کریں.

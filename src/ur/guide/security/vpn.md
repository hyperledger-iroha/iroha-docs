...
براؤزر VPN یہ صرف اس براؤزر سے ٹریفک کی حفاظت کرتا ہے. `iroha3d`, CLI, SDK, SSH, میٹرکس، یا بیک اپ ٹریفک جب تک کہ ان عملوں کو ایک ہی نجی نیٹ ورک کے ذریعے روٹ نہیں کیا جاتا ہے.
...
`network.address` اور `network.public_address` میں موجودہ ہم مرتبہ کو تفویض کردہ ایڈریس کا استعمال کریں۔ ہر ہم مرتبہ کو ایک ہی قابل اعتماد ہم مرتبہ کی شناختوں کی فہرست بنانی چاہئے ، لیکن ایسے پتے کے ساتھ جو اس کی اپنی VPN روٹ ٹیبل سے قابل رسائی ہیں۔
...
- [ہم مرتبہ مینجمنٹ](/ur/guide/configure/peer-management.md)
- [ہم مرتبہ ترتیب حوالہ ](/ur/reference/peer-config/index.md)

...
Հաշիվի կեղծանունները օգտատերերի առջեւ ծառացած հաշիվների անուններն են: Նրանք գոյատեւում են հաշիվի վերականգնումից, քանի որ կեղծանվանները ցույց են տալիս ակտիվ հաշիվը ID ՝ աշխարհի պետությունների ինդեքսների եւ հաշվի վերականգնման արձանագրությունների միջոցով. Օգտագործեք `SetPrimaryAccountAlias` հաշվի առաջնային մակնիշի համար, `SetAccountAliasBinding` լրացուցիչ ոչ առաջնային կեղծանունների համար եւ `FindAccountByAlias` կամ `FindAliasesByAccountId` ընթերցումների համար: Հաշվեի կեղծանվանները սովորաբար պահանջում են ակտիվ SNS հաշիվի կեղծանու վարձակալություն, որը ձեռք է բերվել `AcquireAccountAliasLease`-ով եւ վերականգնվում է `RenewAccountAliasLease`-ով:

Աշունների կեղծանունները անվանում են ակտիվի սահմանումները, այլ ոչ թե առանձին հաշիվների բալանսերը: Աշունային կեղծանվաններն ու պայմանագրային կեղծնիները ուղղակիորեն կապում են ընթերցելի անունից գոյություն ունեցող կանոնական նպատակին: Գույքի կեղծանունները սահմանվում են `SetAssetDefinitionAlias`; կեղծանու անվանումի սեգմենտը պետք է համապատասխանի ակտիվի սահմանման ցուցադրման անունին կամ նախագծված սահմանման անունը: Պայմանագրի կեղծանվանները սահմանվում է `SetContractAlias`; կեղծանուի տվյալների տարածքը պետք է համապատասխանի պայմանագրային հասցեում կոդավորված տվյալների տարածքին: Երկուսն էլ կարող են կրել `lease_expiry_ms`; ժամկետը լրանալուց հետո նրանք դադարեցնում են լուծումը, երբ անցնում է շնորհի պատուհանը եւ քաշվում են համաշխարհային պետությունների ցուցանիշներից:

...
Նպատակը բացահայտում է `payments.universal`, նրա թվային տվյալների տարածքը, կանոնական I105 սեփականատերը, վարձակալության ձեռքբերման ժամկետը եւ ընթացիկ քաղաքականություն / վճարման գծապատկեր պահապան: Planner- ի վերջնական կետը `POST /v1/aliases/setup/plan` է; նրա վերադարձված պլանը կապ ունի շղթայի, իշխանության, պետության եւ ժամկետի հետ: Դոմեյնի հեռացումը դեռ օգտագործում է [`Unregister`](/hy/blockchain/instructions.md#un-register):

...
Գրանցվեք լեզվական հատուկ ուղեցույցներից մեկին, որը կօգնի ձեզ գրանցել օբյեկտները բլոկչեյնում.
...
Գույքի քանակությունը ոչ բացասական է, այնպես որ դուք երբեք չեք կարող ունենալ `$-1.0` ակտիվի կամ այրել բացասական գումար եւ ստանալ դրամապանակը.

Գտեք լեզվական հատուկ ուղեցույցներից մեկը, որը կօգնի ձեզ քայլել բլոկչեյնում ակտիվների մինինգի գործընթացի միջոցով.
...
Iroha նաեւ բացատրում է գործնական ժամանակի եւ կատարողի ինտեգրման համար ավելի ցածր մակարդակի հրահանգներ.

...
Թվային փոխանցումները ստեղծում են կառուցվածքային փոխանցման տրանսկրիպտ, երբ հրահանգը փոխակերպում է մնացորդները:

- աղբյուրի հաշվին, նպատակային հաշվին, ակտիվների սահմանմանը եւ գումարը
- ուղարկողի եւ ստացողի մնացորդը փոխանցումից առաջ եւ հետո
- գործարքի մուտքային կետի հեշը, որն օգտագործվում է որպես խմբաքանակի հեշ
- ներկայացնող հաշվետվությունից ստացված լիազոր հաշվի ցուցակը
...
Բլոկի վերջնականացման ժամանակ Iroha խմբավորում է այս տրանսկրիպտերը մուտքային կետի հեշի համաձայն: Գործադրման վկանը ապա տեղափոխում է ինչպես սկզբնական տրանսկրիտների փաթեթները, այնպես էլ FastPQ անցումային խմբաքանակները, որոնք պատրաստված են պրոֆերի համար:

Յուրաքանչյուր տրանսֆերային դելտա դառնում է երկու անցումային շարքեր.

|Սարք |Գլխավոր ձեւ |Նախագծային արժեք|Հետագա արժեք |
| --------------- | ------------------------------------------------ | ----------------------- | ---------------------- |
|Հեռորդի դեբետ |`asset/<asset-definition>/<source-account>` |նախորդ ուղարկողի մնացորդը |ուղարկողի մնացորդը |
|Ստացողի կրեդիտը|`asset/<asset-definition>/<destination-account>` |ստացողի հաշվեկշիռը՝ առաջ |ստացողի հաշվեկշիռը՝ հետո |
...
|`old_root` |Կատարման վկայից ստացված սկզբնական վիճակի արմատ |
|`new_root` |Կատարումից հետո վիճակի արմատը՝ ստացված կատարման վկայից |
...
Իրագործումը պայմանական կերպով ավելացնում կամ հանում է `p` մինչեւ արդյունքը կանոնիկ լինի: ստորագրված ամբողջ թվերը, ինչպիսիք են մնացորդի դելտանները, ներմուծվում են հետեւյալ կերպ.
...
Յուրաքանչյուր փոխանցման դելտայի համար նպատակային տասնամյակի մասշտաբը չափի եւ երկու մնացորդի ակնթարթների առավելագույն կտրված մասշտաբն է.
...
Տրանսֆերային գումարի համար `a`, ուղարկողի մնացորդի համար `f` եւ ստացողի հավասարում `t`, FastPQ հավաստիացնում է վկաների նորմալացված արժեքները նախքան հետագա կառուցումը.
...
Ընտրական միավոր դելտա փոխանցման դիջեսը commit է կոդավորված փոխանցման նախանկարը.
...
Հյուրընկալող լիազոր հաշիվը փոխանցման տրանսկրիպտերի համար ներմուծում է հետեւյալը.
...
Փոխանցման տողերը կրում են 32 մակարդակի պակաս Merkle ուղին: Եթե բացակայում է հյուրընկալող ապացույցը, prover- ը համադրում է որոշիչ ուղին տողերի բանալից, նախնական մնացորդից եւ թե արդյոք տողը ուղարկողի կամ ստացողի կողմն է:
...
Վերջին հանձնառությունը տիրույթի, պարամետրերի հավաքածուի վրա բայթային հեշ է, տիրույթի ձեւը, գնդակի դիժեստը եւ տիրույթի արմատը.
...
Վավերացնողը վերաշվարկում է `A_i` նմուշագրված շարքի բացությունների համար եւ այն ստուգում AIR կազմի Merkle արմատով հաստատված բաղադրիչային արժեքի հետ:
...
Իրականացումը սա հաշվարկում է՝ գործակիցները FFT-ից առաջ կոսետի շեղման աստիճաններով բազմապատկելով.
...
FRI-ը commit է կատարել AIR կազմի գնահատականներ: Յուրաքանչյուր փուլ `l` -ի համար տրանսկրիպտային նմուշները մարտահրավեր են վերցնում `beta_l`։ Լայնը լցվում է հորիզոնականի բազմապատիկի վրա՝ կրկնելով վերջին արժեքը։ Յուրաքանչյուր հորիզոնի չափով խումբ բարդում է հետեւյալ կերպ.
...
Քանոնիկ պարամետրերի կատալոգը վերագրման հեշը նշում է որպես SHA3-256. Ներկայիս պրովեր եւ ստուգիչի իրականացումը բխում է մարտահրավերային բայտներից ՝ `iroha_crypto::Hash::new`, որը 32-բայթ Blake2bVar դիժեսն է, այնուհետեւ նվազեցնում է առաջին ութ փոքր-հանդիսական բայտները `F`:
...
Հարցման նմուշագրությունը շարունակում է նկարել 32-բայթանոց մարտահրավերային դիջետներ եւ կարդալ դրանք որպես փոքր-ինչ `u64` կտորներ, մինչեւ այն ունենա պահանջված յուրահատուկ ինդեքսների թիվը.
...
- ուղարկողի մնացորդը չպետք է նվազի
...
- տրամադրված sparse-Merkle ապացույցները պետք է վերծանվեն որպես 1-ին տարբերակ. բացակայող ուղիները լրացվում են դետերմինիստական սինթետիկ ապացույցներով
...
`iroha3d` սկսում է FastPQ պրովեր լեյնը մեկնարկելիս, եթե պրովերի հետագա վերջը կարող է նախաձեռնվել: Լեյնը ֆոնային գործ է սահմանված հերթով: Երբ բլոկը արտադրում է կատարման վկան, commit ուղին ներկայացնում է պրովոր աշխատանք, որը պարունակում է բլոկի շաշը, բարձրությունը, տեսքը եւ վկանը:

Եթե lane-ը չի աշխատում կամ հերթը լիքն է, աշխատանքը բաց է թողնվում, իսկ բլոկի սովորական մշակումը շարունակվում է։ Այսինքն՝ ֆոնային prover lane-ը գործարքների ընդունման կամ consensus-ի դարպաս չէ։ Այն արդեն կատարված վիճակի համար ապացույց արտադրող ուղի է։
...
Երկու կարգավորումները նախանշվում են `cpu`։ Ընտրելով `gpu`-ը բացասական, անջատված խնդրանք է. եթե GPU-ի աջակցությունը չի կազմվել կամ պահանջված GPU backend- ը ձախողվում է թռիչքից առաջ, prover lane- ն անջատված է մնում: Առաջին թողարկումը չունի `auto` արժեք եւ չի ընկնում պահանջվող GPU ռեժիմից դեպի CPU
...
Եթե ստուգումը հաջողվում է, Iroha-ը պահում է `VerifiedLaneRelayRecord`, որը պարունակում է ռելեյի հղումը, օրիգինալ փաթեթը, ապացուցման օգտակար բեռնվածության հեշը, ստուգման բարձրությունը, manifest root-ը եւ FastPQ կոճակը։
...
և authorization policy-ն կապող metadata տող։ `compliance` պահանջը ավելացնում է երկու metadata տող՝ մեկը policy-ի, մյուսը target dataspaces-ի համար։
...
SCCP օգնական տուփը նաեւ օգտագործում է FastPQ թափանցիկ խաչմերուկային հաղորդագրությունների ապացուցման համար: Այս ուղին առանձին է `iroha3d` ֆոնային prover ից: Lane. Այն կառուցում է FastPQ խմբաքանակը անմիջապես SCCP հաղորդագրության ապացույցի փաթեթից եւ մանիֆեստից, այնուհետեւ ծածկում է արդյունաբերված ապացույցը բաց ստուգման համար:
...
| ---------------------- | -------------------------- | ------------------------------ | ------------------------------------------- | ------------------------------- |
|`fastpq-lane-balanced` |հավասարակշռված պրովերային անցում |Goldilocks քառակուսի ընդլայնում |Poseidon2 պարտավորությունները, կատալոգը SHA3 |Արթուր 8, պայթյուն 8, 46 հարցումներ |
|`fastpq-lane-latency` |լատենցիային զգայուն ուղիները |Goldilocks քառակուսի ընդլայնում |Poseidon2 պարտավորությունները, կատալոգը SHA3 |Arity 16, blowup 16, 34 հարցումներ |
...
- [Տվյալների մոդելային սխեման](/hy/reference/data-model-schema.md) բջիջային հավատարիմության տիպի արձանագրության համար
- `FastpqTransitionBatch`
- `FastpqPublicInputs`
- `TransferTranscript`
- `AxtFastpqBinding`
- `LaneFastpqProofMaterial`
- [`iroha3d` FastPQ տարբերակներ](/hy/reference/iroha3d-cli.md#fastpq-overrides)

...
5. Նշեք DA փաթեթի մտադրությունը կամ մատչելիության պարտավորությունը, երբ նպատակային պրոֆիլը պահանջում է հստակ ապացույցներ:
...
Aitai-ն շուկայական կարգավորման համար SORA հավելվածի միջանցքն է, որտեղ գնորդը եւ վաճառողը համակարգում են օֆշեյնի վճարումը, մինչդեռ Iroha վերահսկում է առցանց ակտիվների պահպանումը: Գործակալությունը պետք է նոր թվային ակտիվների պահպանումի հոսքերի համար օգտագործի տեղական գրավականային կարգավորման ընտանիքը, այլ ոչ թե պայմանագրային սեփականության գրավականային հաշիվ:

Native escrow- ը պահում է պահպանումը գլխավոր գրքում: Վաճառողը բացում է առաջարկը `OpenAssetEscrow`, գնորդը ընդունում եւ նշում է օֆ շղթանային վճարումը `AcceptAssetEscrow` եւ `MarkEscrowPaymentSent`, իսկ վաճառողը թողնում է `ReleaseAssetEscrow` կամ չեղարկում է վճարումը նշվելուց առաջ: Եթե գնորդն ու վաճառողը համաձայնություն չունեն, կողմերից մեկը կարող է վեճ բացել եւ `CanResolveEscrowDispute`-ի հետ լուծողը կարող է բաժանել փակված գումարը:
...
|`OpenAnonymousAssetEscrow`, `AcceptAnonymousAssetEscrow`, `MarkAnonymousEscrowPaymentSent`, `ReleaseAnonymousAssetEscrow`, `CancelAnonymousAssetEscrow` |Պաշտպանված առաջարկներ, երբ ֆինանսավորման եւ փակման շարժումները կատարվում են ապացույցների հավելվածներով: |
...
|`HttpService` |`Inrou` |Live HTTP APIs, հավաքիչների ծանր աշխատանք, պահեստային աջակցությամբ ծառայություններ, SSE, բրաուզերներով օժանդակված հոսքեր |

Կառավարման ինքնաթիռը հեղինակավոր է: Զեղուցեք, թարմացրեք, վերադարձրեք, կոմֆիգացրեք, գաղտնիքներ, մոդել եւ կարգավիճակ հրամանները ուղարկեք Torii եւ կարդացեք պարտավորված համաշխարհային վիճակը. դրանք չեն հիմնվում մեկ առանձին CLI տեղական հայելու վրա: Հանրային երթեւեկությունը հիմնված է ամենաերկար նախադրյալի վրա, այնպես որ մեկ գրանցված հյուրընկալող կարող է բաժանել երթեւանությունը հյուրասիրված HTTP երթուղիների եւ deterministic API երթուղների միջեւ:
...
Inrou-ն հյուրընկալվում է HTTP վազման ժամանակը, որն օգտագործվում է Soracloud. Մինետ Iroha ներմուծված հանգույցի հետ Soracloud ընդունված վազման ժամանակի նախագծեր Soracloud տեղական նյութափոխանակության ծրագրի մեջ, սկսում է վերը նշված հյուրընկալված ծառայությունների կրկնօրինակները որպես loopback ծառայություններ, եւ զեկուցում է Replica runtime վիճակը վերադառնալ հեղինակավոր մոդել.
...
- DA արձանագրում է պարտավորությունները, ապացույցի քաղաքականությունները, ապացուցման բացումները եւ պին մտադրությունները, որոնք թույլ են տալիս այդ բայթներին պլանավորել, վերլուծել եւ կապել գրքի վիճակի հետ:

Օգտագործեք DA, երբ հավելվածի կամ Nexus երթուղու համար անհրաժեշտ է հաշվառման տեսանելի խոստում, որ դուրս շղթայի տվյալները մնում են վերականգնվող: Հաճախակի օրինակներ ներառում են երթուղի օգտակար բեռնվածության պարտավորությունները կարգավորման հոսքերի համար, SoraFS փոստային մտադրություններ հրապարակված բովանդակության համար, ապացույցների փաթեթները, որոնք պետք է պահպանվեն հետագա ստուգման համար, եւ կիրառման արվեստի գործիքներ, որոնց հանրային վիճակը պետք է լինի ամբողջական բեռնվածքի փոխարեն:
...
1. Կառուցեք կամ ստացեք օգնական բեռը WSV-ից դուրս, օրինակ՝ SoraFS CAR ֆայլ կամ Nexus երթեւեկի օգնական բեռն:
...
1. Canonicalize the submitted payload. Torii ընդունում է ներբեռնումի խնդրանք ՝ օգտագործելով `(lane_id, epoch, sequence)`, payload բայթներ, կոճման մետադատա, մասերի չափը, ջնջման պրոֆիլը, պահեստավորման քաղաքականությունը եւ ուղարկողի ստորագրությունը: Նոդը պահանջի դեպքում կսպասում է gzip, deflate կամ Zstandard օգտակար բեռները, ապա ստուգում է, որ կանոնական բայթերի երկարությունը հավասար է `total_size`:
2. Վավերացրեք գոտի եւ մասային պարամետրերը: Գոտին պետք է լինի Nexus գոտի կատալոգում: `chunk_size` պետք է լինի ոչ զրոյական ուժ ՝ երկու, առնվազն երկու բայտ, եւ ոչ ավելի մեծ, քան սահմանված առավելագույնը: Սեղմման պրոֆիլը պետք է ներառի տվյալների կտորներ եւ առնվազն երկու հավասարության կտորներ: Ճանապարհային կատալոգում ընտրվում է ապացուցման համակարգը, կամ `merkle_sha256` կամ `kzg_bls12_381`:
...
5. Բարձրացրեք ջնջման պարտավորությունները: Մասերը խմբագրվում են `data_shards` գծերով: Վերջնական գծի բացակայող բջիջները զրոյական են զուգահեռության հաշվարկի համար: RS(16) Զուգահեռությունը ստեղծում է շարքի / գլոբալ զուգահեռնային հատվածներ. ընտրանքային `row_parity_stripes` ավելացնել սյունակի ոճով գիծի զուգահաշար ամբողջ մատրիչում: Parity shard պարտավորությունները BLAKE3 փոքր-հասարակական `u16` խորհրդանիշների դիժեր են:
...
8. Torii հաշվարկում է PDP պարտավորությունը, ստորագրում `DaIngestReceipt`, կառուցում է `DaCommitmentRecord` եւ գրում spool artefacts manifesto- ի համար, PDP պարտավորության արձանագրություն, պարտավորության գրանցում, պարտավորությունների ժամանակացույցը, pin մտադրությունը, ստացուցակի ֆայլը եւ ստացուցքի օրագիրը: Գլխավոր գրասենյակը առաջ շարժվում է monotonically per `(lane_id, epoch)`.

Հանձնառության փաստաթղթերը այն են, ինչ բլոկները կրում են:
...
Բլոկի գլուխը պահում է DA ապացույցների քաղաքականությունների, պարտավորությունների եւ փաթեթավորման մտադրությունների համար: Անդամության ապացուցումների համար պարտավորության փաթեթն նաեւ բացահայտում է Merkle արմատ, որի տերեւները կանոնիկ Norito կոդավորված `DaCommitmentRecord` արժեքների հաշեներ են։ Ծնողական բջիջները շփում են ձախ եւ աջ երեխաներին: Զարմանալի տերեւը անփոխարինելիորեն տեղափոխվում է հաջորդ շերտ:
...
Iroha 3 կոնսենսուսային պրոֆիլները ներառում են RBC- ի աջակցությամբ օգտակար բեռի տարածումը, manifest պահպանումները, DA փաթեթի հավաստագրումը եւ վերականգնման հեռաչափությունը: Համանախագահների ձեւանմուշը բացահայտում է `[sumeragi.da]` պարտավորությունների սահմանները եւ ապացուցման բացումները յուրաքանչյուր բլոկի համար. գումարած `[sumeragi.advanced.da]` ժամանակահատվածի բազմապատկիչները քվորումի եւ մատչելիության վարքի համար: Պահպանեք այս կարգավորումները համատեղելի են մեկ ցանցային պրոֆիլում վավերացողների միջեւ:
...
Օգտագործեք [ հարցման հղումը](/hy/reference/queries.md#nexus-data-availability-and-packages) ընթացիկ DA հարցման անունների համար, եւ [ զուգընկերների կազմավորման ձեւանմուշը](/hy/reference/peer-config/) ձեր կառուցվածքի կողմից բացահայտված տեղական `[sumeragi.da]` կոճակների համար:

## SoraFS {#sorafs}

SoraFS -ը բովանդակության վրա հասցեագրված ապակենտրոնացված պահեստային հյուսվածք է: Այն փաթեթավորում է բայտները դետերմինիստիկ կտորներ, CAR արխիվներ եւ Norito դրսեւորումներ, որոնք կապում են բովանդակության արմատները, կտորների պրոֆիլները, փայտի քաղաքականությունները եւ կառավարման վկայականները: Սպառման մատակարարները գովազդում են հզորության եւ բովանդակության հասանելիության մասին, մինչդեռ մուտք գործիչները ստուգում են մանիֆեսներն ու բաժնետոմսային պարտավորությունները' բովանդակությունը մատուցելուց առաջ:
...
SoraDNS -ը SORA ծառայությունների եւ բովանդակության համար դետերմինիստիկ անվանումների շերտ է: Այն կարգավորում է անունները, ամրացնում է լուծողի ցուցակային թարմացումները Iroha-ում, եւ բաժանորդագրվում է ստորագրված գոտի կամ լուծողի փաթեթների միջոցով SoraFS: Բանաձեւիչները եւ մուտք գործիչները վավերացնում են լուծողի վկայականի փաստաթղթերը, նախքան վստահել հայտնաբերման մետադատային տվյալներին:
...
`/soradns/<alias>/...` fallback- ը նախընտրելի հանրային չէ URL. Օգտագործման գործիքներ, հավելվածների մանիֆեսներ եւ առաջադեմ կողմի կարգավորումը պետք է նախընտրեն ինքնաբերական հյուրընկալողին: Եթե alias- ը ակտիվ չէ Taira- ում, բրաուզերային դարպասը կամ հետադարձ ուղին կարող է վերադառնալ `404` կամ ձախողել TLS- ը նախքան ծրագրի երթեւեկությունը սկսելը:
...
BFV նույնականացման ուղին օգտագործվում է գաղտնիությունը պահպանող գրանցման համար: Հաճախորդը կարող է կոդավորված նույնականացում ներկայացնել Torii բանաձեւում: Բանաձեւը այն գնահատում է ակտիվ նույնականացման քաղաքականության համաձայն, ստանում է `OpaqueAccountId`, եւ ուղարկում է վիտամոն: `ClaimIdentifier`-ը այնուհետեւ կապում է այդ ստուգումը նպատակային հաշիվին միացված UAID գրասենյակի հետ:
...
`FheJobSpecV1::validate_for_execution` ստուգում է, որ աշխատանքը, կատարման քաղաքականությունը եւ պարամետրերի հավաքածուն համաձայն են ընդունվելուց առաջ: Այն նաեւ կիրառում է շահագործման հատուկ կանոններ. ավելացնել եւ բազմապատկել պետք է առնվազն երկու մուտք, պտտել եւ bootstrap անհրաժեշտ է ճիշտ մեկ մուտք, եւ պահանջված խորություն, պտույտի քանակը, bootstrap- ի քանակը, մուտքի քանակ, Օգտակար բայթներ, եւ deterministic արտադրանքի չափը պետք է մնա քաղաքականության սահմաններում. Ciphertext հարցման արդյունքները չպետք է վերադարձնել plaintext շարքերը:

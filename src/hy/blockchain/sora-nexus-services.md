...
SORA Nexus հավելում է ծրագրային ուղղությամբ սպասարկման ինքնաթիռներ Iroha 3-ի շուրջ: Այս ծառայությունները առանձին գրասենյակներ չեն: Նրանք ամրագրվում են Iroha համաշխարհային պետության, Norito մանիֆեսների, կառավարման գրանցումների եւ Torii երթուղիների ընտանիքների կողմից:

Գործունակությունը կախված է բջիջների կառուցվածքից եւ ցանցի պրոֆիլից: Օգտագործել [`/openapi`](/hy/reference/torii-endpoints.md#app-and-sora-route-families) ստեղծված հավելվածների հայտնաբերման համար:API նպատակային հանգույցի երթուղիները: SoraFS CID եւ հայտնի երթուղիները տեղադրված են ստեղծված փաստաթղթից դուրս, այնպես որ ստուգեք այդ երթուղները անմիջապես տեղակայման ժամանակ:
...
|SoraNet |Պrivacy եւ տրանսպորտային overlay շրջանների, ռեալի երթեւեկության, VPN, Connect նստաշրջանները, եւ հոսքի ուղիները. |`/v1/connect/`, `/v1/vpn/`, SoraNet երթուղի մետադատա |
...
| ----------------- | --------------------- | ------------------------------------------------- |
| `/`               |SoraFS ստատիկ պարունակություն |Վերարտադրելի բովանդակության արմատային եւ մուտքային պահեստավորման |
|`/assets/*` |SoraFS ստատիկ պարունակություն |Բովանդակության վրա հասցեագրված ակտիվներ եւ ապացույցներ |
...
5. Նշեք DA փաթեթային մտադրություն կամ մատչելիության պարտավորությունը, երբ նպատակային պրոֆիլը պահանջում է հստակ ապացույցներ:
6. Հաշվետը միացրեք SoraDNS անվանումի կամ Soracloud ստատիկ առաջատար երթուղու վրա:

### Անձնական տրանսպորտային կամ հեռարձակման ուղին {#private-fetch-or-streaming-route}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
|`OpenAssetEscrow`, `AcceptAssetEscrow`, `MarkEscrowPaymentSent`, `ReleaseAssetEscrow`, `CancelAssetEscrow` |Թվային ակտիվների թափանցիկ առաջարկներ, ներառյալ XOR դոմինատացված հաշվետվությունների հոսքերը: |
...
Նախքան այս էջից օրինակներ օգտագործելը հաստատեք, որ երթուղի ընտանիքը գոյություն ունի թիրախավորվող հանգույցում.
...
Եթե `/openapi.json` չի բացահայտվում պրոֆիլից, փորձեք `/openapi`. Ճշգրիտ երթուղու մատչելիությունը կախված է կառուցման առանձնահատկություններից եւ ցանցի կազմաձեւումից: Փաստաթղթում չեն թվարկվում հանրային տեղական SoraFS CID եւ հայտնի երթուղիները. ստուգեք այդ վերջակետները անմիջապես, ինչպես նկարագրված է ստորեւ:

### Taira Կարդալ միայն ծխախոտի ստուգումներ {#taira-read-only-smoke-checks}

Հասարակական Taira վերջային կետը օգտակար է ընթերցման կողմի ստուգումների համար, բայց մի օգտագործեք այն մուտացիոն օրինակների համար, եթե չեք վարում թույլատրված հաշիվ եւ մտադիր եք փոխել հանրային թեստնետի վիճակը:
...
Taira-ը կարող է բացահայտել տեղակայման հատուկ վերահսկողության ինքնաթիռի երթուղիներ, որոնք նշված չեն OpenAPI ճամփորդության քարտեզում: Պարվել `/openapi`-ին որպես այն պարունակող երթուղիների համար ստեղծված պայմանագիր, ապա անմիջապես հաստատել տեղական եւ տեղական SoraFS երթուղիները տեղակայման համար, նախքան դրանք փաստագրելը որպես մատչելի.
...
Soracloud օգտագործվում է երկու իրականացման ինքնաթիռներ.

|Գործադրանքի ինքնաթիռը|Գործընթաց |Օգտագործեք այն |
| ---------------------- | ------- | -------------------------------------------------------------------------------------------- |
|`DeterministicService` |`Ivm` |Հեղինակ, պահեստային վիճակ, հավաստագրված ընթերցումներ, պատվիրված փոստային գրասենյակներ, կառավարման համար զգայուն մուտացիաներ |
...
### Սթափեցրեք Split App- ը {#scaffold-a-split-app}
...
### Հավելվածի տեղակայման եւ ստուգման վիճակը {#deploy-and-inspect-app-state}
...
- Ծառայության մանիֆեսի իրականացման հարթակը պետք է լինի `HttpService`.
...
### Սթրիմինգի կարգավորում {#streaming-configuration}
...
Օգտագործեք `access_kind = "read-only"` բովանդակության երթուղիների համար, որոնք չեն պահանջում դիտորդի հավատարմագրումը: Օգտագործիր `authenticated`, երբ ելքային ռեալիը պետք է ուժի մեջ դնի տոմսերը կամ դիտորդի ինքնությունը, նախքան կապելը Torii կամ հյուրընկալվող ծառայության հետ.
...
### Relay Incentive Verifier Roster-ը {#relay-incentive-verifier-roster}

Relay խրախուսման ընդունումը մերժում է ապացույցները, եթե բոլոր պահանջվող ստուգումները չեն հաջողվում: Եթե `incentives.enable` ճիշտ է, ապա `incentives.trusted_verifier_ids`-ը պետք է պարունակում է առնվազն մեկ կանոնիկ հաշիվ ID. Գրանցումը երբեք չպետք է գերազանցի 64 մուտքը, նույնիսկ այն ժամանակ, երբ խրախուսումները անջատված են: Runtime- ը պահպանում է այն որպես դետերմինիստական կարգավորված հավաքածու եւ մերժում է անվավեր գրանցման երկրաչափությունը ռելեային մեկնարկի ընթացքում:

Յուրաքանչյուր `RelayBandwidthProofV1` կոդավորվում է ֆիքսված շրջանակի/բաշխման բյուջեի ներքո եւ պետք է սպառի ամբողջական շրջանակը: Ապացուցման վավերացնող հաշիվը պետք է լինի կազմավորված ցուցակում, եւ `RelayBandwidthProofV1::verify_signature()`-ը պետք է հաջողվի, նախքան ռելեյը փակվի կամ փոխվի իր կատարողական կուտակիչը: Հեռարձակումը անտեսում է ոչ վստահելի ստորագրող կամ ստորագրության անվավեր/խախտված ապացույցը: Նման ապացույցն ավելացնում է ոչ մի չափում եւ չի կարող ստեղծել խրախուսող ակնթարթ:
...
1. Torii ընդունում է ներբեռնումի խնդրանք, որը պարունակում է `(lane_id, epoch, sequence)`, օգտակար բեռնվածության բայտներ, կոճման մետադատա, կտորների չափը, ջնջման պրոֆիլ, պահպանումի քաղաքականությունը եւ ուղարկողի ստորագրությունը: Նոդը պահանջելիս կոմպրեսում է gzip, deflate կամ Zstandard օգտակար բեռնվածքները, այնուհետեւ ստուգում է, որ կանոնական բայթ երկարությունը հավասար է `total_size`:
...
- RBC վերականգնել է օգտակար բեռը համընկնում բլոկի hash, բարձրություն, տեսք, եւ օգտակար բեռնվածության hash.
...
Տիպիկ SoraFS օգտագործումները ներառում են ստատիկ ծրագրային ակտիվներ, փաստաթղթերի կառուցվածք, գոտի փաթեթներ, մոդել կամ արվեստի գործիքների հղումներ եւ կառավարման ապացույցների փաթետներ: Iroha տվյալների մոդելը բացահայտում է SoraFS մուտքի իրադարձությունները եւ մատակարարի սեփականության լուծման համար [`FindSorafsProviderOwner`](/hy/reference/queries.md#nexus-data-availability-and-packages) հարցումը:

### Taira Թեստնետի պրոֆիլ {#taira-testnet-profile}

Taira է կանոնական հանրությունը SoraFS թեստային ցանց: Նրա ստուգված հավաստիացնող պրոֆիլը օգտագործում է շղթա `fc56984b-2be7-431d-840e-21514d1883f0` եւ շղթայական խտրական `369`. Հրապարակված SoraFS կարգավորումները հետեւյալն են.
...
`sorafs.sora.org` CID հաջորդականությունը կենդանի/արտադրության պրոֆիլն է, այլ ոչ թե Taira: Այն չպետք է տեղադրվի Taira մանիֆեսներում, ծագման ստուգումներում կամ բրաուզերային փորձարկումների մեջ։ Արտադրանքի տեղակայումը պետք է օգտագործի իրենց սեփական ցանցային ինքնությունը, կառավարման բանալիները, մատակարարների ընդունման նյութը, փաթեթավորման վերջնական կետերը եւ հզորության/վերանորոգման քաղաքականությունը: Երբեք Taira հավատարմագրերը կամ վերջնական կետերի ենթադրությունները չեն կրկնօրինակվում արտադրական կոնֆիգուրացիայում։
...
Այս երթուղիները երբեք չեն ընդունում `x-sorafs-stream-token` կամ `x-sorafs-token-id`. Ցանկացած գլուխի ներկայությունը վատ խնդրանք է: Կոնոնիկական մանիֆեստն արդեն ներկա է հանգույցի հեղինակավոր տեղական խանութում հանրային ընթերցման ունակություն; պահեստային բացակայությունը թույլ չի տալիս հեռավոր մատակարարի հիդրատացիան: Պաշտպանված մատակարարը CAR եւ կտոր երթուղիները մնում են առանձին վավերացված արձանագրական մակերեսներ:

Նախքան բայթների ընթերցումը, Torii հաստատում է տեղական մանիֆեստի կանոնիկ կոդավորումը, սեմանտիկական սահմանափակումները, դիջեստը եւ արմատը CID. Այնուհետեւ պահանջում է հեղինակավոր տեղական մատակարարի ինքնությունը, կառավարման ընդունումը եւ կարգավորված համապատասխանությունը մանիֆեսին, CID եւ մատակարարին: Gateway- ի տոկոսադրույք / արգելման քաղաքականությունը օգտագործում է հաճախորդի արդյունավետ հասցեն, պատվիրելով փոխանցված հասցեները միայն կոնֆիգուրացված վստահելի ներկայացուցիչների միջոցով: Եթե բացակայում է քաղաքականությունը, համապատասխանությունը, ինքնությունը կամ ընդունման վիճակը, Torii մերժում է խնդրանքը:
...
Ստորեւ բերված մուտացիոն օրինակում օգտագործվում է ստուգված Taira `NetworkId`, PIN վերջային կետ, կրկնապատկման հատակ եւ կառավարման քաղաքականություն: Օգտագործեք ֆինանսավորվող փորձարկման ցանցի հաշիվ եւ միաժամանակ օգտագործվող միայն սեփականատերերի հիմնական ֆայլ: Taira թույլ է տալիս առանց թույլտվության պիններ առանց խորհրդի ստորագրությունների, բայց դեռեւս վճարում է կառավարվող վճարը:
...
Օպերատորները կարող են ստուգել, արտահանել եւ զեկուցել վերականգնվողության ապացուցման արդյունքները: մարտահրավերները պլանավորված են ցանցի ապացուցումային խողովակաշարի միջոցով; CLI մակերեւույթում են դրանց արդյունքները:
...
|Taira բրաուզերային դարպաս |`https://<fqdn>.mon.taira.sora.net/<path>` |Գլխավոր բրաուզերային մուտք գործիչ ՝ ակտիվ alias- ի համար |
...
### Ծրագրային մուտքի հյուրընկալողներ {#derive-gateway-hosts}
...
### Հանրային DNS պատվիրակություն {#public-dns-delegation}

SoraDNS հյուրընկալող ծագումը չի փոխարինում սովորական ինտերնետի DNS պատվիրակությունը: Եթե հանրային DNS անվանումը պետք է ցույց տա SoraDNS մուտքի դարպասը.
...
- Soracloud պետության եւ աշխատանքի սխեմաների մոդել FHE կոդային տեքստի աշխատանքային բեռնվածքներ կառավարման կողմից կառավարվող պարամետրերի հավաքածուներով, իրականացման քաղաքականություններով, կոդային թեքստի պարտավորությունները, հարցումների փաթեթները եւ բացահայտման խնդրանքները։
...
`FheJobSpecV1::validate_for_execution` ստուգում է, որ աշխատանքը, կատարման քաղաքականությունը եւ պարամետրերի հավաքածուն համաձայն են ընդունվելուց առաջ: Այն նաեւ իրականացնում է շահագործման հատուկ կանոններ. ավելացնել եւ բազմապատկել պետք է առնվազն երկու մուտք գործել, rotate- ը եւ bootstrap- ը պետք է ճիշտ մեկ մուտք գործեն, եւ պահանջված խորությունը, պտույտային հաշիվը, Bootstrap- ի թիվը, մուտքի հաշվարկը, օգտակար բայթները եւ որոշիչ արտադրանքի չափը պետք է մնան քաղաքականության սահմաններում: Ciphertext հարցման արդյունքները չպետք է վերադարձնեն պարզ տեքստի գծեր:

UAID ոչ թե կոդավորվող տեքստն է, եւ ոչ էլ ինքնուրույն FHE քաղաքականությունը: Այն կայուն հաշիվի ունակության թղթադրամն է, որը օգտագործվում է հաշիվը գտնելու համար, անբացատրելի նույնականացման պահանջները եւ Space Directory- ի կապերը, որոնք թույլ են տալիս ծառայություն կամ տվյալների տարածքի հոսք: FHE սխեմաները կառավարում են կոդավորված օգտակար բեռի ընդունումը եւ կատարումը առանձին պարամետրերի հավաքածուների, կատարման քաղաքականությունների, կոդային տեքստի պարտավորությունների եւ ապականագրման իշխանության քաղաքականությունների միջոցով:
...
- Համոզվեք, որ `/openapi` թիրախային Torii հանգույցի վրա ստեղծված ծառայությունների ընտանիքներն են եւ անմիջապես ստուգեք հանրային տեղական SoraFS CID եւ հայտնի երթուղիներ:
- Soracloud տեղակայման մանիֆեսները, SoraFS մանիֆեստները, SoraDNS լուծիչների ցուցակային արձանագրությունները, SoraNet ռելեյի ցուցակի արձանագրություններն ու DA փայլերի մտադրությունները կամ հասանելիության պարտավորությունները կառավարման համար զգայուն արվեստագետներ են:

...
Ռեալի խրախուսման ընդունումը փակվում է: Երբ `incentives.enable` ճիշտ է, `incentives.trusted_verifier_ids`-ը պետք է պարունակում է առնվազն մեկ եւ առավելագույնը 64 կանոնիկ հաշիվ IDs: Runtime- ը պահպանում է ցուցակը որպես որոշողական կարգավորված հավաքածու, եւ անվավեր ցուցակի երկրաչափությունը մերժվում է ռեալի սկիզբավորման ընթացքում:

Յուրաքանչյուր `RelayBandwidthProof` կոդավորվում է ֆիքսված շրջանակի/բաշխման բյուջեի հիման վրա եւ պետք է սպառի ամբողջական շրջանակը: ապացույցի ստուգիչ հաշիվը պետք է լինի կազմված ցուցակում, եւ `RelayBandwidthProof::verify_signature()`-ն պետք է հաջողվի, նախքան ռելեյը փակում է կամ փոխում է իր կատարողականի կուտակիչը: Անհավատալի ստորագրող կամ ստորագրության անվավեր/խեղդված ապացույցը, հետեւաբար, ոչ մի չափման մեջ չի ներգրավվում եւ չի կարող խրախուսական ակնթարթություն ստեղծել:
...
|`GET /sorafs/cid/{cid}/{*path}` |Ծառայել մեկ նորմալացված ուղին, կամ մեկ սահմանված բայթային տիրույթ, այն CID |
...
Բայթների ընթերցելուց առաջ Torii հավաստիացնում է տեղական մանիֆեստի կանոնիկ կոդավորումը, սեմանտիկական սահմանափակումները, դիջեստը եւ արմատը CID: Այնուհետեւ պահանջում է տեղական մատակարարի հեղինակային ինքնությունը, կառավարման ընդունումը, ինչպես նաեւ կարգավորված համապատասխանության եւ վերացման ստուգումները մանիֆետի համար, CID: եւ պրովայդեր: Գեյթվեյի տոկոսադրույք / արգելման քաղաքականությունը օգտագործում է հաճախորդի արդյունավետ հասցեն, պատվիրելով փոխանցված հասցեները միայն կոնֆիգուրացված վստահելի պատգամավորների միջոցով: Մնացած քաղաքականությունը, համապատասխանությունը, հեռացումը, ինքնության կամ ընդունման վիճակը չի փակվում:

Մի խնդրանք ունի հանրային մուտքի թույլտվություն վերջից մինչեւ վերջ: գործընթացի ամբողջությամբ սահմանվում է 64 միաժամանակյա ընթերցումներ, ավելորդ պահանջները վերադարձնում են `503 Service Unavailable` եւ `Retry-After: 1`: Բացահայտված պատասխանները սահմանափակվում են 16 MiB, ֆայլերի ցուցակները նախանշանակով 50 մուտքագրություն եւ ընդունում են առավելագույնը 500, իսկ ամբողջական ֆայլ կամ մեկ բայթային տիրույթը սահմանափակվում է 8 MiB: CIDs, հարցումները, հյուրընկալողները, ուղիները եւ տիրույթի գլուխները պետք է օգտագործեն իրենց քանոնիկ միակ արժեքավոր ձեւերը: Ակտիվ HTML, կրիպտ, SVG, XML, PDF կամ Wasm բովանդակությունը մատուցվում է միայն կոնֆիգուրացված CID-ից ստացված մեկուսացված ծագումից (կամ այնտեղ վերանայված), ինչը կանխում է կիսվող ուղեւորային մուտքի աղբյուրի կողմից անվստահելի բովանդակություն կատարելը:

### Միջեցման մարտահրավերները {#moderation-challenges}

SoraFS համավարակի մարտահրավեր էկոնոմիկան կոնսենսուսային պետություն են: Ակտիվ քաղաքականությունը անվանում է կառավարման քվեարկության ակտիվը եւ կառավարման հաշիվները, որոնք օգտագործվում են պահպանումների եւ կրճատումների համար: Յուրաքանչյուր մարտահրավերը պահանջում է այդ ակտիվի ճշգրիտ 150 միավոր. այն բարձրացնելով ատոմային կերպով փոխանցում է կապակցությունը պահպանակի մեջ: Դատարանը մերժում է կրկնակի մարտահրավերների նույնականացմանը, նույն հաշվետվության կողմից երկրորդ մարտահրավերը կամ ապացույցների վերաօգտագործումը՝ առանց փոխելու հավասարակշռությունը կամ մարտահրահանգների համարիչները:

Հակառակորդի առաջադրման ժամկետը եւ մարտահրավերների լուծման ժամկետն տարբեր են: Կառավարությունը ստանում է հստակ 24 ժամ հետո, երբ ներկայացումները մոտենում են ընդունել կամ մերժել սպասվող մարտահրավերը: Բլոկ քվեարկության փուլը բացահայտում է միայն այդ բանաձեւի ժամկետի ընթացքում.

- ընդունված մարտահրավերով դադարեցվում է գործը եւ վերադարձվում է ամբողջական պարտատոմսերը:
- մերժված մարտահրավերը թույլ է տալիս շարունակել գործը, ուղարկում է պարտատոմսերի 25%-ը կրճատման ստացողի (կապակվում է քվեարկող ակտիվի ճշգրտության հիման վրա) եւ վերադարձնում է մնացածը: եւ
- չլուծված մարտահրավերը լրանում է շնորհման պատուհանից հետո, չի բացվում եւ վերադարձնում է ամբողջական պարտավորությունը:

`ExpireSorafsModerationChallenge` թույլտվություն չունի եւ անօգուտ է արդեն ժամկետանց բողոքի ակցիայի համար: Դեպքի վերջնականացումը կատարում է նույն ժամկետային կարգավորումը, ինչպես պահպանումը, Այսպիսով, բացակայող պահապանը չի կարող փակ դրամական միջոցներ թողնել կամ արգելափակել բացահայտումները: Յուրաքանչյուր կարգավորումը ատոմային է. եթե որեւէ փոխհատուցում կամ կտրված հատված ձախողվում է, ամբողջական կարգավորումը հետաձգվում է.

Մոդերացիայի քաղաքականությունն ու դեպքերի արձանագրությունները ուղղակիորեն օգտագործում են առաջին թողարկման սխեման: Նոդերը մերժում են նախապես կտրված մշտական դասակարգումները գենեզի / վիճակի նախաձեռնության ընթացքում: կամ ակնթարթային վերականգնում; վերակառուցել այդ ֆիքսատորները, փոխարենը քվեարկության ակտիվի, պահեստային հաշիվների, ժամկետների կամ տնտեսագիտության ենթադրությունը ժառանգական պետությունից:

...
### BFV Աֆին Backend {#bfv-affine-backend}
...
### BFV Ծրագրավորված Backend {#bfv-programmed-backend}
...
|`POST /v1/ram-lfe/programs/{program_id}/execute` |Գործարկել մի ծրագիր `input_hex` կամ `encrypted_input` եւ վերադարձնել արտադրանքի hashes գումարած անպետական վոմենտ. |

...
Վճարային հովանավորումը թույլ է տալիս օգտատերերին ներկայացնել մասնավոր տվյալների տարածքի գործարքներ ՝ առանց XOR պահելու: Օգտատերը դեռ ստորագրում է գործարքը: Գործարքի մետադատները նշվում են հովանու հաշիվի վրա, եւ ընթացիկ ժամանակը պարտք է կատարում հովանուի XOR մնացորդը ցանցային վճարների համար.

Ինտեգրումը բաղկացած է երեք շարժական մասերից.

1. հանգույցը միացնում է վճարների հովանավորումը
...
- մասնավոր երթուղին հայտնվում է հանգույցի `/status` պատասխանում
...
7. շղթան պահպանում է ոչ թափանցիկ նույնականացողի եւ ստուգման հեշը, այլ ոչ թե բնական հեռախոսի կամ էլ.փոստի արժեքը
...
Վճարների հովանավորումը հանգույցի/runtime-ի քաղաքականություն է։ Միացրեք այն Nexus-ի վճարների կարգավորումներում։
...
Taira-ի փորձարկումների համար պահեք [Ստանալ թեստային ցանցի XOR Taira-ում](/hy/get-started/sora-nexus-dataspaces.md#_4-get-testnet-xor-on-taira) բաժնի ծորակի օգնականը որպես `taira_faucet_claim.py`, ապա ֆինանսավորեք հովանավորին հանրային ծորակից, այլ ոչ թե գանձարանի փոխանցմամբ:
...
Ստուգեք հովանավորի XOR մնացորդը.
...
Օգտատիրոջը տրված թույլտվությունները ստուգելու համար՝
...
Օգտատերերի հաշիվը չի պահանջում XOR մնացորդ: Sponsor-ի հաշիվը պետք է պահպանի բավականաչափ XOR ՝ կազմված Nexus վճարները ապահովելու համար:
...
- ինչ է կատարվում, երբ օգտագործողի մնացորդը չափազանց ցածր է:
- ինչ է կատարվում, երբ հովանավորի մնացորդը XOR չափազանց ցածր է

::: warning

Մի օգտագործեք `gas_asset_id` "տեղական տոքերային վճարների" ձեւաչափի համար, եթե չեք ցանկանում, որ հովանավորը նաեւ գազային ակտիվում վարձատրվի: Ներկա ընթացիկ ժամանակահատվածում `fee_sponsor`- ը նաեւ հովանաւորին դարձնում է սահմանված մշակման շղթայի գազի ակտիվների պարտքերի վճարող: Տեղական տոկենների օգտվողի վճարների համար զեկույցը բացահայտորեն հավաքեք փոխանցման կամ պայմանագրի կանոնով:
...
|`fee balance ... is insufficient` |Բարձրացրեք հովանավորի մնացորդը XOR|
...
Երբ debugging ձեւանմուշը 2, ստուգեք երկու մնացորդը:
...
- նախքան հովանավորի XOR մնացորդը հասնել ընդունելության մակարդակի:
...
- համատեղել օգտագործողի գործարքների հեշերը, տեղական տոքերով վճարումները եւ սպոնսորների XOR վարկանիշները

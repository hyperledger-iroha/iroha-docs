...
ստորագրված գրասենյակային գործարքների, ստորագրված հարցումների եւ Norito բնիկ օգտակար բեռների համար նախընտրեք պաշտոնական Iroha SDKs: OpenAPI հաճախորդները ձեզ համար չեն հավաքում ստորագրություններ, կառավարում են հաշիվի բանալիները կամ կոդավորում Norito գործարքի մարմինները:

...
Խնդիրների մեծ մասն առաջանում է չհամընկնող բանալիներից։ Այդ պատճառով խորհուրդ ենք տալիս հետևել այս կանոնին. **Եթե ինչ-որ բան սխալ է, նախ ստուգեք բանալիները**։

Ահա մի կարճ բացատրություն. հնարավոր չէ տարբերել սխալների հաղորդագրությունները, որոնք առաջանում են, երբ հանգույցների բանալիները չեն համապատասխանում վստահելի հանգույցի շարքում գտնվող բանալիներին, քանի որ դա կբացահայտի հանգույցի հանրային բանալին: Հետեւաբար, եթե դուք ունեք Helm քարտեզներ կամ Kubernetes տեղակայումները միջավայրի փոփոխականների միջոցով սահմանված բանալիների հետ, նախքան ավելի բարձր մակարդակի ձախողումների ուսումնասիրումը համեմատեք կազմավորված [`public_key`](/hy/reference/peer-config/params.md#param-public-key), [`private_key`](/hy/reference/peer-config/params.md#param-private-key), եւ [`trusted_peers`](/hy/reference/peer-config/params.md#param-trusted-peers) արժեքները:

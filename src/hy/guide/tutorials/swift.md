...
Փաթեթը կախված է բնիկ `NoritoBridge` բինար թիրախից: Փաթեթի բանաձեւը հաստատում է `../dist/NoritoBridge.xcframework` կառուցվելուց առաջ, եւ գործարքի կամ Connect կրիպտո ուղիները նետում են կամուրջի անհասանելի սխալներ, երբ բնիկ խորհրդանիշները չեն բեռնվում:
...
Կոդային հիմնադրամը նաեւ պարունակում է `IrohaSwift/IrohaSwift.podspec`. Այն հայտարարում է, որ `IrohaSwift` կոշիկ, Swift 5.9, եւ iOS 15. Podspec ձգում է Swift հիմնական պահեստից ստացված աղբյուրները. բնական կամուրջը դեռ պետք է առկա լինի եւ կապված լինի գործարքի կոդավորման համար, ոչ-Ed25519 ստորագրում, եւ Connect կրիպտո.
...
Գործարքի ստեղծման եւ ներկայացնելու համար օգտագործեք `IrohaSDK` օգնականները: Նրանք կոչում են բրիջային աջակցությամբ գործարքների բնիկ կոդավորիչը.
...
Swift կառուցում է շուկայական եւ անանուն պահպանումի հրահանգներ որպես Norito JSON օգտակար բեռնվածքներ `NativeEscrowInstructionBuilders` կամ հավասար `IrohaSDK.build*Escrow*` օգնականների միջոցով: Դիտեք [ Native Asset Escrow](/hy/blockchain/escrow.md#swift-and-ios) օրինակները, անանուն ապացույցների դաշտերը եւ վեճերի լուծման թույլտվության տոքերը:
...
`ConnectSession` կառավարում է բաց եւ փակ վերահսկողությունները, կոդավորված փաթեթների ընթերցումները, ուղղության բանալիները, հոսքի վերահսկողությունը, իրադարձությունների հոսքերը, հավասարակշռման հոսքերը եւ ախտորոշիչ ամսագրերը:
...
- Kagemusha պատրաստությունը, տիպված լրացում եւ վերադարձ, շահագործման կարգավիճակ, ծանոթագրություն, զուգընկերների փաթեթ, ստացուցք եւ QR հոսքի մոդելներ

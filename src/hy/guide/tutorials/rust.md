...
Գլխավոր հաշվարկով կառավարվող պահպանումների աշխատանքային հոսքերի համար դիտեք [Native Asset Escrow](/hy/blockchain/escrow.md#rust-sdk). Rust տվյալների մոդելը ներկայումս ունի շուկայական պահպանակի, ընդհանուր ակտիվների փակման, անանուն պահպանակների, հարցումների եւ իրադարձությունների ամենատարածված տիպային ծավալը:

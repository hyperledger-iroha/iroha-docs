...
5. Օգտագործեք [Ներդնել Kaigi-ն](/hy/guide/tutorials/kaigi.md), երբ ցանկանում եք ավելացնել դրամապանակի աջակցությամբ աուդիո / տեսահոլովակ հանդիպումներ ձեր սեփական հավելվածում:
...
Կասկածի դեպքում նախընտրեք այդ գրացուցակների README-ն և փաթեթի մետատվյալները․ դրանք նկարագրում են կառուցվող սկզբնաղբյուրի վերանայումը։

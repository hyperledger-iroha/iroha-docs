...
- Preflight կարեւորը գրում է միայն ընթերցման հարցումներով. հաշիվի առկայությունը, ակտիվների բալանսները, թույլտվության վիճակը, վճարային ակտիվների մատչելիությունը եւ նպատակային օբյեկտի վիճակը:
- Գրանցեք գործարքի հեշը, իրավասու հաշիվը, հրահանգների ամփոփումը եւ սպասվող վիճակի փոփոխությունը նախքան ուղարկելը:
...
Նայեք [Հարցումներ](/hy/blockchain/queries.md), [Պատահանդեսներ](/hy/blockchain/events.md) եւ [Ֆիլտրեր](/hy/blockchain/filters.md).
...
- Մի տեղադրեք անձնական բանալիներ, հաշիվների վերականգնման նյութեր, API տոկեններ կամ փոխանցված նույնականացման վերնագրերը հրահանգների մեջ:
- Պահանջեք գործարքի պլան, նախքան ցանկացած գործակալ ներկայացնի կենդանի փորձարկման ցանցի գործարք: Ծրագիրը պետք է նշել ցանցը, լիազոր հաշիվը, հրահանգները, վճարային ակտիվը, թռիչքից առաջ կարդալը, ակնկալվող արդյունքը եւ կրկին փորձել վարքը:

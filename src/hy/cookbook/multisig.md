...
# Հաշված Multisig {#weighted-multisig}
...
- `taira.tx-metadata.json` կառուցված է ընթացիկ ջրհեղեղի արձագանքից, երբեք կրկնօրինակված վճարային ակտիվից ID:
...
CLI գրանցման հրամանը տպագրում է իր ժամանակավոր սերմը, նախքան վազման ժամանակը վերականգնում է այն. Մի օգտագործեք այդ սերմը որպես վերահսկողություն: Չկա վերահսկողության մասնավոր բանալին. multisig իշխանությունը գալիս է միայն հաստատված առաջարկներից:
...
Առաջարկողը ավտոմատ կերպով նպաստում է իր սեփական քաշին: Գտեք հստակ հրահանգային хэշը, որը տպագրված է CLI; հաստատությունները կապվում են այդ хэշի հետ:
...
- Մնացած սպասվող առաջարկը կարող է նշանակել, որ արդեն հասել է քվորումի, TTL ժամկետը լրանացել է կամ սխալ հրամանագրային хэշ / հաշիվ ընտրիչ օգտագործվել է: Հարցրեք հետագա վիճակը, նախքան կրկին առաջարկելը:
...
- [Մուլտիսիգ ինտեգրման փորձարկումները փակված հանձնաժողովում](https://github.com/hyperledger-iroha/iroha/blob/bc7114ed1c7f265a156d2100ff09e851cc95702c/integration_tests/tests/multisig.rs)
- [Multisig տվյալների մոդելը փակված commit- ում](https://github.com/hyperledger-iroha/iroha/blob/bc7114ed1c7f265a156d2100ff09e851cc95702c/crates/iroha_executor_data_model/src/isi.rs)
- [CLI բազում նշանների իրականացում փաթեթավորված պարտավորության վրա](https://github.com/hyperledger-iroha/iroha/blob/bc7114ed1c7f265a156d2100ff09e851cc95702c/crates/iroha_cli/src/main_shared.rs)

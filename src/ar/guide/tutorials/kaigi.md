...
استخدم التجربة مع [`@iroha/iroha-js`](https://github.com/hyperledger-iroha/iroha/tree/main/javascript/iroha_js) من الأخوة Iroha مخزن المصدر. `file:` تعتمد تسوية ذلك التحقق مباشرة. إذا تغير الالتزام الأصلي، أعيد بناءها تحت `iroha/javascript/iroha_js`; دليل حزمة نظيفة لا يحتوي على مساحة العمل الشحن المطلوبة من قبل: `npm run build:native`.

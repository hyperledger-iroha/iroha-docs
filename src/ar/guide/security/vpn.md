...
متصفح VPN يحمي فقط حركة المرور من هذا المتصفح. `iroha3d`, CLI, SDK, SSH, المقاييس، أو حركة مرور النسخ الاحتياطية ما لم يتم توجيه هذه العمليات عبر نفس الشبكة الخاصة.

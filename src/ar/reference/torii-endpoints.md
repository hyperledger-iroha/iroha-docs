...
يجب أن يقدم `pacs.009` البيانات الرسالة التجارية ID، وصف الرسالة ID، وقت إنشاءها، ومبلغ تسوية بين البنوك، والعملة، وتاريخ تسوية، وكيل المشاركة والمشاركة BICs، والدين والمدين IBANs. إذا كانت الرسالة تشمل `Purp`، فإن الجسر لا يقبل حاليًا سوى تمويل للأوراق المالية: `Purp=SECU`.
...
استخدم `--room-policy public` في الغرف التي قد تعرضها الروايات دون تذاكر المشاهد، أو `--room-policy authenticated` عندما يتطلب الخروج تصديق المشاهد. استخدم `--privacy-mode zk-roster-v1` فقط بعد أن يتم تشكيل القائمة و مفاتيح التحقق من الاستخدام في شبكة Kaigi ؛ وإلا فإن المجموعات، والورقات، وسجلات الاستخدام الخاصة تفشل أثناء التحقق من التحديد.
...
تعتمد مرؤية النقطة النهائية على إعدادات التليومترية. يصف الوثائق المتقدمة خمسة مستويات ملف:

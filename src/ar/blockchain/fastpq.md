...
(الـ) Rust الترميز يمثل عناصر الحقل على أنها قائمة. `u64` القيم في `[0,p)`. الإضافة والسحب هي:
...
قيمة التركيب V1 AIR هي مزيج خطي من بقايا الصف المحلية. عينات النسخة تظهر تحديين:

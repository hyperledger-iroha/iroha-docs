...
Бірдеңе жасауға рұқсат алу - бұл шотта тиісті `Permission` бар дегенді білдіреді. Рұқсаттар тікелей немесе [`Role`](#permission-groups-roles) арқылы берілуі мүмкін, ол рұқсаттардың жиынтығын топтастырады. Рұқсаттар `Grant` нұсқаулығымен беріледі. Рұқсаттар мен рөлдер мерзімі өтіп кетпейді; оларды `Revoke` нұсқауларымен алып тастаңыз.

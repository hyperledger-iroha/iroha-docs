...
Алдыңғы атаулар - каноникалық кітапша идентификаторларына қабатталған адам бетіндегі атаулар. Олар API, CLI, қапшығы, және зерттеуші шекаралары, бірақ каноникалық IDs қатаң кітапша өрістерінде сақталған тұрақты идентификаторлар болып қала береді.
...
|Деректер аумағының атауы |белсенді Nexus каталогынан сандық `DataSpaceId` | деректер кеңістігінің атаулары: `universal`, `paynet`, немесе `zk` |SNS `dataspace` атау кеңістігі тіркемесі және белсенді деректер кеңістігінің каталогы |
...
Домендер бөлек емес `DomainAlias` Объект. Домен идентификаторы деректер кеңістігіне сәйкес келетін атау болып табылады: `payments.universal`. SNS аймақтағы домен атаулары үшін жалға алу құқығына `domain` атау кеңістігі және деректер кеңістігінің аты-жөндері үшін `dataspace` атау кеңістігі. `universal` деректер кеңістігінің аты-жөндері анықталуы тиіс.

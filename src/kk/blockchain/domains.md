...
Мақсат `payments.universal`, оның сандық деректер кеңістігі, каноникалық I105 иесі, жалға алуды сатып алу мерзімі және ағымдағы саясатты / төлем бағасын қорғаушы анықталады. жоспарлаушының соңғы нүктесі `POST /v1/aliases/setup/plan`; оның қайтарылған жоспары тізбек, билік, мемлекет және мерзімге байланысты. Доменді алып тастау әлі күнге дейін [`Unregister`](/kk/blockchain/instructions.md#un-register) пайдаланады.
...
Домендер топтамалық кітапша объектілері болып табылады және домен ауқымы бойынша деректер үшін атау кеңістігін ұсынады. Әрекет анықтамалары домендік сәйкестендірушілерді пайдаланады, ал сұрау салулар домендерді тізбелеу немесе табуға болады Тіркелгілердің өздері қазіргі деректер үлгісінде доменсіз, бірақ шоттар домендерге ие бола алады және олардың анықтамалары домендер астында өмір сүретін активтерді сақтай алады.

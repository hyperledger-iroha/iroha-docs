...
`auto` проверге қол жетімді бэкэндін таңдауға мүмкіндік береді. `cpu` пин орындалуы CPU үшін артықшылығын береді. `gpu` GPU орындалуды жақсы көреді, мұнда CPU बैक-энд сұралған ядроларды пайдалана алмайтын.

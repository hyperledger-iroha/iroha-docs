...
[Шыфрлық кілттерді құру](/kk/guide/security/generating-cryptographic-keys.md) және [Сохтайтын криптографиялық кілттер](/kk/guide/security/storing-cryptographic-keys.md) қараңыз.
...
[Виртуалдық жеке желілер](/kk/guide/security/vpn.md) және [Torii Аяқ нүктелері](/kk/reference/torii-endpoints.md).

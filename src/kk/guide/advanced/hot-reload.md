...
# Ыстық қайта жүктеу Iroha а) Docker Контейнер {#hot-reload-iroha-in-a-docker-container}
...
Назардағы теңгерім конфигурациясы: TOML. Пайдаланылғанды байлау немесе көшіру `config.toml`, `genesis.signed.nrt`, және суретте күтілетін контейнер жолдарына байланысты негізгі файлдарды, содан кейін қайта бастаңыз. Жаратылған файлдарды бірге ұстаңыз; әртүрлі файлдарды араластыру Kagami жүгіру дезерыяландыруды немесе консенсус сәтсіздіктерін тудырады.

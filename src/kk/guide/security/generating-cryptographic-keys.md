...
- `bls_normal` Құрылымы рұқсат еткен жағдайда, растаушы консенсус кілттері үшін BLS қолдау.
...
NPOS және Nexus куәландырушы профильдері қажет BLS куәландырушы кілттері және PoPs:

```bash
cargo run --bin kagami -- keys --algorithm bls_normal --pop --json
```

Қауымдастық JSON кіреді `pop_hex` қашан `--pop` пайдаланған топологиямен бірге осы мәнді немесе `trusted_peers_pop` Профильге қойылатын жазулар.

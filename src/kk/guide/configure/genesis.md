...
Жаратылыс бастапқы тізбекті күйін анықтайды. JSON айқын және Iroha 3 түйін қолтаңбаланған Norito транзакция файлы.
...
NPoS немесе Nexus бейіні, топологияны және BLS Жаратылған профиль бойынша талап етілетін иелік дәлелдемесі. Kagami `localnet`, `wizard`, және профильді құру командалары осы деректерді автоматты түрде өңдейді.

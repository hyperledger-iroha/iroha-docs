...
# Орындау Iroha 3 арқылы CLI {#operate-iroha-3-via-cli}
...
Тек оқуға тырыса аласыз Taira жергiлiктi теңгершiлiкпен жұмыс iстеуден немесе қолтаңбалаушыны құрудан бұрын тексерулер. Torii JSON маршруттар және тестнет жұмсау емес XOR.

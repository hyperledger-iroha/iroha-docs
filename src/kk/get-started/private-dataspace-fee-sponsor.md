...
Алдымен доменді орнатыңыз және SNS активтердің атау кеңістігін иеленушілерге жалға беру. `AliasSetupPlanRequestV1` мақсат `$BILLING_DOMAIN`, сандық `team` деректер кеңістігі ID, Қасиетті меншік иесі, жалға алу мерзімі және ағымдағы цитата қорғаушы:
...
Жаңа тіркелгі құру үшін, қосылу қызметін таңдаңыз `NewAccount` сыйымдылықпен `uaid` және қажет болған жағдайда, бастапқы `label`. Қарапайым `ledger account register --id` команда тек қана каноникалық есепті тіркейді ID.
...
Ағымдағы CLI осы идентификациялық нұсқаулар үшін түрленген командаларды жария етпейді. `InstructionBox` мәндерімен SDK және оларды `ledger transaction stdin`:
...
- квитанциялар байлау `policy_id`, `opaque_id`, `uaid`, `account_id`, және мерзімінің аяқталуы
...
Пайдаланушы тіркелгісі үшін XOR Баланс. Спонсорлық шотқа жеткілікті ақша сақталуы тиіс XOR конфигурацияланған Nexus Төлемдер.

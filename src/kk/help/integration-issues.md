...
Егер осы бұйрықтар орындалмаса `502`, TLS, DNS, немесе уақыт үзіліс қателері, желіге қол жетімділікті түзеу немесе есептік жазба кілттерін немесе транзакция жүктемелерін түзету алдында қоғамдық тест-неттің соңғы нүктесін күтіңіз.

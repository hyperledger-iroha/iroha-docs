...
# Үҫеп бар SORA 3: Taira һәм Minamoto {#build-on-sora-3-taira-and-minamoto}
...
`AccountId` һәр саҡ каноник һәм доменһыҙ. `[account].domain` ҡиммәте `client.toml` маршрутлаштырыу һәм алфавит контексты тәьмин итә; ул иҫәбенә идентификация өлөшө булып китмәй. `universal` Мәғлүмәт арауығы. Домен контексты ҡулланыла `domain.dataspace` Мәҫәлән, формала:
...
## Taira MCP агенттар өсөн {#taira-mcp-for-agents}

Taira шулай уҡ а Torii-урындағы Контекст протоколы моделе (MCP Әгәр агент тере тест селтәре уҡый, сценарий диагностикаһы, йәки тығыҙ тикшерелгән яҙыу репетициялар кәрәк ваҡытта ҡулланырға. Torii Иң тәүҙә клиент.
...
Конфигурация URL ҡулланыусы урындағы булараҡ MCP серверҙа агенттың эшләү ваҡыты. агентты йөкмәтмә MCP конфигурация, API Токендар, ебәрелгән авторлыҡ исемдәре, `authority`, йәки `private_key` ҡиммәттәрҙе был документтар repo йәки ҡулланыу repo.
...
1. Агентҡа тейешле документтарҙы тикшереүен һорағыҙ. SDK код, CLI командование, йәки MCP коды яҙыр алдынан инструмент схемаһы.
...
Ҡоролтай MCP күпер ҡул ҡуйылған документ тапшыра ала Iroha транзакция, әммә ул ғәҙәттәгесә транзакция талаптарына ҡағылмай. Транзакцияға барыбер дөрөҫ власть, рөхсәт, түләүҙәр финанслау, сылбыр кәрәк ID, Метамәғлүмәттәр һәм ҡултамға.

Сыймаҡ өсөн Iroha транзакциялар, төҙөү һәм килешеү килешеүе менән килешеү SDK йәки CLI тәүҙә, һуңынан агентҡа тик ҡануни ҡул ҡуйылған транзакция байттарҙы ғына бирергә `body_base64`. Агент конвертты: `iroha.transactions.submit_and_wait`, йәки `iroha.transactions.submit` һәм тауыш биреү менән `iroha.transactions.wait`.
...
- транзакция хэшигы
- terminal статусы, мәҫәлән `Committed`, `Applied`, `Rejected`, йәки `Expired`
...
Ауырыу Taira MCP асыҡ тест селтәре контроле өҫкө йөҙө булараҡ. Taira асҡыстар, тест селтәре XOR, кран иҫәбенә, һәм канар ҡултамғалары бер тапҡыр ҡулланыла һәм улар айырым булырға тейеш Minamoto Ключтар һәм етештереү сығарыу эш ағымдары.
...
Беренсе яҙыу яғынан уйынсыҡ булырға тейеш Taira кран claim. Ул тест селтәрен ҡуллана XOR һәм бер ҡасан да күрһәтергә тейеш түгел Minamoto.
...
Финанслау Taira Аҡса түләтеү өсөн түләүҙәр яҙҙырыу алдынан кран аша иҫәбенә. [Testnet-ты алығыҙ XOR тураһында Taira](#_4-get-testnet-xor-on-taira).
...
Тағы ла һынап ҡарамағыҙ `iroha taira doctor` ауыр уңышһыҙлыҡтар күрһәтә. сиратты туйындырыу һәм түләү ҡабул итеүҙән баш тартыу - йәмәғәт тест селтәре өсөн ваҡытлыса шарттар; DNS, TLS, йәки `status = "fail"` диагностикаһы юҡ.

## А-ны булдырыу SORA Nexus Иҫәп ID {#generate-a-sora-nexus-account-id}
...
Һөҙөмтәлә алынған иҫәбен ҡулланығыҙ ID ҡайҙа Nexus API йәки CLI командование канонический отчет һорай ID, мәҫәлән, Taira кран `account_id`, баланс һорауҙар, ҡаты иҫәп-хисап майҙансыҡтары, йәки alias бәйләнештәр. тура килгән шәхси асҡысын клиент конфигурацияһында һаҡларға һәм шул уҡ йәмәғәт селтәрен һайларға `[account].profile = "taira"` йәки `[account].profile = "minamoto"`.

Төҙөүсе ID үҙенән-үҙе финансланған сылбыр иҫәбенә булдыра алмай. Taira, faucet булдыра һәм testnet яҙған өсөн иҫәбенә финанслай ала. Minamoto, Төп селтәрҙе ҡушыу йәки ҡаҙна ағымдарын ҡулланыу.

### Ключтарҙы һаҡлау һәм уларҙы һаҡлап ҡалыу {#key-storage-and-backup}

ID иҫәбенә һәм асыҡ асҡыс менән уртаҡлашырға мөмкин.

SORA Nexus иҫәбе өсөн ошо алымдарҙы ҡулланығыҙ:

- Хосуси асҡыстарҙы шифрланған пароль менеджерында, аппарат ярҙамында тәьмин ителгән клавишалар магазинында йәки махсус ҡултамғалау хеҙмәтендә һаҡлағыҙ.
...
- Һаҡлағыҙ Taira һәм Minamoto Ключтар айырым. Taira Ключтарҙы бер тапҡыр ҡулланыу өсөн һынау селтәре материалы итеп һәм Minamoto Ключтар етештереү фонды органы булараҡ.
- Шәхси асҡыс, йәмәғәт асҡысы, иҫәп яҙмаһы ID, иҫәбенең профиле һәм яҙыусыны тергеҙеү өсөн кәрәк булған бөтә аккаунтты теркәү йәки һаҡлау мәғлүмәттәре.
- Производство имзалаусылары өсөн кәмендә бер шифрланған офлайн резерв yedek һәм бер географик яҡтан айырым шифрланған резерв yedek һаҡлағыҙ.
...
Тулыраҡ мәғлүмәт өсөн ҡарағыҙ: [Криптографик асҡыстарҙы һаҡлау](/ba/guide/security/storing-cryptographic-keys.md) һәм [Парольдәр хәүефһеҙлеге](/ba/guide/security/password-security.md).

## 4. Тестнет алығыҙ. XOR тураһында Taira {#_4-get-testnet-xor-on-taira}
...
Ҡасан `difficulty_bits` булып тора `0`, иҫәп-хисапты ғына тапшырыу ID:
...
Хәҙерге ваҡытта яуап ҡайтарыла HTTP `202 Accepted`. Активтың билдәләмәһе ID өҫтө - Taira түләүле активтар дәүләт краны тарафынан финансланған. `tx_hash_hex` һәм `status: "QUEUED"`.
...
Төҙөүгә әҙер тура өсөн API тикшерегеҙ, һаҡлағыҙ `taira_faucet_claim.py` һәм үткәрергә Taira I105 иҫәбенә ID:
...
Фундаль тик Taira testnet средстволары. testnet ҡулланырға ярамай XOR, кран иҫәбе, йәки Taira канар ҡултамғасы Minamoto ағымдар.
...
А-ны үҙгәртергә Minamoto асыҡ асҡыс уның каноник I105 иҫәбенә ID төп селтәр префиксы менән:
...
Minamoto түләүҙәр етештереү менән бергә түләнә XOR, һәм Minamoto конфигурацияланған иҫәбенә раҫланған төп селтәрҙә инеү йәки казначейлыҡ күсереү аша аҡса түләргә, йәки алырға XOR ғәмәлдәге финансланған Minamoto иҫәбенә.

Каноник иҫәпте тикшерегеҙ ID һәм яҙма тапшырыу алдынан уҡырға ғына тикшереүҙәр менән финанслау. Minamoto XOR етештереү фонды булараҡ: шул уҡ операцияны һынап Taira Беренсенән, етештереү асҡыстарын айырым һаҡлағыҙ һәм төп селтәр транзакцияһын ҡабаттан ҡуйырға мөмкин тип иҫәпләмәгеҙ.

Taira XOR түләй алмай Minamoto түләүҙәр. Testnet баланстары һәм кран өсөн талаптар Minamoto.
...
ID, мәғлүмәт киңлеге ID, валидатор йыйылмаһы, хаталарға түҙемлелек, манифест, маршрутлау ҡағиҙәләре һәм эксплуатация хужаһы бергә тикшерелмәһә, яңы исем-шәрифте пропагандаламағыҙ. Кәрәкле рөхсәттәргә эйә булған ғәҙәти ҡулланыусы иҫәбенә SNS домен һатып алыу һәм уның [PH0000002] ҡуртымға алыныуы ғәмәлдәге мәғлүмәттәр майҙансығында псевдопланер аша мөмкин; ул хәүефһеҙ рәүештә яңы асыҡ мәғлүмәт майҙансығын өҫтәй алмай.
...
- [Эшләгеҙ Iroha 3 аша CLI](/ba/get-started/operate-iroha-via-cli.md)

...
Ҡулланыусыларҙың шәхси мәғлүмәттәр киңлегендә һаҡланасаҡ активтар билдәләмәләрен теркәгеҙ, уларҙы ҡушымта логикаһына күсерер алдынан. `usage#billing.team`:
...
Беренсенән, доменды һәм SNS мөлкәт исемдәренә эйә булған ҡуртымға алыу. `AliasSetupPlanRequestV1` маҡсаты өсөн `$BILLING_DOMAIN`, һандар иҫәбенә `team` мәғлүмәттәр арауығы ID, законлы хужаһы, ҡуртым срогы һәм ағымдағы цитата һаҡсыһы:
...
Һуңынан активтар билдәләмәһен теркәгеҙ. `--id` - селтәр кимәлендәге активтарҙың билдәләмәһе ID.
...
Минет йәки ҡулланыусыға урындағы токенде күсереүҙә:
...
Хисаптар һаман да ҡануниаль I105 иҫәбенә IDs. Ҡулланыусыға ҡараған исемдәр иҫәбенә ҡушамат булып тора, һәм ҡушаматтар һиҙгер булмаған ҡулланмалар булырға тейеш: `alice@team` йәки `alice@members.team`. Телефон номерҙарын һәм электрон почта адрестарын ялған исемдәр итеп ҡулланмағыҙ, улар киләһе бүлектә шәхси идентификаторҙар ағымына инә.
...
Әгәр файҙаланыусы XOR түләмәһә, ойоштороу транзакцияһын төҙөү һәм тапшырыу өсөн раҫланған спонсор-аңлы инеү сервисын ҡулланығыҙ.
...
Ағым CLI был идентификация күрһәтмәләре өсөн типталған командалар асылмай. Сериялы генератор `InstructionBox` ҡиммәттәр менән SDK һәм уларҙы үтәү `ledger transaction stdin`:
...
- сиселгән телефон һәм электрон почта ҡиммәттәре бер ҡасан да ялған исемдәрҙә, метамәғлүмәттәрҙә, журналдарҙа йәки транзакциялар йөкләмәләрендә күренмәй
- иҫәбенә `uaid` бар, сөнки ул шәхси идентификаторҙарҙы талап итә
- квитанциялар бәйләнеше `policy_id`, `opaque_id`, `uaid`, `account_id`, һәм ваҡыты тамамлана
...
`fee_asset_id` - селтәр өсөн түләү актив. SORA Nexus Был XOR. Актив ҡулланыу XOR псевдоним йәки каноник XOR активтар билдәләмәһе ID һеҙҙең селтәрегеҙ тарафынан асыҡланған.
...
өсөн Taira репетициялар, ҡурсаҡ ярҙамсыһын һаҡларға [Testnet-ты алығыҙ XOR тураһында Taira](/ba/get-started/sora-nexus-dataspaces.md#_4-get-testnet-xor-on-taira) тип `taira_faucet_claim.py`, һуңғараҡ спонсорҙы дәүләт фондынан аҡса күсереү урынына финанслау:
...
Спонсор һәр файҙаланыусыға түләүҙәр алыу өсөн рөхсәт бирергә тейеш.
...
Ҡулланыусының гранттарын тикшереү өсөн:
...
SDKs өсөн, ҡул ҡуйылған транзакцияға бер үк транзакция метамәғлүмәт объектын ҡуйып ҡуйығыҙ. Ҡулланыусы транзакцияны ҡулланыусының асҡысы менән ҡул ҡуя. Спонсор һәр ҡулланыусы транзакцияһына ҡул ҡуймай, сөнки быға тиклемге `CanUseFeeSponsor` грант - рөхсәт биреү.
...
Фонд ҡулланыусылар менән `usage#billing.team` инеү, абонемент яңыртыу йәки квота бүлеү ваҡытында.
...
Минималь CLI төтөн һынауы - был бары тик XOR тарафынан спонсорлаштырылған урындағы билдәләр күсереү генә:
...
Ҡулланырға ярамай `gas_asset_id` "Урындағы билдәләр өсөн түләү" өлгөһө өсөн, әгәр һеҙ теләһәгеҙ спонсорҙы шул газ активта ла түләргә кәрәк. `fee_sponsor` шулай уҡ спонсорҙы конфигурацияланған үткәргес-газ активтары өсөн түләтеүсегә әйләндерә. урындағы токен файҙаланыусы түләүҙәре өсөн, токенды күсермә йәки килешеү ҡағиҙәһе менән асыҡтан-асыҡ йыйыу.
...
- ҡулланыусылар транзакцияһы хэштегтарын, локаль билдәләр менән түләүҙәрҙе һәм спонсор XOR дебиттарын көйләү

...
Реле incentive ингредиенты failure-closed.When `incentives.enable` is true, `incentives.trusted_verifier_ids` must contain at least one and no more than 64 canonical account IDs.The runtime stores the roster as a deterministic ordered set, and invalid roster geometry is rejected during relay startup.

Һәр `RelayBandwidthProof` фиксированный рамка / распределение бюджеты буйынса декодлана һәм тулы кадрҙы ҡулланырға тейеш. иҫбатлауҙың верификатор иҫәбенә конфигурацияланған исемлектә булырға тейеш, һәм `RelayBandwidthProof::verify_signature()` уңышлы булырға тейеш, Ретле йомортҡаны ябып ҡуйыуҙан йәки уның һөҙөмтәлелек аккумуляторын үҙгәртеүҙән алда. Ышанысһыҙ ҡултамғалаусы йәки ҡултамғаның ғәмәлдән сыҡмауы / боҙолоуы иҫбатлана, шуға күрә ул үлсәү индермәй һәм стимуллы фотоһүрәт бирә алмай.
...
Байттарҙы уҡыр алдынан, Torii урындағы манифесттың каноник кодировкаһын, семантик сикләүҙәрҙе, һеңдереүҙе һәм тамырҙы раҫлай CID. Һуңынан ул авторитетлы урындағы тәьмин итеүсе шәхесен, идара итеүҙе талап итә ҡабул итеү һәм манифестҡа ярашлылыҡ һәм уны алып ташлау буйынса контроль, CID, һәм провайдер. Gateway ставкаһы / тыйыу сәйәсәте клиенттың ғәмәлдәге адресын ҡуллана, ебәрелгән адрестарҙы конфигурацияланған ышаныслы проксилар аша ғына хөрмәт итеү. Юғалған сәйәсәт, үтәү, ташлау, танылыу йәки ҡабул итеү дәүләтенә ябыла алмай.

Бер үтенесе менән тамамланған йәмәғәт ҡапҡаһы рөхсәт ителә; процесс буйынса сикләү 64 бер үк ваҡытта уҡый, Өҫтәмә һорауҙар менән кире ҡайтарыла `503 Service Unavailable` һәм `Retry-After: 1`. Яңғыҙ яуаптар - 16 MiB, файл исемлектәре дефолт менән 50 яҙыу һәм иң күп 500 ҡабул итә, һәм тулы файл йәки бер байт диапазоны 8 сикләнә MiB. CIDs, Һорауҙар, хосттар, юлдары һәм диапазон башлыҡтары үҙ каноник бер мәғәнәле формалары ҡулланырға тейеш. HTML, сценарий, SVG, XML, PDF, йәки Wasm йөкмәткеһе бары тик конфигурацияланған CID-булған айырым сығанаҡ (йәки унда йүнәлтелгән), уртаҡ маршрут-ҡатылыш сығанағы ышанысһыҙ йөкмәткеһен башҡарыуҙан ҡамасаулай.

### Уңайлылыҡ проблемалары {#moderation-challenges}


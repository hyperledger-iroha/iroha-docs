...
- `id`: барлыҡҡа килгән каноник RWA Идентификатор: `<hash>$<domain>`
...
Сылбырҙағы файҙалы йөк compact һаҡларға. ҙур хоҡуҡи документтар һаҡлау, инспекция отчеттары һәм аудит пакеттары WSV, Шунан уны (Ҡөръәнде) яҙ. URI, SoraFS юл, йәки асыҡтан-асыҡ һылтанма RWA метамәғлүмәт.

## Идентификаторҙар {#identifiers}

`RegisterRwa` һайлап алынған саҡырыусыны ҡабул итмәй `id`, һәм ул ҡабул итмәй `owner` өлкә. Транзакция органы тәүге `owned_by` иҫәп, һәм йүгереү ваҡыты генерирует `RwaId` маҡсатлы биләмәлә.
...
Ҡулланыусылар үҙҙәренең бизнес идентификаторына `primary_reference` йәки `metadata`, Унан һуң барлыҡҡа килгән нәмәләрҙе табығыҙ. `RwaId` от `RwaEvent::Created`, `FindRwas`, `/v1/rwas`, йәки экспедитор маршруты операциянан һуң билдәләнгән.
...
Ҡулланыу [`FindRwas`](/ba/reference/queries.md#assets-nfts-and-rwas) теркәлгән исемлеккә RWA бик күп. туранан-тура яңыртыуҙарға мохтаж булған ҡушымталар [`Rwa` мәғлүмәт ваҡиғалары](/ba/blockchain/filters.md#data-event-filters) булдырылған, хужаһын үҙгәрткән, бүленгән, берләштерелгән, һатып алынған, туңдырылған, туңдырылмаған, һаҡланған, иреккә сығарылған, көс менән күсерелгән, контроллерҙар алмаштырылған һәм метамәғлүмәттәр ваҡиғалары өсөн.
...
Иҫәпкә алыу RWA туранан-тура асыҡланған маршруттар Taira OpenAPI документ:
...
### Аңлашығыҙ RWA API Маршруттар {#discover-rwa-api-routes}
...
Әгәр исемлек буш булһа, узел һаман да ярҙам итә ала RWA башҡалар аша күрһәтмәләр һәм һорауҙар Torii APIs, әммә ул факультатив асыу түгел JSON Маршрут ғаиләһе.
...
Транзакция йөкләмәләрен үтәгәндән һуң, исемлек барлыҡҡа килә RWA IDs. Сылбыр-дәүләт маршруттары каноникаль IDs; ҡулланыу ваҡиғалар йәки эҙләүсе деталдәр маршруттары, әгәр һеҙ кәрәк ID кире ҡайтыу `primary_reference` йәки метамәғлүмәт:
...
Булдырылған ҡулланыу RWA ID Сылбыр менән кире ҡайтарылған. `alice` хужаһы булып тора һәм шулай уҡ контроллер булараҡ көйләнә `hold_enabled`.
...
Өҫтәмә суммаһы, әгәр күрһәтелгән сылбырҙан тыш актив тапшырылған, ҡулланылған, пенсияға сығарылған йәки башҡаса әйләнештән алынған. `redeem_enabled`, һәм ҡул ҡуйған хужа йәки контроллер булырға тейеш.
...
Берләшкән ваҡытта ике сираттан тыш позициялар тупланған. ата-әсәләр бер үк доменда булырға тейеш һәм шул уҡ күләмдең спецификацияһын ҡулланырға кәрәк. ID.

...
Партия күсереүҙәрендә бер транскрипт һәм күп кенә дельталар ҡулланыла. Ундай осраҡта бер дельталы Посейдон дайджесты юҡ.
...
| --------------- | ------------------------------------------------ | ----------------------- | ---------------------- |
| Ебәреүсенән сығым | `asset/<asset-definition>/<source-account>` | үҙгәрешкә тиклем ебәреүсенең балансы | үҙгәрештән һуң ебәреүсенең балансы |
| Ҡабул итеүсе иҫәбенә инеү | `asset/<asset-definition>/<destination-account>` | үҙгәрешкә тиклем ҡабул итеүсенең балансы | үҙгәрештән һуң ҡабул итеүсенең балансы |
...
|`new_root` |Башҡарыу шаһитынан сығарылған башҡарыуҙан һуңғы торош тамыры |
|`perm_root` |Посейдондың актив роль өсөн рөхсәт биреүенә бәйле йөкләмәһе |
|`tx_set_hash` |Һәҙерләнгән транзакция һәм ваҡыт-тикшереү инеү нөктәһе хештары өҫтөндә хеш |

Ҡунаҡсы был партиялар өсөн `fastpq-lane-balanced` каноник параметр билдәләй.

## Математик модель {#mathematical-model}

Был бүлектә хәҙерге Rust проверкаһы һәм верификаторы тарафынан тормошҡа ашырылған арифметика һүрәтләнә. Түбәндәге бөтә баҫыу операциялары "Алтын сәскәләр"ҙең төп яланынан үтә:
...
Ҡоролтай Rust код таҡта элементтарын каноник тип аңлата `u64` ҡиммәттәре `[0,p)`. Өҫтәмә һәм киметеү:
...
Реализация шартлы рәүештә `p` өҫтәй йәки төшөрә, һөҙөмтә каноник булғанға тиклем. Баланс дельтаһы кеүек ҡул ҡуйылған бөтөн һандар түбәндәгеләр менән ҡушыла:
...
бында `h_i` — тәртипкә һалынған транзакция һәм ваҡыт триггерының инеү нөктәһе хештары. Асыҡ иҫбатлау IO-һында `perm_root` йәки `tx_set_hash` тотош нулдәрҙән торһа, иҫбатлаусы резерв ҡиммәттәрҙе тултыра:
...
Факультатив бер дельта күсереү диджеты кодировкалы күсереү преобразованияһын commit итә:
...
Күп-дельта күсереү транскрипттары өсөн, хәҙерге форматта был юғары кимәлдәге дайджест юҡ булырға тейеш.
...
Бары тик минтлау һәм яндырыу сираттары ғына тәьмин итеү һанаҡсыһын яңырта:
...
Эҙләүсе битте яҙҙыра . `b_l`, ҡустыһы `s_l`, инеү узелы `x_l`, һәм сығарыу узелы `x_{l+1}` һәр кимәлдә. Кодтың тармаҡ конвенцияһы менән:
...
Һуңғы эҙләү йөкләмәһе - домен, параметрҙар йыйылмаһы, эҙләү формаһы, бағана дайджест һәм эҙләнеү тамырҙары өҫтөндә байт хэши:
...
Тикшереүсе `A_i` өлгөһөнә индерелгән рәт киңлектәрен ҡабаттан иҫәпләп сығара һәм уны AIR составындағы Merkle тамыры буйынса commit ителгән композиция ҡиммәте менән тикшерә.
...
FRI AIR композицияһы баһаларын commit итә. Һәр `l` раунды өсөн transcript `beta_l` challenge-ын һайлай. Ҡатлам һуңғы ҡиммәтте ҡабатлап, arity-ға тап килгән ҙурлыҡҡа тиклем тултырыла. Һәр arity ҙурлығындағы төркөм ошолай йыйыла:
...
Һәр яланы раҫлауҙың асыҡ IO байт-байт менән тап килергә тейеш. Унан һуң тикшереүсе шул уҡ транскриптты реконструкциялай һәм шул уҡ мәғлүмәтте килтерә:
...
Эҙҙе төҙөү алдынан FastPQ prover пакет тәртибен күсеү асҡысы, операция рангы һәм өҫтәү тәртибе буйынса канонлаштыра. Күсеү юлдары өсөн transcript metadata ла талап ителә. Күсеү юлдары булған, әммә күсеү transcript-тары булмаған пакет яраҡһыҙ.

Трансфер транскрипттары өсөн, провер-бәйләнештәге тикшереүҙәр түбәндәгеләрҙе үҙ эсенә ала:

- ебәреүсенең балансы нулдән түбән төшмәҫкә, йәғни underflow булмаҫҡа тейеш
...
- бер дельталы Посейдон дайджест, әгәр бар булһа, транскрипт преобразы менән тап килергә тейеш.
...
Трейсҡа күсереү, минтлау, яндырыу, роль биреү, ролде юҡҡа сығарыу, метамәғлүмәттәр йыйылмаһы һәм рөхсәт эҙләү рәттәре өсөн һайлап алыу бағаналары инә. Официальный сайт Санлы операциялар рәттәре шулай уҡ ҡул ҡуйылған дельталар, актив буйынса дельталар һәм тәьмин итеү счетсылары алып бара.

## Проверка Лейн {#prover-lane}

`iroha3d` башланғыс ваҡытта FastPQ провер лентаһын башлай, әгәр провер бэкэндаһы инициациялана алһа. Лен - сикләнгән сиратлы фон эше. Блок башҡарғандан һуң бойондороҡлау юлы провер эшен тапшыра, унда блок хэш, бейеклек, ҡарау һәм шаһит бар.
...
Ике көйләүҙең дә ғәҙәти ҡиммәте — `cpu`. `gpu` һайлау асыҡтан-асыҡ, хатала ябыҡ ҡала торған талап булып тора: GPU ярҙамы компиляцияланмаһа йәки һоралған GPU бэкенды алданғы тикшереүҙе үтмәһә, иҫбатлау һыҙаты һүндерелгән килеш ҡала. Беренсе сығарылышта `auto` ҡиммәте юҡ һәм һоралған GPU режимынан CPU-ға автоматик күсеү башҡарылмай.
...
Әгәр раҫлау уңышлы булһа, Iroha эстафетаға һылтанманы, оригиналь конвертты, иҫбатлау йөкләмәһе хэшын, тикшереү бейеклеген, манифест тамырын һәм FastPQ бәйләнешен үҙ эсенә алған `VerifiedLaneRelayRecord`-ты һаҡлай.
...
`authorization` заявкаһында "Ролль бирелгән рөхсәт" рәтенә индерелгән:
...
SCCP ярҙамсы crate-ында асыҡ cross-chain message proof-тары өсөн дә FastPQ ҡулланыла. Был юл `iroha3d` background prover lane-ынан айырым. Ул SCCP message proof bundle-ы һәм manifest-ынан FastPQ batch-ты туранан-тура төҙөй, һуңынан һөҙөмтәләге proof-ты асыҡ тикшереү өсөн урай.
...
| ------------- | ---------------------------------------------------------- |
|`dsid` |Тәүге 16 байт Блейк2б дайджесты белдереүҙең hash өҫтөндә|
...
Каноник параметрҙар каталогы ике параметр йыйылмаһын асыҡлай. Хәҙерге ваҡытта `fastpq-lane-balanced` ҡулланыла.
...
|`fastpq_poseidon_pipeline_total` |Посейдон pipeline юлы буйынса һоралған һәм хәл ителгән |
|`fastpq_metal_queue_depth` |Metal сираты сиге, бер үк ваҡытта башҡарылған операцияларҙың максималь һаны, ебәреүҙәр һаны һәм өлгө алыу тәҙрәһе|
...
- Node-authoritative type snapshot өсөн [Мәғлүмәт моделе схемаһы](/ba/reference/data-model-schema.md)
- `FastpqTransitionBatch`
- `FastpqPublicInputs`
- `TransferTranscript`
- `AxtFastpqBinding`
- `LaneFastpqProofMaterial`
- [`iroha3d` FastPQ варианттары](/ba/reference/iroha3d-cli.md#fastpq-overrides)

...
Трансферҙар иҫәбтәр араһында милек йәки ҡиммәт күсерелә. һәм NFTs. RWA күләм хәрәкәте тәғәйенләнгән ҡулланыла `TransferRwa` һәм `ForceTransferRwa` күрһәтмәләре [Реаль донъя активтары](/ba/blockchain/rwas.md).

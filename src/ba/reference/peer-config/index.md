...
TOML файлдарҙа урындағы тиңдәш конфигурацияһы ҡуйыла. Был [`SetParameter`](/ba/blockchain/instructions.md#setparameter) күрһәтмәләре аша үҙгәртелгән сылбыр конфигурацияһынан айырыла.

...
Ҡулланыу SDK типографик төҙөүселәр йәки CLI Һорау конверттарын ҡул менән төҙөү урынына. түбәндәге исемдәрҙә `iroha_data_model::query`.
...
## Активтар, NFTs, һәм RWAs {#assets-nfts-and-rwas}

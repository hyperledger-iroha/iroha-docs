...
OpenAPI яҙма документын ғәмәлдә булған Torii һуңғы нөктәһенән маршруттарҙы тикшереү, һынау үтенестәрен ебәреү, curl командаларын күсереп алыу һәм клиент кодын булдырыу өсөн ҡулланығыҙ.
...
- Код генерацияһы өсөн Node.js, pnpm һәм OpenAPI генераторы өсөн Java-ҡаҡшы ваҡыт кәрәк.

Консоль ҡалып буйынса `https://taira.sora.org`. урындағы үҫеш, ғәҙәттә, һеҙҙең машинаһында Torii эшләгәндә, `http://127.0.0.1:8080` менән эшләй.

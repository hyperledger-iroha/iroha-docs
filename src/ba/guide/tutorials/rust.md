...
`taira.client.toml` булдырғандан һуң, шул уҡ бинар Taira менән ҡул ҡуйылған канар командаларын эшләй ала. Уларҙы ғәҙәти берәмек һынауҙарынан айырып ҡалдырығыҙ, сөнки улар кран-финансланған иҫәпкә һәм тере тест селтәренә эйә булырға тейеш.

## Rust клиенттар һандығы менән ҡулланыу {#using-the-rust-client-crate}
...
Бланк менән идара итеүсе конфиденциаль бурыстар буйынса эш процестары өсөн [Native Asset Escrow](/ba/blockchain/escrow.md#rust-sdk) ҡарағыҙ. Rust мәғлүмәттәр моделендә әлеге ваҡытта баҙарҙағы конфиденция, дөйөм активтар бикләүҙәр, аноним конфиденсиаль бурыстар, һорауҙар һәм ваҡиғалар өсөн иң тулы типланған ҡаплау бар.
...
- CLI әлеге ваҡытта үҙаллы һандыҡ документтары менән сағыштырғанда яҡшыраҡ яҡлау бирә.

...
Демо менән ҡулланырға [`@iroha/iroha-js`](https://github.com/hyperledger-iroha/iroha/tree/0010c5a70039eac101a4846499ba9ceaf43eb65c/javascript/iroha_js) ҡустыһынан Iroha сығанағы репозиторияһы. `file:` Әгәр ҙә урындағы бәйләнеш үҙгәрә, уны тергеҙеү `iroha/javascript/iroha_js`; Таҙа пакеттар индексы йөк кәрәкле эш урыны юҡ `npm run build:native`.

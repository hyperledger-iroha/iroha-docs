...
# Ҡатнашылған Kaigi а JavaScript Ҡушымта {#embed-kaigi-in-a-javascript-app}

Kaigi ҡушымтаға аҡса янсығы менән тәьмин ителгән бер-бер аудио / видео осрашыуҙар булдырырға мөмкинлек бирә, уларҙың тормош циклы аша теркәлгән Iroha. Браузер һаман да медиа менән эш итә WebRTC, шулай уҡ Torii һәм Kaigi күрһәтмәләре оҙайлы осрашыуҙар яҙмаһы, шифрланған сигнализация метамәғлүмәттәре, шәхси исемлек ярҙамы һәм ҡулланыу ваҡиғалары менән тәьмин итеү.
...
- Node.js 20+ әгәр һеҙ JavaScript демо йәки туғандаш `@iroha/iroha-js` тура бәйләүсе
...
Был командалар раҫлай, TAIRA тере һәм был Kaigi эстафета телеметрияһы бар. Kaigi Транзакциялар. `CreateKaigi` йәки `JoinKaigi` һынау ихтыяждары финансланған TAIRA аккаунттар һәм демо күпер аша ҡултамғалау йәки башҡа аҡса янсығы менән тәьмин ителгән күпер аша.
...
|Iroha күпер | ҡултамғалау, `CreateKaigi`, `JoinKaigi`, `EndKaigi`, сигнал һайлау |
...
Демо ҡушымтаһында был күпер ысулдары ғәмәлгә ашырыла `@iroha/iroha-js`, урындағы ҡултамға, шифрланған Kaigi метамәғлүмәт, һәм Torii шылтыратыуҙар.
...
Ҡоролтай UI тәмәке һынауы иҫбатлай, `/kaigi` реаль медиа тест әле ике финансланған аҡса янсығы плюс ике тәҙрә йәки ҡорамалдар кәрәк, сөнки транзакция ҡултамғаһы, камера, микрофон һәм WebRTC рөхсәт итеү ваҡыты буйынса үҙгәрә.

Әгәр һеҙ һынау TAIRA һәм шылтыратыу буйынса маршрутҡа кире ҡайтарыу `404`, тәү сиратта , ҡабул итеүсе аҡса янсығының уңышлы тапшырылғанлығын раҫлау `CreateKaigi`. Реле һаулығы буйынса һуңғы пункттар ниндәй ҙә булһа махсус саҡырыуҙан алда уҡ була ала.
...
- Ер өҫтө `KaigiRosterSummary`, `KaigiUsageSummary`, һәм `KaigiRelayHealthUpdated` оператор панелендә булған ваҡиғалар.

...
Башланмыш башланғыс сылбыр торошон билдәләй. Редактировка була торған сығанаҡ JSON манифестаһы, ә Iroha 3 узелы ҡул ҡуйылған Norito транзакция файлын тотоп ала.
...
NPoS йәки Nexus профилдәре өсөн тупология һәм BLS Proof-of-Possession талап ителә генерацияланған профиль. Kagami `localnet`, `wizard`, һәм профиль генерацияһы командалары был мәғлүмәтте автоматты рәүештә эшкәртә.

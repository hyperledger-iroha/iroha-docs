...
Һайлаулы `[basic_auth]` бүлеге клиенттарҙың һорауҙарына HTTP `Authorization` башлыҡ өҫтәй. Iroha тиңдәштәре был таныҡлыҡ документтарын туранан-тура аңлатмай; уларҙы Torii Нгинкс кеүек кире прокси артында булғанда ҡулланалар.

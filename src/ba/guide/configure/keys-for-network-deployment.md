...
`--seed` тик ҡабатланмаҫ үҫешеү ҡоролмалары өсөн генә ҡулланыла. яңы асҡыстар барлыҡҡа килтереү һәм шәхси асҡыстарҙы һаҡлау өсөн һаҡлана.

## Тиҫтерҙәр араһындағы берҙәмлек {#peer-consistency}

Бөтә валидаторҙар бер үк генезис транзакцияһы, топология, ышаныслы уртаса асыҡ асҡыстар һәм валидаторы PoPs тураһында килешергә тейеш.

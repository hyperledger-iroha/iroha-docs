...
Әгәр пирҙар килеп инһә Docker йәки Kubernetes, клиент процесы менән барып етә торған хост йәки сервис адресын ҡулланырға. `127.0.0.1` контейнер эсендә - хост машина түгел.

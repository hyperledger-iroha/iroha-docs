...
Әгәр модуль ҡат-ҡат ҡайтанан эшләй башлаһа, модулдә күрһәтелгән конфигурацияны көтөлгән [`peer.template.toml`](/ba/reference/peer-config/index.md#template) һәм иҫке уйынды ҡабатлаймы, юҡмы икәнен тикшерегеҙ. Kura мәғлүмәттәр.

## Сора профиле {#sora-profile}

Iroha 3 ҡулланыусы урынлаштырыуҙар Nexus, SoraFS, йәки күп юллы ағымдар даemon менән Sora профиле менән эшләй башларға тейеш:

...
このセクションでは問題解決のヒントを提供します Iroha 3 設定.確認してください [鍵をチェックした](./overview.md#check-the-keys) 第"に,これは最も一般的な問題源であるため, Iroha.
...
`hex_literal`を使用すると 醜い文字列が明らかに六位数を持つ小さなテーブルになります.

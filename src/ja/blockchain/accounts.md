...
口座は,トランザクションを署名し,本簿状態を持つ権威である.現在の Iroha 3 データモデルでは, `AccountId` はカノニカルでありドメインなしです:それはアカウント管理者から派生され,カノニック的に I105 として暗号化されています.人に読めるドメインとデータスペースのコンテキストは,別々のアカウント・アリア結合に属します.

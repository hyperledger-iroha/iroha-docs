...
Также естественно предположить, что вызов `PrivateKey::try_from_str` на буквальном строке дает только правильный ключ.

К сожалению, сообщения об ошибках не помогают в отстранении такого типа ошибок.

...
Доменные группы регистрируют объекты и предоставляют пространство имен для данных с доменным масштабом. Счета сами по себе не имеют доменов в текущей модели данных, но учетные записи могут владеть доменами и иметь активы, чьи определения живут под доменами.

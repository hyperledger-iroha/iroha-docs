...
В текущем Iroha аккаунт IDs поступает от контролеров счетов, в то время как прогнозируемые домены используют форму `domain.dataspace`:
...
Если это возможно, устанавливайте технический аккаунт триггера на выделенный аккаунта.
...
Исполняемая последовательность инструкций, которую запускает триггер при совпадении фильтра событий.

...
Некоторые инструкции требуют указания места назначения. Например, если вы переводите активы, вам всегда нужно указывать на тот счет, на который вы их передаете.
...
Намерение и план являются тайными, но применяются шаг-знаки и представляет обычную транзакцию с конфигурированной учетной записью.
...
Обратитесь к одному из языковых гидов, которые помогут вам пройти процесс регистрации объектов в блоке:
...
Монетка и сжигание могут относиться к числовым активам и включают в себя ограниченное количество повторений.

Количество активов не является отрицательным, поэтому вы никогда не можете иметь `$-1.0` актива или сжечь отрицательную сумму и получить метку.

Обратитесь к одному из языковых специальных руководств, которые помогут вам пройти процесс разработки активов в блокчейне:
...
Инструкции о предоставлении и отзыве используются для учетных записей [ разрешений и ролей ](permissions.md).
...
Разрешительные команды читают объект разрешения из стандартного ввода:
...
- `Log`: выпустить запись в журнале во время исполнения
...
Усовершенствование исполнителя из составленного файла байткода IVM:

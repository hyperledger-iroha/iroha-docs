...
|Доказательства хешс |Хаши доказательств могут идентифицировать факты, решения, сообщения, манифесты хранения или другие улики вне цепи. Сама по себе доказательная нагрузка не хранится в записях сделок. |
...
Суммы разрешения споров должны быть не отрицательными, и `buyer_amount + seller_amount` должны равняться сумме поручительства. Ноги с нулевым значением разрешены, но весь раздел должен учитывать запертый баланс.
...
Anonymous escrow использует один и тот же рыночный жизненный цикл, но движение средств и закрытие активов защищено. В публичной записи все еще хранятся продавец, покупатель, статус, хэши доказательств, часовые марки и связанные с проверкой записи о движении. Сумма и получатели в закрепленных банкнотах представлены обязательствами, аннулирующими актами и приложениями к доказательству.

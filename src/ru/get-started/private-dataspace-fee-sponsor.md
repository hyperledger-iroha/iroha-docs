...
Сначала используйте Taira или частную тестовую сеть.
...
Затем регистрируйте определение актива. Канонический `--id` - это определение активов на уровне сети ID.
...
Настройка политики со стороны оператора представляет собой задачу SDK или сервисную задачу.
...
Фонд пользователей с `usage#billing.team` во время ввода, продления подписки или выделения квоты.

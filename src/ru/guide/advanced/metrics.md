...
Публичные Taira показатели полезны для изучения названий сигналов.
...
Используйте эти полосы для наблюдаемого выполнения при целевой пропускной способности `Y` TPS и бюджете задержки `L` миллисекунд.
...
Увеличение fanout может уменьшить задержку в более крупных или менее надежных сетях, но также увеличивает трафик.

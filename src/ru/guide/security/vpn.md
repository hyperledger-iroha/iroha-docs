...
Браузер VPN защищает трафик только от этого браузера. Он не защищает `iroha3d`, CLI, SDK, SSH, метрику или резервный трафик, если эти процессы не направляются через ту же частную сеть.

...
- Публикация только конечных точек, необходимых для окружающей среды.
...
- Следите за направлением очереди, а не только за короткими образцами пропускной способности.

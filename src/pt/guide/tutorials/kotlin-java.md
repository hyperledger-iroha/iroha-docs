...
Consulte o [Kotlin SDK README](https://github.com/hyperledger-iroha/iroha/blob/main/kotlin/README.md) para os comandos de construção específicos do módulo APIs e exatos.

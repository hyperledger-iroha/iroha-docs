...
Iroha מאחסן את מצב ספר החשבונות ב- `World`. מודל הנתונים הראשון שלה משתמש באותיות ונושאים קנוניים הבאים:
...
- NFTs הם רשומות בבעלות יחידה עם תוכן מטא-נתונים IDs בעלת רשימת תחום.
...
Aliases הם שמות קריאים לאדם שמונחים מעל מזהים קנוניים של ספר החשבונות. הם שימושיים בגבולות API, CLI, wallet ו־explorer, אך IDs קנוניים נשארים המזהים היציבים שנשמרים בשדות המחמירים של ספר החשבונות.
...
|מטא-נתונים| [מטא-נתונים](/he/blockchain/metadata.md) |
|הוראות רישום והעברות | [הוראות](/he/blockchain/instructions.md) |
|הרשאות סביבת הריצה | [הרשאות](/he/blockchain/permissions.md) |

...
עבור עסקאות חתומות בספר החשבונות, שאילתות חתומות ו־payloads מסוג Norito-native, העדיפו את ערכות ה־SDKs הרשמיות של Iroha. לקוחות OpenAPI אינם מרכיבים חתימות, מנהלים מפתחות חשבון או מקודדים עבורכם גופי עסקאות Norito.

...
5. עבור צומת או עמית, כיצד סיבוב או השבתה מורשים בשרשרת של מפתח ההסכמה מתואמים עם BLS PoP, מדיניות ההפעלה והחפיפה, תצורת המפתח המקומית, `trusted_peers_pop` וטופולוגיית הפריסה
6. כיצד תצורות, יישומים ומפעילים תלויים מאמצים את ה-`AccountId` החדש, את המפתח הציבורי או את זהות העמית

...
- שמרו על רישום של מארחים מתוקנים, זהות צמתים, רשויות חשבונות, מכשירים לחתימה, נקודות סוף ציבוריות ואנשים אחראים.
...
- ניסוי גיבוי, החזרת, החלפת מפתחות ושיקום צמתים לפני ההתחלה של הייצור.
...
- שינויים בחברות המאמתים והצמתים
...
- סיפוק משאבים, קונצנזוס עצר, או אובדן צומתי צפויים
- שינויים בנכסים, רשות וחשבון שמתאימים לחוקים של הונאה.

שלחו התראות לערוץ שאינו תלוי במארח שנפגע. שמרו יומנים רלוונטיים, תמונות מצב של התצורה, אירועים בספר החשבונות וגיבובי עסקאות בצירוף חותמות זמן. ראו [ניטור הונאות](./fraud-monitoring.md) ו[ביצועים ומדדים](../advanced/metrics.md).

## תוכנית התאוששות {#recovery-plan}

הכינו את תוכנית ההתאוששות לפני העלייה לייצור. תוכנית ההתאוששות חייבת לזהות:

- מי יכול להכריז וארגן אירוע.
- כיצד ליצור קשר עם מבקרי אישור, ניהולי תשתיות, בעלי יישומים ומשתמשים מושפעים
- אשר רשויות יכולות לבטל רשיונות, להחליף מפתחות, או לשנות חברות צמתים
...
4. לשחזר את התוכנה וההקונפיגורציה מתוך ארטיפקטים מאובטחים.
5. אשרו את חברות הצמתים, תקינות הקונצנזוס, הנתיבים הציבוריים, הניטור ופעולות הקריאה של היישומים. חדשו פעולות כתיבה ברשת רק לאחר שכל הבדיקות האלה עברו בהצלחה.

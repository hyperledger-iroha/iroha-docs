...
- חשפו רק את נתיבי Torii, הצמתים, הניטור והיישומים שהפריסה דורשת.
...
- שמרו על ההתנהגות הדטרמיניסטית של הרשת. האצת חומרה אינה רשאית לשנות תוצאות הגלויות לצמתים.

## לעקוב אחר הראיות ולשמור אותן {#monitor-and-preserve-evidence}

- עקבו אחר תקינות הצמתים, התקדמות הקונצנזוס, שינויי הרשאות, הוראות מיוחסות, כשלי אימות ושינויי תצורה בלתי צפויים.
- שלחו התראות חשובות למערכת שאינה תלויה במארח שנפגע.
...
- בדקו נהלים לגיבוי, שחזור, החלפת מפתחות, ביטול הרשאות ושחזור צמתים.

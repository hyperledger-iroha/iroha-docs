...
የህዝብ Taira የሙከራ አውታረመረብ የመተግበሪያ ደንበኞች ለንባብ-ብቻ ፍለጋ የሚጠቀሙበትን ተመሳሳይ Torii JSON ወለል ያሳያል ። እነዚህ ትዕዛዞች ቁልፎችን አያስፈልጋቸውም
...
አንድ የህዝብ የሙከራ አውታረመረብ መንገድ `502` የሚመልስ ከሆነ ፣ ጊዜዎችን ያቆማል ወይም የተሟላ ረድፍ ሪፖርት የሚያደርግ ከሆነ ፣ እንደ መጨረሻ ነጥብ ተደራሽነት ችግር አድርገው ይመለከቱት እና ከደንበኛ ኮድዎን ከማስተካከልዎ በፊት በኋላ እንደገና ይሞክሩት ።
...
|`GET /v1/sumeragi/bls_keys` |JSON |ንቁ BLS ስምምነት ቁልፎች |
...
|`GET /v1/sumeragi/params` |JSON |የአሁኑ ሰንሰለት ላይ Sumeragi መለኪያዎች |
...
የመተግበሪያ-ተኮር መቁጠሪያ አንባቢዎች አንድ አማራጭ የካኖኒካዊ የሂሳብ ፊርማ ወሰን ይጠቀማሉ ። ያልተፈረመ ጥያቄ ንቁ የህዝብ የውሂብ ጎታዎችን ብቻ ይቀበላል ። ትክክለኛ የተፈረመ ጥያቄ ለተጠቃሚው የአሁኑ UAID እና በዚያ ሂሳብ `CanReadRestrictedDataspace` ፍቃዶች በተሰየሙት ትክክለኛ የውሂብ የጎታ መስመሮችን የሚጨምር ነው ። `CanReadAllLedgerData` በእያንዳንዱ የውሂብ ቦታ ላይ ታይነትን ይሰጣል. ብቻ `X-Iroha-Account` ወይም ማንኛውንም ያልተሟላ ወይም የተበላሸ የፊርማ ራስጌ ስብስብ በማቅረብ, `401 Unauthorized` ይመለሳል; ወደ አናሚ ታይነት አይመለስም.

ተመሳሳይ ታይነት ዕቃዎች ማጣሪያዎች ሂሳብ, ጎራ, ሀብት-ትርጉም, ንብረት, NFT, RWA, ባለቤት, እና Explorer ን ያነባል. አንድ የጎደለው ነገር እና ከጠሪው ከሚታየው መንገድ ውጭ የሆነ ነገር ሆን ተብሎ ሊለዩ አይችሉም. ለግብይቱ የተመዘገቡት እያንዳንዱ የመንገድ እግር በሚታይበት ጊዜ ብቻ የተሰማሩ ግብይቶች እና መመሪያ ታሪክ ይታያል። ስለዚህ አንድ የተሳታፊ እግር እንኳን ከጠሪው አቅጣጫ ውጭ በሚሆንበት ጊዜ ተደብቋል ፣ የጎደለው ፣ የቆየ ወይም የተበላሸ የጉዞ አውድ ለአለምአቀፍ አንባቢ ብቻ የሚታየው ነው።

Torii ተጠቃሚዎች ማጣሪያዎች, pagination, ቆጠራዎች ወይም SSE, WebSocket, ውል-ክስተት እና ዳግመኛ መስመሮች ላይ ትንበያዎች በፊት ይህን ስፋት ይተግብራል. ረጅም ዕድሜ ዥረቶች መለያ ፍቃዶች ለውጥ ጋር ተመሳሳይ ፈቃድ እንደገና ለመገምገም እና መዳረሻ በኋላ አንድ አጠቃላይ ፍቃድ ውድቀት ጋር ያበቃል. ተሰርዟል።

በስድስት በዓለም ላይ የተደገፉ የኤክስፕሎረር ስብስቦች ግልጽ ያልሆኑ የካኖኒካል base64url ቁልፍ ሰሌዳዎችን ይጠቀማሉ ። ነባሪ ገጽ ገደቡ 25 ነው ፣ ከፍተኛው 100 ሲሆን አንድ ገጽ በከፍተኛ ደረጃ 512 የእጩ ቁልፎችን ይመረምራል። እያንዳንዱ ማጣሪያ ከስብሰባው ፣ ከማጣሪያዎች ፣ ከካኖኒካል የመጨረሻ ቁልፍ እና ከተጠቃሚው ከሚታየው የመንገድ ስብስብ ጋር የተቆራኘ ነው ፣ ስለሆነም በሌላ መጠይቅ ላይ ወይም ከተጠቃሚውን ታይነት ከተቀየረ በኋላ እንደገና መጫወት አይችልም።

የብሎክ, ግብይት, የቅርብ ጊዜ-ግብይት, መመሪያ, እና የቅርብ ጊዜ ትዕዛዝ ታሪክ መርማሪዎች በተጨማሪ የተሰጠውን ቅጽበታዊ ገጽ እይታ ቁመት እና የብሎክ ሃሽ ይለጥፋሉ. ምላሾች `pagination.limit`, `pagination.snapshot_height`, `pagination.snapshot_hash`, `pagination.next_cursor`, እና `pagination.has_more`. ሌላ መንገድ ወይም የማጣሪያ ስብስብ ፣ የተለወጠ የእይታ ዳይጀስት ፣ ወይም አንጓው ከእንግዲህ ማረጋገጥ የማይችል ቅጽበታዊ ገጽ እይታ ይዘጋል። የማገጃ ሰራተኛው በሚሰራበት ጊዜ የታሪክ ስካን በ Torii የጥያቄ-መግቢያ ፈቃድ ውስጥ ይቀራል።

ኤክስፕሎረር WebSocket ዥረቶች የተጣራ ማጠቃለያዎችን ያወጣሉ እና መቁጠሪያ ፍቃዶች ሲቀየሩ የእይታን እንደገና ማስላት። የአገር ውስጥው `GET /v1/blocks/stream` መንገድ የተለየ ነው: ሙሉውን ያወጣል የተፈረመባቸው ብሎኮች፣ በእጅ መጨናነቅ ወቅት `CanReadAllLedgerData` ይጠይቃል፣ እና ይህ ፈቃድ በኋላ ላይ ከተሰረዘ ይዘጋል።

የቀጥታ `GET /v1/sumeragi/status/sse` የስምምነት-ምርመራ ዥረት እንዲሁ የማይታወቅ የመረጃ ቦታ ምግብ አይደለም ። በእያንዳንዱ ግንኙነት ሙከራ ላይ የተሟላ ኦፕሬተር ፊርማ ራስጌ አራተኛ ያስፈልገዋል ። ደንበኞች ለትክክለኛ ዥረት URI አዲስ ፊርማ ይፈጥራሉ እና በራስ-ሰር የመጓጓዣ ዳግም ሙከራ አማካኝነት የተፈረመውን ሙከራ አይከተሉም ወይም እንደገና አይጫወቱም ።
...
እያንዳንዱ የተፈቀደ ድልድይ ተሳታፊ ካታሎግ አለው ። እያንዳንዱ ተሳታፊ ግቤት ልዩ ተሳታፊ ID ፣ አንድ ወይም ከዚያ በላይ የአስተናጋጅ የህዝብ ቁልፎች ፣ አንድ ወይም ተጨማሪ የገንዘብ መታወቂያዎች ፣ የተፈቀደ የመገለጫ ስብስብ እና `originator` ፣ `counterparty` ወይም ሁለቱም ሚናዎች አሉት ። የኦፕሬተር ቁልፎች እና የገንዘብ መታወቂያዎች ከአንድ በላይ ተሳታፊ ሊሆኑ አይችሉም ። `audit_admin_keys` ን በተናጠል ያዋቅሩ; የአውዲት አስተዳዳሪ ቁልፍም እንዲሁ የተሳታፊ ለውጥ ቁልፍ ሊሆን አይችልም ።

ሁሉም ISO የመንገድ መስመሮች አዲስ ኦፕሬተር ፊርማ ያስፈልጋቸዋል. `pacs.008`, `pacs.009`, `sese.023`, ወይም `colr.012` በማመልከቻው ራስጌ የተገለጸውን ተሳታፊ የሚያመለክተው ኦፕሬተር መሆን አለበት። `From` የገንዘብ ማንነት. `To` ማንነት ሌላ የተዋቀረ ተሳታፊ ስም መስጠት አለበት ፣ እና ለተመረጠው መገለጫ ለሁለቱም ወገኖች ይፈቀድላቸዋል። ቀጣይነት ያለው የመግቢያ መዝገቦች አዘጋጅ ፣ ግብረ-ወጪ ፣ በመግባት ተሳታፊና ኦፕሬተር ቁልፍ፣ እንዲሁም የመጀመሪያ መገለጫ እና የተካተቱ ፊርማዎች ፖሊሲ።
...
### ዘላቂ የመልሶ ማጫወት መታወቂያ እና የተፈረሙ የቦክስ ሰነዶች {#durable-replay-identity-and-signed-outbox-documents}

ISO የመመዝገቢያ መደብሮች ብቻ ቅጅ ይቀበላሉ V3 መዝገቦች እና የመቃብር ድንጋዮች መልሶ ማጫወት. Torii የቀጠለው ውሂብ ከተጠቀሰው መርሃግብር ጋር የማይጣጣም ከሆነ ግልጽ የሆነ አለመመጣጠን ስህተት በመኖሩ መጀመሩ አልተሳካም ፣ ስለዚህ የመጀመርያ ልቀት ማከማቻዎች እና መለዋወጫዎች መፈጠር አለባቸው። አንድ የተለየ ዘላቂ የመቃብር ድንጋይ መልዕክቱን ይጠብቃል ID, የስራ ጭነት ሃሽ፣ የንግድ መልእክት ID, እና UETR ለሙሉ ድብልቅነት TTL የበለጸጉ መዝገቦች ዝርዝሮች ከተቆረጡ በኋላም ቢሆን።

Torii የህይወት ዑደት መልዕክት ከመፈረም ወይም ከማቀናበሩ በፊት እንደገና መጫወት መቀበል ይቀጥላል ። ያልተጠናቀቀ የመልሶ ማጫወት ማንነት በጭራሽ አይለቅም። የተዋቀረው መዝገብ አቅም በ TTL የተጠበቁ ግቤቶችን ብቻ የሚይዝ ከሆነ ፣ ግቤቶች የህይወት ዑደትን ወይም የሂሳብ ደረጃን ሳይለውጡ ሊመለሱ የሚችሉ `503 Service Unavailable` ይቀበላሉ ።
...
በ UTF-8 ባይት ቅደም ተከተል `iroha.iso20022.outbound.v2` ፣ በአንድ ዜሮ ባይት እና በትክክለኛው የምላሽ አካል ላይ ፊርማውን ያረጋግጡ ። ከማረጋገጫ በፊት XML ን እንደገና ቅርጸት ወይም መደበኛነት አይጠቀሙ።
...
በዴሞ ሪፖ ውስጥ ለተፈቀደ ቁጥጥር የሚከተሉትን ይሮጡ:
...
የ መጨረሻ ነጥብ ታይነት የአገናኙ `telemetry.profile` ቅንብር ላይ የተመሠረተ ነው። የአሁኑ ውቅር አምስት የመገለጫ ደረጃዎችን ያጋልጣል-

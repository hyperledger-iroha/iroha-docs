...
የቅልጥፍና ማበረታቻ መግባት በተሳካ ሁኔታ ተዘግቷል ። `incentives.enable` እውነት ከሆነ ፣ `incentives.trusted_verifier_ids` ቢያንስ አንድ እና በከፍተኛው 64 የካኖኒካል መለያዎች IDs ሊኖረው ይገባል ። አሂድ ጊዜ ዝርዝሩን እንደ የተወሰነ ቅደም ተከተል ስብስብ ያከማቻል ፣ እና ልክ ያልሆነ የዝርዝሩ ጂኦሜትሪ በትራንስፖርት ጅምር ወቅት ውድቅ ይደረጋል።

እያንዳንዱ `RelayBandwidthProof` በተወሰነ ማዕቀፍ/የመከፋፈል በጀት መሠረት ይከፈታል እናም ሙሉውን ማዕቀፍ ያጠቃልላል ። የምስክርነት ማረጋገጫ መለያው በተዋቀረው ዝርዝር ውስጥ መኖር አለበት ፣ እና `RelayBandwidthProof::verify_signature()` ስኬታማ መሆን አለበት ፣ ከመተላለፉ በፊት የአፈፃፀም አከባቢውን ይዘጋል ወይም ይለውጣል ። አንድ የማይታመን ፊርማ ወይም የፊርማ ልክ ያልሆነ / የተበላሸ ማስረጃ ስለዚህ ምንም መለኪያ አያበረክትም እና ማበረታቻ ቅጽበታዊ ገጽ እይታን ሊያመጣ አይችልም ።
...
ባይት ከማንበብዎ በፊት, Torii የአከባቢው ማኒፌስት ካኖኒካል ኮዲንግን ፣ የሴማንቲክ ገደቦችን ፣ ዲጀስትን እና ሥርውን ያረጋግጣል ። CID. ከዚያ በኋላ ትክክለኛውን የአከባቢ አቅራቢ ማንነት ፣ አስተዳደር ይፈልጋል የመልዕክት ማመልከቻው ተቀባይነት፣ የተያዘለት ተኳሃኝነትና የማስወገድ ቁጥጥር፣ CID, የጌትዌይ ተመኖች/የእገዳ ፖሊሲ ውጤታማውን የደንበኛ አድራሻ ይጠቀማል፣ የተላለፉ አድራሻዎችን ማክበር የሚቻለው በተዋቀሩ የታመኑ ወኪሎች በኩል ብቻ ነው። የጎደለው ፖሊሲ፣ ተገዢነት፣ መወገድ፣ ማንነት ወይም የመግቢያ ሁኔታ ተዘግቷል ።

አንድ ጥያቄ መጨረሻ-ወደ-መጨረሻ የህዝብ መግቢያ ፍቃድ ይዟል; ለሂደቱ በሙሉ ገደቡ 64 concurrent ንባቦች ነው, ከመጠን በላይ ጥያቄዎችን በመመለስ `503 Service Unavailable` እና `Retry-After: 1`. በግልጽ የሚታዩ መልሶች በ 16 ላይ የተገደቡ ናቸው MiB, የፋይል ዝርዝሮች በነባሪነት 50 ግቤቶችን ይቀበላሉ እና ከፍተኛውን 500 ይቀበላሉ ፣ እና ሙሉ ፋይል ወይም ነጠላ ባይት ክልል በ 8 የተገደበ ነው MiB. CIDs, መጠይቆች, አስተናጋጆች, መስመሮች እና ክልል ራስጌዎች ያላቸውን ካኖኒካዊ ነጠላ ዋጋ ያላቸው ቅጾችን መጠቀም አለባቸው. HTML, ስክሪፕት፣ SVG, XML, PDF, ወይም Wasm ይዘት ብቻ ነው የተዋቀረ CID-የተገኘ ገለልተኛ አመጣጥ (ወይም ወደዚያ የሚመራ) ፣ የተጋራ የመንገድ-ጌትዌይ አመጣጥ የማይታመን ይዘት እንዳይፈጽም ይከላከላል ።

### መጠነኛነት የሚያጋጥሙ ፈተናዎች {#moderation-challenges}

SoraFS የማስተካከያ ፈተና ኢኮኖሚክስ የስምምነት ሁኔታ ነው ። ንቁ ፖሊሲው የአስተዳደር ድምጽ አሰጣጥ ንብረት እና ለኤስሮው እና ለመቀነስ ጥቅም ላይ የሚውሉ የአስተዳደር ሂሳቦች ስም ይሰጣል ። እያንዳንዱ ፈተና በትክክል 150 ዩኒት ያንን ሀብት ይፈልጋል ፣ እሱን ማሳደግ ቦንድውን በአቶሚካዊነት ወደ ኤስሮው ይዛወራል። አንድ ጉዳይ ሁለት ዓይነት ፈተና መታወቂያ፣ በተመሳሳይ ሂሳብ ሁለተኛ ፈተና ወይም እንደገና ጥቅም ላይ የዋለው የምስክር ወረቀት ያለ ሚዛን መለወጥ ወይም ፈተና መቁጠሪያዎች ውድቅ ያደርጋል።

ለችግሩ ማቅረቢያ ጊዜ እና ለችግሩን ለመፍታት ጊዜ የተለየ ነው ። የአስተዳደር አመራር የሚቀርበውን ተቃውሞ ለመቀበል ወይም ውድቅ ለማድረግ ቅርብ ከሆኑ አስተያየቶች በኋላ በትክክል 24 ሰዓታት ይቀበላል ። የሚጠበቁ ተግዳሮቶች የብሎክ ድምጽ ማቅረቢያ በዚያ የውሳኔ ሃሳብ ገደብ ብቻ ይገልጻል-

- ተቀባይነት ያለው ተቃውሞ ጉዳዩን ያቆማል እና ሙሉውን ቦንድ ተመላሽ ያደርጋል።
- ተቀባይነት የሌለው ተቃውሞ ጉዳዩን እንዲቀጥል ያስችለዋል ፣ 25% የሚሆነውን ቦንድ ወደ ቅናሽ ተቀባዩ ይልካል (በድምፅ አሰጣጡ ላይ ባለው ንብረት ትክክለኛነት መሠረት ክብ ይደረጋል) እና ቀሪውን ተመላሽ ያደርጋል ።
- ያልተፈታ ጥያቄ ከክፍያ መስኮቱ በኋላ ያበቃል ፣ አይከፈትም ፣ እና ሙሉውን ቦንድ ይመልሳል ።

`ExpireSorafsModerationChallenge` ፈቃድ የሌለው እና ቀድሞውኑ የጨረሰውን ተቃውሞ ለመቃወም አቅም የለውም ። ስለዚህ አንድ የጎደለው ጠባቂ ገንዘብን መቆለፍ ወይም መክፈቻዎችን መከልከል አይችልም። እያንዳንዱ ስምምነት አቶም ነው: ማንኛውም ተመላሽ ገንዘብ ወይም ቅነሳ ካልተሳካ, ሙሉው ስምምነት ተመልሷል.

የማስተካከያ ፖሊሲው እና የጉዳይ መዝገቦች የመጀመሪያውን የመልቀቂያ መርሃግብር በቀጥታ ይጠቀማሉ ። ኖዶች በጄኔዝ / ሁኔታ ጅምር ወቅት ቀድሞ የተቆረጡ የቀጠሉ አቀማመጦችን ውድቅ ያደርጋሉ። ወይም ቅጽበታዊ ገጽ እይታ መልሶ ማቋቋም; የድምፅ አክሲዮን, የመጠባበቂያ ሂሳቦች, ገደቦች, ወይም ኢኮኖሚክስ ከቀድሞው ሁኔታ ከመወሰን ይልቅ እነዚያን መሳሪያዎች መልሰው ያስቀምጡ.

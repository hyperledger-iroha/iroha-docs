...
የ ማሳያውን ይጠቀሙ [`@iroha/iroha-js`](https://github.com/hyperledger-iroha/iroha/tree/0010c5a70039eac101a4846499ba9ceaf43eb65c/javascript/iroha_js) ከወንድም Iroha ምንጭ ማከማቻ. `file:` ተወላጅ ተያያዥነት በቀጥታ ያ ቼክአውት ይፈታል. `iroha/javascript/iroha_js`; ንጹህ የፓኬጅ ማውጫ በ Cargo የሚፈለገውን የሥራ ቦታ አይይዝም `npm run build:native`.

...
Les mêmes étiquettes d'exécution et de télémétrie peuvent être écartées à partir de `iroha3d`:
...
- [Les options `iroha3d` FastPQ](/fr/reference/iroha3d-cli.md#arg-fastpq-execution-mode)

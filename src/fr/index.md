...
features:
  - icon:
    ...
    title: "Commencez"
    details: "Créer l'espace de travail actuel, lancer un réseau local et commencer à utiliser le Iroha 3 CLI"
    link: /fr/get-started/
  - icon:
      dark: /build.svg
...
<p style="font-weight: 200; font-size: 0.875rem;">Hyperledger Iroha fait partie de <a href="https://www.lfdecentralizedtrust.org/projects/tag/ledger-technology" target="_blank">LF Decentralized Trust</a>. En savoir plus à <a href="https://iroha.tech/" target="_blank">iroha.tech</a>.</p>

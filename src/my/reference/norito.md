...
Norito ရှိသည် Iroha ဒါက Network peers တွေမှာ သုံးတဲ့ byte format ပါ။ SDKs, CLI ကိရိယာများ၊ Torii, Kura, ထုတ်လုပ်ထားတဲ့ လက်ရာတွေဟာ တူညီတဲ့ အသုံးဝင်မှုမှာ သဘောတူဖို့ လိုပါတယ်။

အသုံးပြုခြင်း Norito ဒေတာဟာ သဘောတူညီချက်၊ လက်မှတ်ရေးထိုးမှု၊ hashing၊ persistence သို့မဟုတ် cross-SDK ပူးပေါင်းဆောင်ရွက်နိုင်မှု JSON ဘယ်အချိန်မှာ API endpoint ဟာ operator တွေ၊ dashboard တွေ ဒါမှမဟုတ် quick debugging တွေအတွက် လူသားဖတ်လို့ရတဲ့ projection တစ်ခုကို ရှင်းလင်းစွာ ပေးပါတယ်။
...
|blockchain ပေါ်ပေါက်ခြင်း |`kagami genesis sign` ဟာ လက်မှတ်ထိုးထားတဲ့ `.nrt` ဘလော့ကို ထုတ်ပေးပြီး Network peers တွေက startup မှာ load လုပ်ကြတယ်။ |
|Torii ရိုက်ထည့်ထားတဲ့ တုံ့ပြန်မှု |API endpoints တွေမှာ typeed binary responses ကို support လုပ်တဲ့ endpoints က `Accept: application/x-norito` ကို အသုံးပြုတယ်။ |
...
|Kura သိုလှောင်ခြင်း |Block payloads, recovery auxiliary records, rosters များနှင့် block-finalisation marker များကို Norito ဖွဲ့စည်းထားသော ဒေတာအဖြစ် သိမ်းဆည်းထားသည်။ |
|နည်းပညာထုတ်ပြန်ချက်များ|Nexus, data availability, SoraFS, streaming, and app-facing technical manifests use Norito when the technical manifesto must be signed or hashed. |
|Streaming ကို|Norito Streaming သည် Norito နည်းပညာ manifest များ၊ segment headers များ၊ ထိန်းချုပ်ရေး frame များနှင့် လိုက်နာမှု fixtures များကို အသုံးပြုသည်။ |

Norito သည် စမတ်စာချုပ်ဘာသာစကားမဟုတ်ပါ။ ငွေကြေးလုပ်ငန်းများ၊ စာချုပ်ခေါ်ဆိုမှုများ၊ နည်းပညာထုတ်ပြန်ချက်များနှင့် API ရိုက်ထည့်သော အသုံးဝင်ဝန်ဆောင်မှုများကို သယ်ယူပို့ဆောင်သည့် သတ်မှတ်ချက်ဆိုင်ရာဒေတာ ကွန်တိန်နာနှင့် ကိုဒီကပါ။

## အသုံးဝင် ဝန်ဆောင်မှု ပုံစံ {#payload-model}

ပရိုတိုကောလ်သယ်ယူပို့လွှတ်မှု (သို့) disk ပေါ်ရှိ Norito အသုံးဝင်ဝန်ဆောင်မှုတိုင်းကို ခေါင်းစဉ်တစ်ခုနဲ့ ဖွဲ့စည်းထားပြီးနောက်မှာ ကုဒ်သွင်းထားတဲ့ အသုံးဝင်ဝန်ပိုး ဘိုင်က်များဖြစ်သည်။ ခေါင်းစီးမဲ့ (သို့မဟုတ် bare) အသုံးဝင်ဝန်ထမ်းများကို ပြည်တွင်း hashing, benchmarks နှင့် helper APIs အတွက် သိမ်းဆည်းထားပြီး ပို့ဆောင်ခြင်းမတိုင်မီ ရလဒ်ကို ချက်ချင်း ခေါင်းစဉ်တစ်ခုထဲထည့်သွင်းသည်။
...
|Schema ကို cryptographic hash |၁၆ ဘိုက်များ|မမျှော်လင့်တဲ့ အသုံးဝင်မှုများကို ပယ်ချရန် Typed Decoders များက အသုံးပြုသော Type Identity ကို။ |
...
ခေါင်းစဉ်သည် ဘိုက် (၄၀) ရှိသည်။ decoders သည်သင်္ကေတ, ဗားရှင်း, ထောက်ပံ့သောအမှတ်တံဆိပ်မျက်နှာဖုံး, အသုံးဝင်မှုရှည်, checksum နှင့် schema cryptographic hash ကိုပြန်လည်တည်ဆောက်ရန်မတိုင်မီ validate လုပ်သည်။

## အလှဆင်အလံများ {#layout-flags}
...
|`COMPACT_LEN` |`0x02` |အလိုအလျောက်|တန်ဖိုးအလိုက် အရှည် prefix များအတွက် Single Protocol Standard လက်မှတ်မထိုးထားတဲ့ varints ကို အသုံးပြုတယ်။ |
...
Flag တွေက ရှင်းလင်းပါတယ်။ decoders တွေဟာ payload ပုံစံ၊ version minor (သို့) heuristics ကနေ layout ကို infer မလုပ်ကြပါဘူး။ မသိတဲ့ (သို့) မတည်ငြိမ်တဲ့ ပေါင်းစပ်မှုတွေကို ပယ်ချထားပြီး network peers အားလုံးဟာ payload တစ်ခုကို တစ်နည်းတည်းနဲ့ interpret လုပ်နိုင်ကြပါတယ်။

## ကုဒ်ရေးစည်းမျဉ်းများ {#encoding-rules}

Norito သည် Iroha ဒေတာပုံစံတွင်ဖော်ပြထားသော အများသုံးဒေတာပုံစံများအတွက် သတ်မှတ်ချက်ဆိုင်ရာ စီမံကိန်းများကို အသုံးပြုသည်-
...
ဤစည်းမျဉ်းများသည် လက်မှတ်များနှင့် cryptographic hash များအတွက် အရေးပါသည်။ logical transaction တစ်ခုတည်းကို တည်ဆောက်သည့် SDKs နှစ်ခုသည်တူညီသော single protocol-standard byte ကိုထုတ်လုပ်ရမည်ဖြစ်သည်။

## Schema cryptographic hashes များ {#schema-hashes}

Typed Norito payloads သည် ခေါင်းစဉ်တွင် 16-byte schema cryptographic hash ကို သယ်ဆောင်သည်။ အလိုအလျောက် cryptographic Hash သည်အပြည့်အဝသတ်မှတ်ထားသောအမျိုးအစားနာမည်မှရယူထားသည်။ တည်ဆောက်မှု schema hashing ကိုခွင့်ပြုသည့် build များသည် cryptographic hashtag ကို single protocol-standard schema မှရယူသည်။

Typed decoders သည် schema incompatibilities ကို ပယ်ချသည်။ ဤသည်မှာ client များကို valid Norito frame ကို မှားယွင်းသော type အဖြစ် မတော်တဆ decoding မှ ကာကွယ်ပေးပြီး SDK test artifact bundle က node data model ကနေ drift လုပ်တဲ့အခါ ပုံမှန် ပျက်ကွက်မှု mode ဖြစ်ပါသည်။
...
Norito သည် API အပြီးသတ်မှတ်ချက်များနှင့် ကိရိယာများအတွက် JSON အမျိုးအစားစနစ်ကို မစွန့်ခွာဘဲ Norito ကိုဖယ်ရှားရန် လိုအပ်သော ဒေသခံ JSON stack ကိုပါ ၀ င်သည်။

|JSON feature ကို |အသုံးပြုမှု ကိစ္စ|
| --- | --- |
|`norito::json::{to_json, from_json}` |Deterministic typeed JSON code/decode ကိုနှိပ်ပါ။ |
|လှပပြီး စာရေးဆရာရဲ့ အကူအညီပေးသူပါ။|CLI ထုတ်ကုန်များ၊ စမ်းသပ်မှုပစ္စည်းများနှင့် streaming `std::io` ပေါင်းစပ်ခြင်း။ |
...
|`#[norito(skip_serializing_if = "...")]` |JSON ကွင်းတွေကို predicate ကိုက်ညီတဲ့အခါ ချန်ထားပြီး deterministic decoding default တွေကို ထိန်းသိမ်းပါတယ်။ |
...
## ဆော့ဝဲပက်ကတ် Feature မိသားစုများ {#crate-feature-families}
...
API အပြီးသတ်မှတ်ချက်တစ်ခုက လက်ခံတဲ့အခါ (သို့) Norito ရိုက်နှိပ်တဲ့ပြန်ကြားမှုတွေမှာ ဒီခေါင်းစဉ်တွေကို အသုံးပြုပါ။
...
API အပြီးသတ်မှတ်ချက်တစ်ခုက ကိုယ်စားပြုချက် နှစ်ခုစလုံးကို ထောက်ပံ့တဲ့အခါ ဖောက်သည်တွေဟာ ရှင်းလင်းတဲ့ ကြိုက်နှစ်သက်မှုစာရင်းကို ပို့နိုင်ပါတယ်
...
Norito Streaming ဟာ မီဒီယာတွေနဲ့ အချိန်နဲ့တပြေးညီ သယ်ယူပို့ဆောင်ရေး မျက်နှာပြင်တွေကို တူညီတဲ့ သတ်မှတ်ချက်ဆိုင်ရာ ချဉ်းကပ်မှုကို ဖြန့်ချိပါတယ်။ အဓိက အပိုင်းတွေက:

|Streaming feature ကို |ရည်ရွယ်ချက်|
| --- | --- |
|နည်းပညာထုတ်ပြန်ချက်များ|segment cryptographic commitment values, privacy routes, capabilities, codec profile, encryption suite နဲ့ content key metadata တွေကို ကြေညာပါ။ |
...
|Cryptographic commitment values အစိတ်အပိုင်းများ |ကြည့်ရှုသူတွေနဲ့ relays တွေကို serve မလုပ်ခင် (သို့) decode မလုပ်ခင် အသုံးဝင် ဝန်ဆောင်မှု အပိုင်းတွေကို Technical Manifesto ကို စစ်ဆေးခွင့်ပြုပါ။ |
|ထိန်းချုပ်ရေး ဘောင်များ |Technical manifest ကြေညာချက်များ၊ ပြန်ကြားချက်များ၊ အဓိက update များနှင့် စွမ်းဆောင်ရည် ညှိနှိုင်းမှုများကို ဆောင်ရွက်ပါ။ |
...
|Conformity vectors များ|ဘာသာစကားစုံ စမ်းသပ်မှု လက်ရာတွေဟာ SDKs ကို တစ်နည်းတည်းသော နည်းပညာ manifesto တွေ၊ segment တွေနဲ့ entropy streams တွေကို dekode လုပ်ဖို့ သက်သေပြတယ်။ |

Streaming-specific codecs နဲ့ entropy profiles တွေဟာ core Norito transaction/query format ကနေ ခွဲခြားထားပေမဲ့ သူတို့ရဲ့ technical manifest တွေနဲ့ control data တွေက Norito ကို အသုံးပြုတုန်းပဲဆိုတော့ routing, billing, replay နဲ့ audit evidence တွေကို ပြန်လည်ဖန်တီးနိုင်သေးတယ်လေ။

## လုပ်ငန်းဆိုင်ရာ လမ်းညွှန်ချက်များ {#operational-guidance}

- SDK ဆောက်လုပ်ရေးကိရိယာများနှင့် ထုတ်လုပ်သော ချည်နှောင်မှုများကို လက်နဲ့ထုတ်လုပ်သည့် Norito byte များထက် ပိုနှစ်သက်သည်။
- Schema ကွဲပြားမှုကို အပြောင်းအလဲ ကွန်ရက် ပျက်ကွက်မှုအဖြစ်မဟုတ်ဘဲ ဗားရှင်း (သို့) စမ်းသပ်လက်ရာပြဿနာတစ်ခုအဖြစ် ကုသပါ။
- Archive `.nrt`, `.norito` နဲ့ ထုတ်ပေးခဲ့တဲ့ release (သို့) incident bundle ထဲမှာရှိတဲ့ technical manifest လက်ရာတွေပါ။
...
- Typed အသစ်တစ်ခုထည့်တဲ့အခါ Torii API အဆုံးသတ်မှတ်ချက်၊ လက်ခံမှု မှတ်တမ်း JSON, Norito, (သို့) နှစ်ခုစလုံး၊ ပြီးတော့ ထောက်ပံ့တဲ့ အကြောင်းအရာအမျိုးအစားတွေကို `/openapi.json`.
...
- [Norito ပုံစံ သတ်မှတ်ချက်](https://github.com/hyperledger-iroha/iroha/blob/0010c5a70039eac101a4846499ba9ceaf43eb65c/norito.md)
- [Norito ဆော့ဝဲအိတ် README](https://github.com/hyperledger-iroha/iroha/blob/0010c5a70039eac101a4846499ba9ceaf43eb65c/crates/norito/README.md)

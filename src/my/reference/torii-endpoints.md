...
|`GET /v1/api/versions` |JSON |ထောက်ပံ့ထားသော Torii API မူကွဲများ |
...
`pacs.009` တင်ပြချက်တွေဟာ စီးပွားရေး သတင်းစကားကို ပေးပို့ရမှာပါ။ ID, သတင်းစကား အဓိပ္ပါယ်ဖွင့်ဆိုချက် ID, တည်ထောင်ချိန်၊ ဘဏ်အချင်းချင်းဖြေရှင်းမှု ပမာဏ၊ ငွေကြေးငွေ၊ ဖြေရှင်းရက်၊ ညွှန်ကြားချက်ပေးသူနှင့် ညွှန်ပြထားသော အရာရှိ။ BICs, အကြွေးရှင်နဲ့ ချေးငွေပေးသူ IBANs. သတင်းအချက်အလက်မှာ ပါဝင်ပါက `Purp`, လက်ရှိတွင် တံတားသည် စာရင်းအင်းများအတွက် ရင်းနှီးမြှုပ်နှံမှုများကိုသာ လက်ခံနေသည်- `Purp=SECU`.

နိုင်ငံတကာ `pacs.008` နှင့် `pacs.009` တင်ပြမှု အဆုံးသတ်မှတ်ချက်များ လက်ခံ XML ISO တံတား စမ်းသပ်မှုတွေမှာ အသုံးပြုတဲ့ ဖုံးအုပ် (သို့) ပွင့်လင်းတဲ့ ကွင်းပုံစံပါ။ ရွေးချယ်စရာ `SplmtryData` ကွင်းတွေက ပစ်မှတ်ကို ညှိနိုင်တယ် Iroha မှတ်ပုံတင်စာရင်း၊ အရင်းအမြစ်နှင့် ရည်မှန်းချက်စာရင်း IDs (သို့) လိပ်စာများနှင့် အရင်းအမြစ် သတ်မှတ်ချက် ID. အဖြေက `202 Accepted` နှင့်အတူ `message_id`, `transaction_hash`, `status`, `pacs002_code`, ပြတ်တောက်နေတဲ့ စာရင်းအင်း/စာရင်း/အရင်းအမြစ် အခြေအနေ။
...
`--room-policy public` ကို ကြည့်ရှုသူလက်မှတ်မပါဘဲ Relay တွေက ပွင့်လင်းစေနိုင်တဲ့ အခန်းများအတွက် (သို့) `--room-policy authenticated` ထွက်ပေါက်များတွင် ကြည့်ရှုသူအတည်ပြုမှုလိုအပ်တဲ့အခါမှာ အသုံးပြုပါ။ ကွန်ရက်မှာ Kaigi စာရင်းနှင့် အသုံးပြုမှု စစ်ဆေးရေး သော့တွေ ဖွဲ့စည်းထားပြီးနောက်မှသာ `--privacy-mode zk-roster-v1` ကိုအသုံးပြုပါ။ ဒါမဟုတ်ရင် deterministic verification အတွင်းမှာ joins တွေ၊ leaves တွေနဲ့ private usage record တွေ ကျရှုံးသွားပါတယ်။
...
နောက်ဆုံးမှတ်တိုင်အမြင်က telemetry setting များအပေါ် မူတည်သည်။ Upstream Docs တွင် profile အဆင့်ငါးခုကိုဖော်ပြထားသည်-

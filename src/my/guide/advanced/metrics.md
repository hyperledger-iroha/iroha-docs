...
Telemetry မြင်ကွင်းသည် သတ်မှတ်ထားသော ပရိုဖိုင်အပေါ် မူတည်သည်။ အသုံးပြုခြင်း `extended` လိုအပ်တဲ့အခါမှာ `/metrics`, အသုံးပြုခြင်း `full` ကာလအတွင်း အသေးစိတ် Sumeragi အော်ပရေတာလမ်းကြောင်းတွေကိုလည်း လိုအပ်တဲ့ စမ်းသပ်မှု လမ်းစဉ်တွေပါ။

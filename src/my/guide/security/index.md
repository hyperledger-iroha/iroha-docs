...
Iroha deployment ကို sensitive data နဲ့ value တွေကို စီမံခန့်ခွဲတဲ့ စနစ်တိုင်းလိုပဲ Secure လုပ်ပါ။ Signing keys, network access, node operations, monitoring, and incident response တို့ကို ကာကွယ်ပါ။ blockchain ledger ဟာ ဒီထိန်းချုပ်မှုတွေရဲ့ လိုအပ်ချက်ကို မဖယ်ရှားဘူး။
...
သံသယရှိတဲ့အလုပ်ကို ရှာဖွေဖို့နဲ့ တုံ့ပြန်မှု သက်သေတွေကို ထိန်းသိမ်းဖို့ blockchain ledger ဖြစ်ရပ်တွေ၊ မေးမြန်းချက်တွေ၊ ခွင့်ပြုချက်တွေနဲ့ လုပ်ဆောင်ရေး အချက်ပြမှုတွေကို ဘယ်လိုသုံးရမလဲပေါ့။
...
- [အများပြည်သူသော့စာဝှက်ချက်](./public-key-cryptography.md)
...
`kagami` ဖြင့်ထောက်ပံ့သော cryptographic key များကိုထုတ်လုပ်ပါ။
  ...
  - [Cryptographic Key ကို သိုလှောင်ခြင်း](./storing-cryptographic-keys.md)

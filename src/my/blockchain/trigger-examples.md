...
ဤဥပမာသည် IDs နယ်ပယ်မဲ့စာရင်းနှင့် Iroha 3 ဒေတာပုံစံတွင် စီမံကိန်းအရင်းအမြစ်အနက်ကောက်ချက်များကို အသုံးပြုသည်။

ကွန်ရက်တစ်ခုမှာ:

- Alice ရဲ့ သော့က ထိန်းချုပ်တဲ့ တရားဝင်စာရင်းတစ်ခု
...
ရည်မှန်းချက်က Alice ရဲ့ လက်ဖက်စာရင်းကို စောင့်ကြည့်ပြီး Mad Hatter အကောင့်ကနေ ငွေလွှဲပြောင်းမှုကို ထုတ်လွှင့်တဲ့ ကွပ်ကဲမှုတစ်ခုကို မှတ်ပုံတင်ဖို့ပါ။

## (၁) စာရင်းများနှင့် အရင်းအမြစ်များကို ပြင်ဆင်ခြင်း {#_1-prepare-accounts-and-assets}

ပါဝင်သူစာရင်းများနှင့် အရင်းအမြစ်အဓိပ္ပာယ်သတ်မှတ်ချက်များကို ပထမဦးဆုံး မှတ်ပုံတင်ပါ။ လက်ရှိ Iroha တွင်, စာရင်း IDs သည်စာရင်းထိန်းချုပ်သူများထံမှလာသည်၊ စီမံကိန်း domain များတွင် `domain.dataspace` ပုံစံကိုအသုံးပြုသည်။
...
အရင်းအမြစ်အဓိပ္ပါယ်ဖွင့်ဆိုချက်မှာ Canonical ပွင့်လင်းမြင်သာမှုမရှိတဲ့လိပ်စာတစ်ခုရှိတုန်းပါ။ မှတ်ပုံတင်ပြီးနောက် ဒီလိပ်စာကို သိမ်းဆည်း (သို့) မေးမြန်းပြီး trigger လုပ်ဆောင်မှုတွင် အသုံးပြုပါ။
...
SDK ၏ လက်ရှိရိုက်ကူးထားသော builders များကို နောက်ဆုံးရောင်းဝယ်မှု အသုံးဝင်ဝန်ဆောင်မှုအတွက်အသုံးပြုပါ။ ထရီဂါကုဒ်တွင် hard-coding ရှေးစာသား IDs ကိုရှောင်ရှားပါ; စစ်ဆေးခြင်း (သို့) မေးမြန်းမှု ကန်နီကလီးယား IDs အကောင်အထည်ဖော်နိုင်သည့် build မလုပ်ခင်။
...
4. trigger-produced effects တွေကို block execution pipeline ထဲမှာ handle လုပ်ပြီး Restricted recursive trigger execution ကို မပြုလုပ်ဘဲ ပြုလုပ်ပါတယ်။

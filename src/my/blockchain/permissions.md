...
အကောင့်တွေဟာ blockchain ပေါ်မှာ လုပ်ဆောင်ချက် အမျိုးမျိုးအတွက် ခွင့်ပြုချက် လက်မှတ်တွေ လိုအပ်ပါတယ်၊ ဥပမာ အရင်းအမြစ်တွေကို ထုတ်ပေးရန် (သို့) ဖျက်ဆီးဖို့ပါ။

အများပိုင် blockchain နှင့် ပုဂ္ဂလိက blockchain အကြားမှာ အသုံးပြုသူများအား ပေးအပ်သော ခွင့်ပြုချက်များအရ ခြားနားမှုရှိသည်။ အများပိုင် blockchain တွင် အကောင့်အများစုသည် ခွင့်ပြုချက်တွေ တူညီသည်။ ပုဂ္ဂလိက blockchain မှာ အများစုအကောင့်တွေဟာ သက်ဆိုင်ရာ ခွင့်ပြုချက်မပေးဘဲနဲ့ သူတို့ကို ပေးထားတဲ့ ခွင့်ပြုမှု အရင်းအမြစ် အပြင်မှာ ဘာတစ်ခုမှ မလုပ်နိုင်ဘူးလို့ ယူဆကြတယ်။
...
ခွင့်ပြုချက်လက်မှတ်များသည် တက်ကြွသော အကောင်အထည်ဖော်သူက သတ်မှတ်ထားသည့် အမျိုးအစားပစ္စည်းများဖြစ်သည်။ တစ်ချို့လက်မှတ်များသည် ကမ္ဘာလုံးဆိုင်ရာဖြစ်သည်၊ ဥပမာ `CanManagePeers` နှင့် အခြားသူများမှာ အကောင့်တစ်ခု၊ အရင်းအမြစ်တစ်ရပ်၊ ပိုင်ဆိုင်မှု အဓိပ္ပါယ်ဖွင့်ဆိုခြင်း၊ ဒိုမင်တစ်ခု၊ NFT ၊ အခန်းကဏ္ဍ သို့မဟုတ် trigger ကဲ့သို့သော သီးခြား blockchain လက်မှတ်စာရင်းအရာရှိတစ်ခုသို့ ရည်ရွယ်သည်။
...
[ရည်ညွှန်းချက်](/my/reference/permissions) အခန်းမှာ ကြိုတင်ပြင်ဆင်ထားတဲ့ ခွင့်ပြုချက် လက်မှတ်စာရင်းကို တွေ့နိုင်ပါတယ်။
...
Mouse ရဲ့စာရင်းမှာရှိတဲ့ [metadata များ](/my/blockchain/metadata.md) အကောင့်ကို အခြားတစ်ခုက ဝင်ခွင့်ပြုမယ့် ကဏ္ဍသစ်တစ်ခုကို မှတ်ပုံတင်ပါရစေ။
...
စာရင်းသွင်းပြီးနောက် Mouse က Alice ကို ပေးအပ်နိုင်သည်-
...
Default validator မျက်နှာပြင်ကို blockchain ledger နယ်ပယ်ဖြင့်စုစည်းထားသည်

- ကွန်ရက် peer management
...
တိကျတဲ့ token စာရင်းကို [ခွင့်ပြုချက် Token ကို ရည်ညွှန်းခြင်း](/my/reference/permissions.md) မှာ source-backed လုပ်ထားတယ်။

### ဆော့ဖ်ဝဲ အကောင်အထည်ဖော်မှု ပတ်ဝန်းကျင် Validators {#runtime-validators}

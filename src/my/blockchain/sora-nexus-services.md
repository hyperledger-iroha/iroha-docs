...
Relay incentive intake ကို ကျရှုံးမှုမရှိဘဲ ပိတ်ထားတယ်။ `incentives.enable` ဒါက အမှန်ပါ။ `incentives.trusted_verifier_ids` အနည်းဆုံး တစ်ပုဒ်နဲ့ အများဆုံး ၆၄ ပုဒ်ကို ဖမ်းယူရမယ်။ IDs. Runtime က roster ကို deterministic ordered set အဖြစ် သိမ်းထားပြီး relay startup လုပ်စဉ်မှာ invalid roster geometry ကို ပယ်ချတယ်။

`RelayBandwidthProof` တစ်ခုစီကို Fixed Frame/allocation budget နဲ့ decod လုပ်ထားပြီး အပြည့်အဝ frame ကို စားသုံးရပါမယ်။ proof verifier account ကတော့ ဖွဲ့စည်းထားတဲ့ roster ထဲမှာ ရှိနေဖို့လိုပြီး `RelayBandwidthProof::verify_signature()` ဟာ အောင်မြင်ရမှာပါ။ မယုံနိုင်တဲ့ လက်မှတ်ထိုးသူ (သို့) လက်မှတ်လက်မှတ်မမှန်/အတုလုပ်ထားတဲ့ အထောက်အထားက တိုင်းတာမှုတစ်ခုမှ ပါဝင်ခြင်းမရှိဘူး၊ လှုံ့ဆော်ချက် snapshot ကို ထုတ်လုပ်နိုင်ခြင်း မရှိပါ။
...
| --- | --- |
|`GET /.well-known/sorafs/manifest` |Canonical request host က ရွေးချယ်ထားတဲ့ manifesto ကို ပြန်ပေးပါ။|
...
Torii သည် byte များကို ဖတ်ရှုရန်မတိုင်မီ ဒေသတွင်းထုတ်ပြန်ချက်၏ Canonical encoding, semantic constraints, digest နှင့် root CID ကိုအတည်ပြုသည်။ ထို့နောက် local provider identity၊ governance admit and governed compliance and takedown checks for the manifesto, CID တို့အားလိုအပ်ပါသည်။ Gateway rate/ban policy သည် client address ကိုအသုံးပြုပြီး forwarded address များကို configured trusted proxies များမှတစ်ဆင့်သာ ဂုဏ်ပြုသည်။ ပျောက်ဆုံးနေသောမူဝါဒ၊ လိုက်နာမှု၊ ဖျက်သိမ်းခြင်း၊ ကိုယ်စားလှယ်လက္ခဏာ သို့မဟုတ်ဝင်ခွင့်အခြေအနေကိုပိတ်နိုင်ခြင်းမရှိပါ။

တောင်းဆိုချက်တစ်ခုမှာ အဆုံးမှ အဆုံးအထိ ပြည်သူ့ဂိတ်တံခါး ခွင့်ပြုချက်ရှိပြီး လုပ်ငန်းစဉ်တစ်ခုလုံးအတွက် ကန့်သတ်ချက်က တစ်ပြိုင်နက်ဖတ်ခြင်း ၆၄ ခုဖြစ်ပြီး အလွန်အကျွံတောင်းဆိုချက်တွေက `503 Service Unavailable` နှင့် `Retry-After: 1` ကိုပြန်ပို့ပေးပါတယ်။ Manifest တုံ့ပြန်မှုများကို 16 MiB တွင်သတ်မှတ်ထားသည်၊ ဖိုင်စာရင်းများတွင် အလိုအလျောက် ၀ န်ဆောင်မှု ၅၀ ရှိပြီး အများဆုံး 500 ကိုလက်ခံထားရသည်၊ နှင့်ပြည့်စုံသောဖိုင် သို့မဟုတ် တစ်ဘက်တာအကွာအဝေးကို 8 MiB သို့သတ်မှတ်ထားသည်။ CIDs, မေးမြန်းချက်များ၊ အိမ်ရှင်များ၊ လမ်းကြောင်းများနှင့်အကွာခြားမှုခေါင်းစဉ်များသည်သူတို့၏ Canonical single-value form များကိုအသုံးပြုရမည်။ Active HTML, script, SVG, XML, PDF သို့မဟုတ် Wasm content ကို configured CID derived isolated origin (သို့မဟုတ် အဲဒီကို redirected) မှသာ serve လုပ်ပေးခြင်းဖြင့် မျှဝေထားသော path-gateway origin က မယုံနိုင်စရာ အကြောင်းအရာများကို executing မလုပ်စေပါ။

### နှိမ်နင်းမှု စိန်ခေါ်မှုများ {#moderation-challenges}

SoraFS နှိမ်နင်းမှု စိန်ခေါ်မှု စီးပွားရေးသည် သဘောတူညီချက်အခြေအနေဖြစ်သည်။ တက်ကြွသောမူဝါဒက အုပ်ချုပ်ရေးမဲပေးပိုင်ခွင့်အရင်းအမြစ်နှင့် ကန့်သတ်ချက်များအတွက်အသုံးပြုသည့် အုပ်ချုပ်မှုစာရင်းများကိုအမည်ပေးသည်။ စိန်ခေါ်မှုများတိုင်းတွင် ထိုအရင်းအမြစ်ကို အတိအကျ ၁၅၀ ယူနစ်လိုအပ်သည်။ ၎င်းကိုတိုးမြှင့်ခြင်းအားဖြင့် ဘဏ်ဘောင်ကို အက်တမ်တစ်ဆင့် ကန့်သတ်မှုအဖြစ်ပြောင်းပေးသည်။ ကိစ္စတစ်ခုမှာ စိန်ခေါ်မှုအမှတ်တံဆိပ် နှစ်ထပ်၊ အလားတူစာရင်းက ဒုတိယစိန်ခေါ်မှု (သို့) ဘားလန်များ (သို့) စိန်ခေါ်ချက်တွက်စက်များကို ပြောင်းလဲခြင်းမရှိဘဲ ပြန်လည်အသုံးပြုတဲ့ အထောက်အထားကို ပယ်ချတယ်။

စိန်ခေါ်မှုတင်သွင်းရန် နောက်ဆုံးအချိန်နှင့် စိန်ခေါ်မှုကို ဖြေရှင်းရန် နောက်ဆုံးအချိန်သည် ကွဲပြားခြားနားသည်။ လက်ရှိစိန်ခေါ်မှုကို လက်ခံရန် သို့မဟုတ် ငြင်းပယ်ရန် နီးစပ်သည့် တင်ပြချက်များအပြီးတွင် အုပ်ချုပ်ရေးမှူးအနေဖြင့် ၂၄ နာရီတိတိရစ္ဆာန်များကို ရယူနိုင်ပါသည်။

- လက်ခံထားတဲ့ စိန်ခေါ်မှုတစ်ခုက အမှုကို ရပ်ဆိုင်းပြီး အချုပ်အခြာအားလုံးကို ပြန်လည်ပေးချေတယ်။
- ငြင်းပယ်ခံရတဲ့ စိန်ခေါ်မှုတစ်ခုက အမှုကို ဆက်လက်လုပ်ဆောင်စေပြီး အချုပ်အခြာငွေရဲ့ ၂၅% ကို လျှော့ချခံသူဆီ ပို့ပေးတယ် (မဲပေးပိုင်ခွင့်ရှိတဲ့ အရင်းအမြစ်ရဲ့ တိကျမှုအရ ကျုံ့သွားတယ်) နောက် ကျန်တာတွေကို ပြန်လည်ပေးပို့တယ်။
- ဖြေရှင်းမရသေးတဲ့ စိန်ခေါ်မှုတစ်ခုက ခွင့်ပြုချက် ပြတင်းပေါက်အပြီးမှာ ကုန်ဆုံးသွားတယ်၊ မဖွင့်တော့ဘူး၊ ပြီးရင် အပြည့်အဝ ချုပ်ဆိုမှုကို ပြန်ပေးတယ်။

`ExpireSorafsModerationChallenge` ဟာ ခွင့်ပြုချက်မရှိပြီး သက်တမ်းကုန်ဆုံးသွားတဲ့ စိန်ခေါ်မှုအတွက် စွမ်းအားမဲ့ပါ။ အမှုအဆုံးသတ်မှုဟာ backstop လိုပဲ သက်တမ်းကုန်ကျတဲ့ သဘောတူညီချက်ကို လုပ်ဆောင်တယ်။ ထို့ကြောင့် ပျောက်ကွယ်နေသူသည် ငွေကြေးကို ပိတ်ထားခြင်း (သို့) ဖေါ်ပြချက်များကို ပိတ်ထားခြင်းကို မထားနိုင်ပါ။ ရုံးချိန်းတစ်ခုစီသည် အက်တမ်ဖြစ်သည်: မည်သည့်ငွေပြန်လည်ပေးချေမှု သို့မဟုတ် ခြေလက်ဖြတ်တောက်မှုမဆို ကျရှုံးပါက အပြည့်အဝရုံးချိန်အား ပြန်လည်ဖြည့်စွက်သည်။

Moderation policy နှင့် case record များတွင် ပထမဦးဆုံးထုတ်လွှင့်ခြင်း schema ကို တိုက်ရိုက်အသုံးပြုသည်။ node များသည် genesis/state အစပျိုးမှုအတွင်း ကြိုတင်ဖြတ်တောက်ထားသော persisted layouts များကို ပယ်ချပါသည်။ (သို့) snapshot ပြန်လည်ထူထောင်ခြင်း။ မဲပေးပိုင်ခွင့်အရင်းအမြစ်၊ ထိန်းသိမ်းမှုစာရင်းများ၊ နောက်ဆုံးရက်များ သို့မဟုတ် စီးပွားရေးကို အမွေအနှစ်အခြေအနေမှ မှောက်ယူတာအစား ဒီကိရိယာတွေကို ပြန်လည်ဖန်တီးပါ။

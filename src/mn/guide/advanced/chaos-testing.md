...
Izanami-г үйлдвэрлэлийн өмнөх уялдуулалтын шалгалт, регрессийн нөхөн сэргээлт, санал нэгдмэлтийн тохируулалт хийхэд ашиглаарай. Үйлдвэрлэлийн сүлжээ рүү нэвтрүүлэхгүй: хэрэгсэл нь эхлүүлсэн өрсөлдөгчдийг эзэмших зорилгоор бүтээгдсэн бөгөөд тэр дундаа peer restarts, хадгалах хувцас, түр хугацааны найдвартай peer partitions болон орон нутгийн CPU эсвэл дискний даралтыг багтааж байна.
...
Izanami нь TUI болон CLI тохируулгыг хэрэглэгчийн конфигурацийн товчооны доор хэвээр үлдээж байна. Эхний нэвтрүүлгийн файл нь нэг тодорхой V1 загварын байттай; урьдчилсан нэвтрүүлэх эсвэл өөрөөр хэлбэрээр ангилагдаагүй тохируудыг татгалзаж, шилжихээс илүү дахин бий болгох ёстой. Одоогийн профилийг дахин ашиглахаасаа өмнө дэлгэцнээ тавьсан тохируулгыг хянан үзээрэй.
...
|Сүлжээний хуваарилалт |`--fault-enable-network-partition` |Урьдчилан итгэмжлэгдсэн нөхдүүдээс тусгаарлах|
|CPU стресс|`--fault-enable-cpu-stress` |Орон нутгийн баталгаажуулалтын болон хуваарийн даралт |
|Дискийн давтамж|`--fault-enable-disk-saturation` |Орон нутгийн хадгаламжийн даралт |

Зөвхөн сүлжээний хуваарилалтын хэрэгслийн хувьд:
...
|Засаг даргыг тусгаарлах |Зөвхөн сүлжээний хуваарилалтын алдаатай яг нэг алдаатай өрсөлдөгчийг ашиглах; Izanami нь Sumeragi удирдагч телеметрийн дагуу .|
...
- гарын үсэг зурсан RS16 ханшийн хохирол, хүлээлгэгдсэн чуулганы хуралдаанууд, эв нэгдлийн хөдөлгөөний хямрал
...
- "Peer restart", "storage wipe" эсвэл "partition" нөхөн сэргээлт нь гар угаах хэрэгтэй.

...
Контейнерийн нэрийг баталгаажуулахын тулд `docker ps` -ийг ашиглах. Тулгарсан багт нь ижил төстэй контейнерүүдийг `./localnet/docker-compose.yml` -ээр тодорхойлж байна.

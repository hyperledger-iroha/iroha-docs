...
|`UnfreezeRwa` |Байшин эзэмшигчдийн үйл ажиллагааг сэргээх. Захиргааны удирдлага болон `freeze_enabled` .|
|`RedeemRwa` |Хөдөлмөрийн хэмжээг бууруул. Хувь хүн, хяналтын ажилтан болон `redeem_enabled` .|
...
Олон нийтийн хэсгүүд бүртгэгдээгүй бол `items` хол гаргах төлөвтэй байна. Бүртгэл, шилжүүлэн суулгах, хадгалах, хатуулах, төлөх нь гарын үсэг зурсан гүйлгээ юм.
...
Урьдчилсан мэдээллийг ашигла RWA ID Энэ зангилаасаа эргэн иржээ. Энэ жишээ нь `alice` эзэмшигч гэж үздэг бөгөөд мөн `hold_enabled`-ийн хяналтын тоног төхөөрөмжөөр тохируулж байна.
...
Захиргааны гаднах шалгалт нь хэвийн эзэмшигчдийн үйл ажиллагааг зогсоох ёстой үед ихээхэн мөсөн байна. Гарын үсэг зурагч нь хяналтын ажилтан байх ёстой, цуврал нь `freeze_enabled`тэй байх ёстой.
...
Нээлтийг ашиглан эрс тэтгэмжлэгдсэнээс хойш тэтгэвэрт гарах. Мэдээлэл нь зах зээлийн гадны гэрчилгээ эсвэл бүртгэлийн баталгааг харуулдаг:

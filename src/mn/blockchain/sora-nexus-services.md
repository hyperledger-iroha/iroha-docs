...
Рэлегийн урамшуулалтын хэрэглээ нь гараагүй. Хэзээ `incentives.enable` Энэ үнэн. `incentives.trusted_verifier_ids` хамгийн багадаа нэг, хамгийн ихдээ 64 санхүүгийн тэмдэглэлтэй байх ёстой. IDs. Хөдөлмөрийн цаг нь жагсаалтыг тодорхойлолтын зохицуулалтын цуврал болгон хадгалдаг бөгөөд ээлжит бус жагсаалтын геометрийг релейн эхлэлийн үеэр татгалзах юм.

`RelayBandwidthProof` нь тогтмол дэглэм / хуваарилалтын төсөвт хамрагдаж, бүрэн дэглээг хэрэглэх ёстой. Дашрамд тооцооны баталгаажуулагч нь тохируулсан жагсаалтад байх ёстой бөгөөд `RelayBandwidthProof::verify_signature()` нь амжилттай байх ёстой: цахилгаан дамжуулагч нь гүйцэтгэлийн цуглуулгыг хааж эсвэл өөрчлөхөөс өмнө. Итгэмжлэгдэхгүй гарын үсэг зурагч эсвэл гарын үсгийн хүчингүй / сахилгатай нотолгоо тул ямар ч хэмжилтийг оруулж чадахгүй бөгөөд урамшууллын хүйтэн зураг гаргаж чадахгүй байна.
...
SoraFS-ийн хүчин чадалтай Torii түймэр нь сонголттой хэрэгсэл API баригдаагүй ч эдгээр олон нийтийн нууц чиглэлийг байрлуулдаг:

|Хэрэглээ, төгсгөл нь |Зорилго|
| --- | --- |
|`GET /.well-known/sorafs/manifest` |Каноникийн хүсэлт хүлээн авагч сонгосон маннифтыг буцааж өгөх |
|`GET /v1/sorafs/cid/{cid}` |Нэг CID ын хувьд заасан орон нутгийн манифестын мета өгөгдлийг болон файлын бүртгэлүүдийг буцааж өгөх. |
...
Байт уншихаас өмнө Torii орон нутгийн манифстийн каноникийн код, семантик хязгаарлалт, дигест, түлх CID-ийг баталгаажуулна. Дараа нь энэ нь орон нутгийн авьяасны үйлчилгээ үзүүлэгчний тодруулгыг шаарддаг, засаглалын хүлээн зөвшөөрөл, зохицуулсан нийцүүлэл болон манфистын татаж авах шалгалтыг шаардаж байна, CID, Gateway rate/ban policy нь үйлчлүүлэгчдийн үйл ажиллагааны хаягийг ашиглаж, шилжүүлсэн хаягуудыг зөвхөн тохируулсан итгэмжлэгдсэн төлөөлөгчээр дамжуулан хүндэтгэж байна.

Нэг хүсэлт нь төгсгөлөөс төгсгөл хүртэлх олон нийтийн хаалганы зөвшөөрлийг эзэмшдэг; үйл явцын хязгаар нь 64 зэрэглэлийн уншилт, хэтэрсэн хүсэлтийг `503 Service Unavailable` болон `Retry-After: 1` нь эргүүлэн өгөх юм. Дашрамдсан хариуг 16 MiB хэмжээнд, файлын жагсаалтыг 50 бүртгэлээр хангаж, хамгийн ихдээ 500-ийг хүлээн авдаг бөгөөд бүрэн файл эсвэл нэг байтын диапазон нь 8 MiB хэмжээнд хангагдана. CIDs, асуултууд, хөтлөгчүүд, замыг болон диапазоны толгойч нь хуулийн нэг үнэлгээтэй хэлбэрийг ашиглах ёстой. Active HTML, script, SVG, XML, PDF, эсвэл Wasm-ийн агуулгыг зөвхөн CID-аас үүссэн өөрчилсөн эх үүсвэрээс (эсвэл тэнд чиглүүлэх) хангадаг бөгөөд хуваалцсан замын хаалганы эх үүсвэр нь итгэхгүй агуулгыг гүйцэтгэхээс урьдчилан сэргийлж байна.

### Төмөрлөгийн асуудал {#moderation-challenges}

SoraFS хяналтын бэрхшээл эдийн засаг нь тохиромжтой байдал юм. идэвхт бодлого нь удирдлагын санал өгөх хөрөнгийг нэрлэдэг бөгөөд захиргааны санхүүжилт болон хяналт тавих бүртгэлд ашиглагддаг. Бүх бэрхшээл нь тухайн хөрөнгийн яг 150 нэгж шаарддаг; үүнийг нэмэгдүүлэх нь бондтыг атомын дагуу баталгаажуулах болно. Тухайн хэргийн хувьд хоёр дахин давхар хяналтын тодруулалт, мөн адил бүртгэлийн хоёр дахь хяналт тавих ёсоор эсвэл тэнцвэрийг өөрчлөхгүйгээр дахин ашигласан баримтыг үгүйсгэхгүй.

Хөдөлмөрийг өргөн мэдүүлэх хугацаа, асуудлыг шийдвэрлэх хугацаа нь ялгаатай. Удирдах засаглал хүлээлттэй эсэх асуудлыг хүлээн зөвшөөрөх эсвэл үгүйсгэхэд өргөн мэдүүлэг гарснаас хойш яг 24 цагийн дараа хүлээн авдаг. Хөгжлийн хяналт шалгаруулалтын дараах асуудлыг шийдвэрлэх хугацаа дуустал block ballot нь зөвхөн:

- хүлээн зөвшөөрөгдсөн эсэргүүцэл нь хэргийг зогсоож, бүхэлд нь буцаан төлдөг.
- татгалзсан эсэргүүцэл нь хэргийг үргэлжлүүлэн явуулж, бондын 25%-ийг тасарч авагчдад хүргүүлнэ (борондоо санал өгөх хөрөнгийн үнэн зөв байдлаас шалтгаалж) болон үлдсэн хэсгийг буцаан олгоно.
- шийдвэрлэлээгүй бэрхшээл нь даатгалын цонхны дараа дуусгавар болж, нээлттэй болоогүй бөгөөд бүрэн бондыг буцаан олгоно.

`ExpireSorafsModerationChallenge` нь аль хэдийн дууссан эсэргүүцлийн хувьд зөвшөөрөлгүй, хүчингүй. Хэргийг эцэслэн шийдвэрлэхэд хяналтын засалтай нэгэн адил дууссан зохицуулалт хийгддэг, Иймд байцаагч байхгүй бол мөнгийг хааж, нээлттэй хадгалахыг зогсоож чадахгүй. Аливаа зохицуулалт нь атомын байдаг: ямар нэгэн буцалтгүй мөнгөний төлбөр эсвэл цаасан хөл нь алдаатай бол бүхэл бүтэн зохицуулалтыг эргүүлнэ.

Модерацийн бодлого болон тохиолдлын баримт бичгүүд нь анхны нэвтрүүлгийн схемыг шууд ашигладаг. Нодууд эх үүсвэр / байдлын инициализацын үеэр урьдчилсан хэвээр үлдсэн тархилуудыг татгалзах эсвэл снэп-шоот сэргээлт; сонгогчдын актив, хадгаламжийн данс, мөрийн хугацаа, эдийн засаг хуучин байдлаас дүгнэлт гаргахын оронд тэдгээрийг сэргээн засварлах.

...
Зарим удирдамжид зориулалттай газрыг тодорхойлох шаардлагатай байдаг. Жишээ нь, эд хөрөнгийг шилжүүлэн суулгахдаа аль дансанд шилжүүлж байгаагаа үргэлж заасан байх хэрэгтэй.
...
Зохиол, төлөвлөгөө нь нууцгүй боловч алхам тэмдэгт хэрэглэж, тохируулсан данстай энгийн гүйлгээг өргөн мэдүүлнэ.
...
Та [ генезисийн блок](/mn/guide/configure/genesis.md)-ийг `genesis.json` -д хэрхэн байгуулж шийдвэрлэхээс хамаарч (тасандаа зөвшөөрлийн токейн бүртгэлтэй эсэх нь), дансны бүртгэлийн үйл явц маш өөр байж болно.
...
Блокчейн дээр объектыг бүртгэх үйл явцын дагуу танд хэлний талаарх удирдамжуудын нэгээр хүргэж өгье:
...
Тэгсэний бүртгэл нь IVM байткод эсвэл цувралчилсан заалын жагсаалтыг бүрдүүлнэ. Энэ жишээ нь `Log` заалыг CLI-ийн дагуу бүтээж, түүнийг тэгсэйн бүртгэл рүү дамжуулдаг:
...
BLS товчоо, PoP товчоог `kagami` -тай үүсгэн байлгах, хэрэв таны өмнө нь байхгүй бол:
...
Чингисэл, түймэрлэх нь тооны эд хөрөнгийг илэрхийлж, хязгаарлалттай дахин давтагдалтай үйл ажиллагаа явуулдаг.

Ашигт малтмалын хэмжээ нь сөрөг биш тул та хэзээ ч `$-1.0` хөрөнгийг авч чадахгүй, эсвэл сөрөг хэмжээг шатааж, сөрөг мөнгийг авах боломжгүй.

Блокчейн дээр хөрөнгийг олборлох үйл явцын талаар танд хэлний тодорхой удирдамжуудын нэгээр хүргэж өгье:
...
## Үндэсний хадгаламж, хөрөнгийн гулгал {#native-escrow-and-asset-locks}
...
Хөдөлмөрийн зөвшөөрлийг олгох, цуцалах:

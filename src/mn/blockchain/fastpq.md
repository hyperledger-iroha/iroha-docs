...
Багтын шилжүүлэн суулгах нь хэд хэдэн делтатай нэг бичгийг ашигладаг. Энэ тохиолдолд "Посейдон"-ын нэг делта шинжилгээгүй байна.
...
Үндсэн хуулийн Rust код нь талбайн элементийг каноник хэлбэрээр илэрхийлдэг `u64` түвшинд `[0,p)`. Үүнд нэмэлт, хатуулах нь:
...
Хөдөлгөөн нь `p` -ийг нэмж, буцааж, үр дүн нь каноник байх хүртэл нөхцөлтэй. Балансын делта гэх мэт гарын үсэг зурсан бүрэн дугаардыг:
...
V1 AIR бүрэлдэхүүний үнэ нь шугам орон нутгийн үлдэгдлийн сүлжээнд хамаардаг. Үргэлж нь хоёр бэрхшээлтэй байна:
...
Бүх талбар нь баталгааны олон нийт IO байт-байттай нийцэх ёстой. Дараа нь шалгагч ижил транскриптыг дахин боловсруулж, мөнгийг гаргадаг:
...
FastPQ провер нь урсгалыг үүсгэхээс өмнө хувьчлалын түлхүүр, үйл ажиллагааны зэрэгцээгээр цувралтын жагсаалтыг санхүүжүүлдэг. нэвтрүүлгийн дараалал. Үргэлтийн шугам нь мөн транскриптын метабараа шаарддаг. Хөдөлмөрийн шилжүүлэн суулгах шугамтай, аливаа шилжилтийн тэмдэглэлгүй цуврал хүчингүй.

...
# 样本和食谱 {#samples-and-recipes}

Iroha 源存储库包含 SDK 配方和测试套件,跟踪与节点相同的修订.
...
对于新的 Android 工作,使用 Kotlin-first `core-jvm`, `client-android`和 `offline-wallet-android`模块,描述在 [Kotlin, Android 和Java](/zh-hans/guide/tutorials/kotlin-java.md). Kotlin SDK 是 Android 消费者的常规起点.

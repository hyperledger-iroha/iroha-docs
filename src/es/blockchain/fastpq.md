...
Las mismas etiquetas de ejecución y telemetría se pueden anotar desde `irohad`:
...
- [Opciones `irohad` FastPQ ](/es/reference/irohad-cli.md#arg-fastpq-execution-mode)

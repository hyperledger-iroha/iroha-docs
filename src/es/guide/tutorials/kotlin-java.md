...
Consulte el [Kotlin SDK README](https://github.com/hyperledger-iroha/iroha/blob/main/kotlin/README.md) para los comandos de construcción específicos del módulo APIs y exactos.

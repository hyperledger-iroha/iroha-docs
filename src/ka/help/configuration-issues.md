...
თუ თქვენ არასდროს მუშაობდით მულტიჰეშით ადრე, ბუნებრივია ვივარაუდოთ, რომ მარჯვენა მხარე არ არის საკვანძო ბაიტების (ორი სიმბოლო ბიტში), არამედ ASCII (ან UTF-8) კოდირებული ბაიტები. დაძახეთ `from_hex` სტრიქონის ლიტერალურზე როგორც `public_key`, ასევე `private_key` ინსტანციაში.

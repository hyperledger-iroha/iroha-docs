...
არ ჩასვით პირადი გასაღები აგენტის მოთხოვნაში. თუ აგენტს უნდა შექმნას ტრანზაქცია, მიუთითეთ მას ადგილობრივ კოდზე, რომელიც ატვირთავს საიდუმლოებებს მომხმარებლის runtime გარემოსგან, საკვანძო ჯაჭვიდან, ტექნიკური ხელმოწერის ან იგნორირებული testnet კონფიგურაციის ფაილის. აგენტმა არასოდეს უნდა დაწეროს საკვანძო მასალა მარკდაუნში, ჩართულებში, ლოგებში ან კომიტეტებში.
...
კანარი წარადგენს ხელმოწერილ პინგს, ელოდება დადასტურებას და წერს გამშვები დროის ხელმომწერი კონფიგურაციას, როდესაც `--write-config` მოცემულია. Taira არის საჯარო ტესტის ქსელი, ასე რომ რიგების saturation შეიძლება გააკეთოს ხელმოწერილი პინგი არასწორია მაშინაც კი, როდესაც თავად ონკანი მუშაობს. თუ `taira doctor` იუწყება გაჯერებული რიგის შესახებ, ან კანაირი ბრუნდება `PRTRY:NEXUS_FEE_ADMISSION_REJECTED`, დაელოდეთ და კიდევ ერთხელ სცადეთ, სანამ მას კლიენტის კონფიგურაციის შეცდომად შეექმნით.
...
გამოიყენეთ მიღებული ანგარიში ID იქ, სადაც Nexus API ან CLI ბრძანება ითხოვს კანონიკურ ანგარიშს ID, მაგალითად, Taira საბაგირო `account_id`, ბალანსის გამოკითხვები, მკაცრი ანგარიშის ველები ან საგნური კავშირები. შეინახეთ შესაბამისი კერძო გასაღები თქვენი კლიენტის კონფიგურაციაში და აირჩიეთ იგივე საჯარო ქსელი `[account].profile = "taira"` ან `[account].profile = "minamoto"`.
...
ამავე მონაცემთა სივრცის Minamoto განხორციელება მხოლოდ Taira დანერგვის შემდეგ, მოწევის გამოცდების, მონიტორინგის შემდეგ; და მმართველობის მტკიცებულებები მთლიანია.

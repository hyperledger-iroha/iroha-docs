...
გამოიყენეთ კანონიკური I105 ანგარიში IDs, თუ თქვენს განთავსებას არ აქვს აქტიური ანგარიშის ანალიზი იგივე ანგარიშებისთვის.
...
ანგარიშები კვლავ არის კანონიკური I105 ანგარიში IDs. მომხმარებელთა სახეზე სახელები არის ანგარიშის საიდენტიფიკაციო დასახელებები უნდა იყოს არამგრძნობიარე სახელები, როგორიცაა `alice@team` ან `alice@members.team`. არ გამოიყენოთ ტელეფონის ნომრები ან ელ.ფოსტის მისამართები როგორც საიდენტური. ეს ეკუთვნის კერძო იდენტიფიცირების ნაკადს შემდეგ განყოფილებაში.

Alias setup იყენებს იმავე დეკლარაციურ დაგეგმვას, როგორც დომენის დაყენება. ჰქონდეთ SDK ან ინბორდინგის სერვისი შექმნას საიდუმლოების გარეშე `AliasSetupPlanRequestV1` განზრახვა, რომლის ანგარიშზე შესვლის მიზანი არის `$USER`, ირჩევს პირველ როლს, აკრიფებს ციფრულ მონაცემთა სივრცეს ID და ატარებს მიმდინარე იჯარის ციტატის დაცვას. ამის შემდეგ დაგეგმეთ და გამოიყენოთ ეს როგორც ერთი ატომური ოპერაცია:
...
არ გამოიყენოთ `gas_asset_id` "ლოკალური ტოქენის საფასურის" ნიმუში, თუ არ გსურთ, რომ სპონსორს გაზის აქტივშიც გადაიხადოს. მიმდინარე ექსპლუატაციის პერიოდში, `fee_sponsor` ასევე ქმნის სპონორს კონფიგურირებული მილსადენი-გაზის აქტივების დავალიანების გადამხდელის. ადგილობრივი ტოკენების მომხმარებელთა გადასახადებისთვის, შეაგროვეთ ტოკენი მკაფიოდ ტრანსფერის ან ხელშეკრულების წესით.

...
FastPQ არის Iroha -ის STARK მტკიცებულების გზა შეირჩეული შესრულების ეფექტებისთვის. ის არ შეცვლის ჩვეულებრივი ტრანზაქციის შესრულებას ან კონსენსუსს. ტრანზაკციები კვლავ გრძელდება ISI, IVM და Sumeragi როგორც ყოველთვის; FastPQ მოიხმარს დეტერმინისტური განხორციელების მოწმეს და მხარდაჭერილი ეფექტები გარდაქმნის მტკიცებულებათა პარტიებად.
...
განხორციელება პირობითად ემატება ან ამცირებს `p`, სანამ შედეგი არ იქნება კანონიკური. ხელმოწერილი მთლიანი რიცხვები, როგორიცაა ბალანს დელტები, ჩასმულია შემდეგი:
...
შეკვეთის ვალდებულება არის Poseidon2- ის ველის ჰეში დომენის `fastpq:v1:ordering` და Norito კოდირების შესახებ განლაგებული გარდატეხების:
...
ვარიანტური ერთდელის გადაცემის დიგესტი აძლევს კოდირებული გადაცემის წინასწარი გამოსახულების:
...
თითოეული კოეფიციენტის სვეტისათვის `c`, FastPQ პირველ რიგში ინტერპოლებს სვეტის ღირებულებებს კოეზიის დომენის ზედაპირზე და ჰეშავს კოეიფექტორის ვექტორს:
...
მამოწმებელი `A_i` შეადგენს ნიმუშით გამოტანილი რიგების ღია ადგილებისთვის და შეამოწმებს მას AIR-ის შემადგენლობის Merkle ფესვის შესაბამისად ვალდებულებული შემადგენლობითი ღირებულების მიხედვით.
...
FastPQ მტკიცებულების შემოწმება აღადგენს კანონიკური პარტიის ვალდებულებას და ასახავს საჯარო ტრანსკრიპტს. ვერიფიკატორი ამოწმებს პროტოკოლის ვერსიას, პარამეტრების შედგენილ ვერსიაზე, განმეორებითი ლიმიტებზე, კვალიფიკაციის ვალდებულებაზე, საჯარო შესავალებზე, ნიმუშით გამოკვლეული Merkle გახსნილებზე, AIR გახსნილზე და FRI საკვანძო ჯაჭვზე.
...
3. AXT მტკიცებულების ფურცლის დეკოდირება
...
მარშრუტის რელე კონვერტები ასევე ატარებენ კომპაქტური FastPQ მტკიცებულების მასალას. მასალა წარმოადგენს მარშრუტი ID, მონაცემთა სივრცის ID, ბლოკის სიმაღლე, შემოწმების სიმაღლის, ბლოკების სათაურის ჰეშის, დასახლების ჰეშისა და manifesto root-ის დიაგესტს. რელეების გაერთიანება დასაშვებია მხოლოდ იმ შემთხვევაში, თუ მას აქვს როგორც QC, ასევე მოქმედი FastPQ მტკიცებულებების მასალა.
...
`compliance` მოთხოვნაში შედის ორი მეტა მონაცემთა რიგი: ერთი პოლიტიკაზე და მეორე სამიზნე მონაცემთა პალატაზე.
...
SCCP დამხმარე ყუთში ასევე გამოიყენება FastPQ გამჭვირვალე ჯაჭვური შეტყობინებების დასამტკიცებლად. ეს გზა განცალკევებულია `irohad` ფონის პროვერი ზოლიდან. იგი აშენებს FastPQ პარტიას უშუალოდ SCCP შეტყობინების მტკიცებულების ბუნდიდან და manifesto- დან, შემდეგ კი გახსნის შემოწმებისთვის მოიცავს მიღებულ მტკიცებულებას.
...
გამჭვირვალე განცხადების ბაიტები წარმოადგენს ვერსიის კონკეტინაციას, ჯაჭვის ოჯახს, ადგილობრივ და საპირისპირო დომენებს, უსაფრთხოების მოდელს, ანხრის მმართველობას, ანგარიშის კოდეკს, საბოლოოობის მოდელს, შემოწმებლის სამიზნეს, გადამოწმებლის უკანასკნელ ოჯახს, სიგრძის წინასწარი ჯაჭვი/გვერდი/მანიფესტულ ველებს, მიმართულების დამაკავშირებელ ჰაშს; ანგარიშის კოდეკის გასაღები, სასარგებლო ტვირთის ტიპი, საჯარო შეყვანის ბაიტები და სასარგებლოტვირთის ჰაში. განცხადების ჰაში არის:
...
ნედლეული FastPQ მტკიცებულება არის Norito-კოდირებულია `StarkFriOpenProofV1`, შემდეგ შეფუთული `OpenVerifyEnvelope` სათაურით `Stark`. SCCP შემოწმება აღადგენს იგივე FastPQ პარტიიდან და მანიფესტიდან, ამოწმებს ღია შემოწმების კონვერტის მეტა მონაცემებს და უწოდებს: FastPQ აღდგენილი პარტიის შემოწმება და დასამტკიცებელი.

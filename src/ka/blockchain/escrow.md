...
|მტკიცებულებების ჰეშეჟი |ქაღალდების, განაჩენების, შეტყობინებების, შენახვის მანიფესტების ან სხვა არაჩვეულებრივი მტკიცებულებების ჰაშები. თვითონ მტკიცებულების სასარგებლო ტვირთი არ არის შენახული საფინანსო ანგარიშში.|
...
Marketplace escrow-ი კოორდინირებს აქტივების გათავისუფლებას ქსელზე გადახდის ან მიწოდების სამუშაო პროცესთან.
...
|ISI |კჲი დჲ ოპვრთნა.|ეფექტი |
| --- | --- | --- |
|`OpenAssetLock` |წყარო ანგარიში |დადებითი თანხის ჩაკეტვა, რეკორდების მყიდველად აღრიცხვა და სტატუსის `Locked` განსაზღვრა. |
...
Python ამჟამად გამოყოფს მაღალ დონეზე მყოფი დამხმარეები გენერული საკეტებისათვის: `open_asset_lock`, `drawdown_asset_lock`, `cancel_asset_lock`, და `expire_asset_lock`. ბაზრისთვის და ანონიმური საფარდოდ Python, გამოყენება კანონიკური `InstructionBox` JSON მეშვეობით SDK აჟიოტაჟი JSON გაქცევის ღრუში, ან ჩაბარება SDK რომელიც გამოავლინებს პირველი კლასის საფინანსო კონსტრუქციულ მწარმოებლებს.
...
Anonymous escrow იყენებს იმავე ბაზრის სიცოცხლის ციკლს, მაგრამ დაფინანსება და დახურვის აქტივების მოძრაობა დაცულია. საჯარო ჩანაწერი კვლავ ინახავს გამყიდველს, მყიდველს , სტატუსს, მტკიცებულებების ჰეშებს, დროის შტამპებს და მტკიცებულებებთან დაკავშირებული მოძრაობის ჩანაწერებს. დაფარულ ბანკნოტებში არსებული თანხები და მიმღებნი წარმოდგენილია ვალდებულებებით, ბათილებლებით და მტკიცებულების დანართებით.
...
დაფარვის მხარდაჭერა SDKs სხვადასხვაგვარად არის გამოხატული. Rust აქვს კანონიკური ტიპირებული მონაცემთა მოდელი. Python ამჟამად გამოხატავს ზოგადი აქტივების ჩაკეტვის დამხმარეებს. JavaScript და TypeScript იყენებენ Kotodama დაფარების მასპინძელი ზარებს. Kotlin/JVM და Swift უზრუნველყოფენ ტიპირებულ სასარგებლო ტვირთების მშენებლებს ბაზრისთვის და ანონიმურ საფარდელს.
...
- Iroha რეგისტრირებს მფლობელობის და სიცოცხლის ციკლის გადასვლას; იგი არ ადასტურებს ფიატულ ან გარე გადახდის ბილიკებს თავისით.

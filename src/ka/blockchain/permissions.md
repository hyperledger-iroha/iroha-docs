...
ნებართვის მიღება ნიშნავს, რომ ანგარიშს აქვს შესაბამისი `Permission`. ნებართვები შეიძლება გადაეცემა პირდაპირ ან [`Role`](#permission-groups-roles), რომელიც აერთიანებს ნებართვების კომპლექტს. ნებართვები მინიჭებულია `Grant` ინსტრუქციით. ნებაყოფები და როლები არ ვადის; ამოიღეთ ისინი `Revoke` ინსტრუქციის გამოყენებით.

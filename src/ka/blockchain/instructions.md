...
| [SetKeyValue/RemoveKeyValue](#setkeyvalue-removekeyvalue) |ბლოკჩეინ-ის ობიექტების მეტა მონაცემები განახლება.|
...
`EnsureAlias` არის რიგითი პირველი გამოშვების გზა დომენებისა და მათი SNS იჯარის შესაქმნელად. იგი დეკლარატურად აკავშირებს ზუსტ მონაცემთა სივრცეს, მფლობელს, იჯარის ვადსა და ციტატის დაცვას, შემდეგ ქმნის ან აღადგენს ყველა საჭირო მდგომარეობას ატომურად. გამოიყენეთ ავთენტიფიცირებული `POST /v1/aliases/setup/plan` საბოლოო წერტილი ან შესაბამისი CLI სამუშაო პროცესის გამოყენება:
...
თქვენ შეგიძლიათ დაარეგისტრიროთ ანგარიშები, აქტივების განსაზღვრები, NFTs, თანატოლები, როლები და გამომწვევები. დომენის კონფიგურაცია იყენებს `EnsureAlias`; ნედლეული `Register::Domain` სასარგებლო ტვირთი არის გათვალისწინებული გენეზი/ბოტსტრაპისთვის. თანატოლთა რეგისტრაცია იყენებს`RegisterPeerWithPop`, რომელიც ატარებს თანატოლების გასაღების ფლობის დამტკიცებას. შეამოწმეთ ჩვენი [ სახელწოდების კონვენციები](/ka/reference/naming.md) იმისათვის, რომ გაეცნოთ ორგანიზაციის სახელზე დაწესებულ შეზღუდვებს.
...
ენის სპეციფიკური სახელმძღვანელოების ერთ-ერთს მიხედეთ, რათა გაგიყვეთ ბლოკჩეინში ობიექტების რეგისტრაციის პროცესი:
...
აქტივების რაოდენობა არ არის ნეგატიური, ასე რომ თქვენ ვერასდროს შეგიძლიათ ჰქონდეთ `$-1.0` აქტივი ან წვას უარყოფითი თანხა და მიიღოთ ნეგატიკური.

იხილეთ ერთ-ერთი ენის სპეციფიკური სახელმძღვანელო, რომელიც გაგიყვებათ ბლოკჩეინში აქტივების მოპოვების პროცესში:
...
იგივე ნიმუშია ხელმისაწვდომი ანგარიშებისათვის, აქტივების განსაზღვრებისთვის NFTs, RWAs და გამომწვევი ფაქტორებისთვის:
...
CLI შეუძლია დაარეგისტრიროს ტრიგერები და უშუალოდ გამოიწეროს ტრიგრის შესრულების მოვლენები. იგი არ უზრუნველყოფს `execute trigger` ბრძანებას, ამიტომ უნდა წარადგინოს სახელმძღვანელო ინსტრუქცია `ExecuteTrigger`, წარმოქმნას სერიალიზებული `InstructionBox` SDK ან აღსრულების ინსტრუმენტით და მიიღოს მიღებული JSON მასაჟი `ledger transaction stdin`:

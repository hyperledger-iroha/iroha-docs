...
სადაც `public_inputs` არის ვალდებულებები, ანულიფიკატორები, ფესვი, აქტივების ტეგი, ჯაჭვის ტეგი და ნებისმიერი საჯარო არალეგირებული თანხა. მოწმე შეიცავს ნოტის თანხებს, შემთხვევითობას, ხარჯების მასალას და Merkle-ს გზას. ვალიდატორები ადასტურებენ დამტკიცებას და შემდეგ მუტირებენ მთავრობის მდგომარეობას გამომუშავების ვალდებულებების დამატებით და შესასვლელი ნულიფიკატორების გათვალისწინებით, როგორც ხარჯულია.

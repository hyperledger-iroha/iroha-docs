...
აქტივების ანალიზი სახელწოდების აქტივთა განსაზღვრები, არა ინდივიდუალური ანგარიშის ბალანსი. აქტივების ანალიზები და ხელშეკრულების ანალიზი პირდაპირი კავშირებია წაკითხული სახელისაგან არსებული კანონიკური სამიზნეზე. ქონების საიდუმლოები განისაზღვრება `SetAssetDefinitionAlias`; საიდუმლოს სახელის სეგმენტი უნდა შეესაბამებოდეს აქტივის განსაზღვრის გამოსახულების სახელს ან პროგნოზირებულ განსაზღვროს სახელს. ხელშეკრულების საიდუმაო სახელი განისაზღვრა `SetContractAlias`; alias მონაცემთა სივრცე უნდა შეესაბამებოდეს კონტრაქტის მისამართში კოდირებულ მონაცემთა სიფართოს. ორივე კავშირს შეუძლია შეიცავდეს `lease_expiry_ms`; ამოწურვის შემდეგ ისინი წყდება გადაჭრა, როდესაც გრასის ფანჯარა გაივლის და იშლება მსოფლიო სახელმწიფო ინდექსებიდან.

დომენებს არ აქვთ ცალკე `DomainAlias` ობიექტი. დომენის იდენტიფიკატორი უკვე არის მონაცემთა სივრცეში კვალიფიციური სახელწოდება, როგორიცაა `payments.universal`. SNS მიმოიხილავს ლიზინგის მფლობელობას `domain` სახელების სივრცეში არსებული დომენური სახელებისათვის და `dataspace` სახელის სივრცეშიც არსებული მონაცემთა სივრცის ალექსანდრეებისთვის. განკუთვნილი `universal` მონაცემთა სიბნის ალექსანდრი კვლავ უნდა იყოს განსაზღვრული.

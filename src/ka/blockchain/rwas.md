...
|`TransferRwa` |გადატანა რაოდენობა სხვა ანგარიშზე. სრული გადარიცხვა შეიძლება შეიცვალოს `owned_by`; ნაწილობრივი გადარიცხვის შედეგად შეიქმნება ნაყოფიერი პარტია. |
...
კონტროლერის ანგარიშებისა და როლების შესრულება დასაშვებია მხოლოდ იმ კონტროლერთა ოპერაციების განხორციელებისთვის, რომლებიც უზრუნველყოფილია შესაბამისი ბულური დროშის მიერ. მიმდინარე მართვის სასარგებლო ტვირთები არ არის ნებართვის სიის გადაცემის პოლიტიკა და არ შეიცავს ჩაშლილი `transfers` წესები.
...
გაათავისუფლეთ საყრდენი, როდესაც ციხის მიღმა პროცესი დასრულებულია:
...
გამოსასყიდი რაოდენობა, როდესაც წარმოდგენილი off-chain აქტივი მიწოდებულია, მოიხმარა, დააბრუნეს ან სხვაგვარად ამოიღეს ბრუნვადან. პარტია უნდა იყოს `redeem_enabled`, ხოლო ხელმომწერი უნდა იყოს მფლობელი ან კონტროლერი.
...
გაყინეთ ბევრი, როდესაც off-chain მიმოხილვა უნდა დაბლოკოს ჩვეულებრივი მფლობელის ოპერაციები. ხელმომწერი უნდა იყოს კონტროლერი და პარტია უნდა ჰქონდეს `freeze_enabled`.
...
გადაიხადოს წარმოდგენილი თანხა საფირმის გარეშე ანგარიშსწორების შემდეგ:
...
გამოიყენეთ გამოსასყიდი კრედიტების გასაღებად მათი მოთხოვნის შემდეგ. მეტა მონაცემები მიუთითებს სერტიფიკატზე ან რეესტრის დასამტკიცებლად:

...
განზრახვა იდენტიფიცირებს `payments.universal`, მისი ციფრული მონაცემთა სივრცე, კანონიკური I105 მფლობელი, იჯარის შეძენის ვადა და მიმდინარე პოლიტიკის / გადახდის კოტირების დაცვა. დაგეგმვის საბოლოო წერტილი არის `POST /v1/aliases/setup/plan`; მისი დაბრუნებული გეგმა არის ჯაჭვური, უფლებამოსილება, სახელმწიფო და ვადით დაკავებული. დომენის მოხსნა კვლავ იყენებს [`Unregister`](/ka/blockchain/instructions.md#un-register).
...
დომენების ჯგუფი ასახავს ობიექტებს და უზრუნველყოფს სახელის სივრცეს დომენის მასშტაბით განსაზღვრული მონაცემებისთვის. აქტივების დეფინიციები იყენებს დომენის კვალიფიციურ იდენტიფიკატორებს, ხოლო გამოკითხვებს შეუძლიათ ჩამოთვალონ დომენები ან იპოვონ ობიექტები დომენისთვის მიზნად განსაზღვრულ. ანგარიშები თვითონ დომენების გარეშეა მიმდინარე მონაცემთა მოდელში, მაგრამ ანგარიშებს შეუძლიათ ჰქონდეთ დომენები და ინახონ აქტივები, რომელთა განსაზღვრებაც დომენებში ცხოვრობს.

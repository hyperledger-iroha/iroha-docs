...
გამოიყენეთ პირდაპირი OpenAPI დოკუმენტი მიმდინარე Torii API საბოლოო წერტილიდან, რომ შეამოწმოთ მარშრუტები, გამოაგზავნოთ ტესტის მოთხოვნები, გადაწეროთ ბრძანებები curl და შექმნათ კლიენტის კოდი.

<ToriiApiConsole />

## მოთხოვნები {#requirements}

- Torii API საბოლოო წერტილში უნდა იყოს გათვალისწინებული `/openapi.json`.
- ბრაუზერის ტესტირება საჭიროებს CORS ამ დოკუმენტების წარმოშობის დასაშვებად.
- ბრაუზერმა უნდა შეძლოს უშუალოდ მიაღწიოს API საბოლოო წერტილს.
- კოდის გენერაციისათვის საჭიროა Node.js, pnpm და Java შესრულების გარემო OpenAPI გენერატორისთვის.
...
შემდეგ დააჭირეთ `https://taira.sora.org/openapi.json` კონსოლში და სცადეთ მხოლოდ წაკითხვის მარშრუტი, როგორიცაა `GET /status`, `GET /v1/domains` ან `GET /v1/assets/definitions`. შეინახეთ ხელმოწერილი ტრანზაქცია და კერძო გასაღების ნაკადი SDK ან CLI კლიენტისთვის, რომელიც ატვირთავს საიდუმლოებებს თქვენი პროგრამული უზრუნველყოფის გარემოსგან.
...
ხელმოწერილი ბლოკჩეინის რეესტრების ტრანზაქციებისთვის, ხელმოწერილ მოთხოვნებსა და Norito - ადგილობრივ დატვირთვებს ურჩევნიათ ოფიციალური Iroha SDKs. OpenAPI კლიენტები არ შეაგროვებენ ხელმოწერებს, მართავენ ანგარიშის გასაღებს ან კოდირებენ Norito ტრანზაკციის ორგანოებს თქვენთვის.

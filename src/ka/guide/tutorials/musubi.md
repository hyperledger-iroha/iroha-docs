...
`Musubi.lock` ინახავს შერჩეულ ტრანზიტულ გრაფიკს ჯაჭვის რეესტრიდან. თითოეული ჩაკეტილი კვანძი ინახავს თავის კანონიკურ პაკეტს ref, შერჩეული მოთხოვნა, SoraFS manifest digest, წყარო არქივის ჰეში, ბაიტების რაოდენობა, ფაილების რაოდენობა, ექსპორტირებული ფუნქციები, დეტერმინისტური წყარო არქეის გეგმა და დამოკიდებულება aliases. მოკლე საიდუმლოები გადაწყდება სანამ ისინი შევა საკეტი ფაილში.
...
`pack` ითვლება დეტერმინისტური BLAKE3-256 წყარო არქივის ჰეში პლუს წყარო ბაიტი და ფაილების რაოდენობა. როდესაც `--car-out`, `--sorafs-manifest-out` ან `--source-plan-out` მიწოდებულია, ის ასევე ქმნის დეტერმინისტურ SoraFS CAR სასარგებლო ტვირთს, SoraFS მანიფესტი, და Musubi წყარო არქივის გეგმა იმავე წყარო ფაილების კომპლექსიდან.
